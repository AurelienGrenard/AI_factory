...
template<bool MemoryCoupon>
struct PhoenixPathObservationHandler {
...
template<typename ProductParametersT, bool MemoryCoupon>
struct PhoenixPathPolicy {
    ...
    using Handler = PhoenixPathObservationHandler<MemoryCoupon>;
