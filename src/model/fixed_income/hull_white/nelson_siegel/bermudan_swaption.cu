// Hull-White/NS Bermudan swaptions over the common LSM engine.
...
launch_hull_white_nelson_siegel_bermudan_swaption_cuda(
    ...
    >(
        ...
        "Hull-White Nelson-Siegel Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_hull_white_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_hull_white_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const curve::nelson_siegel::NelsonSiegelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
