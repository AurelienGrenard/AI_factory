// Generated Hull-White composition over the common sample engine.
...
void launch_hull_white_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_states}, "hull_white.samples",
        "Hull-White terminal sample kernel");
}

void launch_hull_white_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "hull_white.samples", "Hull-White random terminal sample kernel");
}
...
void launch_hull_white_calendar_samples_cuda(
    ...
    sample::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, threads_per_block, block_count,
        dynamics_seed, {device_states}, "hull_white.samples",
        "Hull-White calendar sample kernel");
}
