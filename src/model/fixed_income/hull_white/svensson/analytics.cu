...
struct AnalyticsProvider {
    ...
    affine_bond_coefficients(
        ...
        return ai_factory::workbench::model::hull_white::svensson::affine_bond_coefficients(
    ...
    prepare_bond_option_context(
        ...
        return ai_factory::workbench::model::hull_white::svensson::prepare_bond_option_context(
            parameters, state, valuation_time, option_expiry
        );
    }
    ...
    __device__ __forceinline__ float bond_option_price(
        ...
        return ai_factory::workbench::model::hull_white::svensson::zero_coupon_bond_option_price(
            context,
            parameters,
            state,
            option_sign,
