// Hull-White/Svensson Bermudans over the common Longstaff-Schwartz engine.
#include "model/fixed_income/hull_white/svensson/bermudan_swaption.cuh"
...
using PricingPolicy = product::FittedBermudanSwaptionPricingPolicy<
...
launch_hull_white_svensson_bermudan_swaption_cuda(
    ...
    >(
        ...
        "Hull-White Svensson Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_hull_white_svensson_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_hull_white_svensson_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const curve::svensson::SvenssonParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
