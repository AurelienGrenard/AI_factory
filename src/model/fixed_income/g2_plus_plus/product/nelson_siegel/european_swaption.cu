...
void launch_g2_plus_plus_nelson_siegel_european_swaption_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<Pricing>(
        ...
        "g2_plus_plus.nelson_siegel.european_swaption", swaption_side_name(Side),
        "G2++ European swaption Monte Carlo kernel"
    );
}

template void launch_g2_plus_plus_nelson_siegel_european_swaption_cuda<SwaptionSide::payer>(
...
template void launch_g2_plus_plus_nelson_siegel_european_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const curve::nelson_siegel::NelsonSiegelParameters*, std::size_t,
    const product::RegularEuropeanSwaptionParameters*,
    const product::RegularEuropeanSwaptionParameters*,
