// G2++/NS Bermudan swaptions over the common Longstaff-Schwartz engine.
...
launch_g2_plus_plus_nelson_siegel_bermudan_swaption_cuda(
    ...
    >(
        ...
        "G2++ Nelson-Siegel Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_g2_plus_plus_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_g2_plus_plus_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const curve::nelson_siegel::NelsonSiegelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
