...
For $`I_t=\int_0^t(x_u+y_u)\,\mathrm du`$, path discounting includes the
fitted shift:
...
A degree-two two-factor Hermite basis estimates
...
$`\mathbb E[D(0,E_0)V_0]`$. Both factor endpoints and their joint centered
