...
template<SwaptionSide Side>
longstaff_schwartz::LaunchResult launch_cir_bermudan_swaption_cuda(
    ...
    >(
        ...
        "CIR Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_cir_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_cir_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, float, std::uint32_t,
