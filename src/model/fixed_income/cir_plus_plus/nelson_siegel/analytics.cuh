// Public CIR++ analytics declarations for pricing against a Nelson-Siegel curve.
#pragma once
...
using CirPlusPlusFittedParameters =
...
static_assert(
    ::ai_factory::workbench::fixed_income::JamshidianAnalyticsProvider<
        ...
        CirPlusPlusFittedParameters,
        float
    >
);

__device__ __forceinline__ CirPlusPlusFittedParameters compose_fitted_model(
...
struct FittedModelComposition {
    using ModelParameters =
        ::ai_factory::workbench::model::fixed_income::cir_plus_plus::ModelParameters;
    using CurveParameters =
        ::ai_factory::workbench::curve::nelson_siegel::NelsonSiegelParameters;
    using FittedModel = CirPlusPlusFittedParameters;

    __device__ __forceinline__ static float initial_state(const FittedModel& model) {
        return model.factor.initial_state;
    }
...
using TerminalForwardBondAnalyticsPolicy =
    fitted::TerminalForwardBondAnalyticsPolicy<FittedModelComposition>;
