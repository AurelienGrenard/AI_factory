// Generated Closed-form CIR++/Svensson European swaptions.
...
void launch_cir_plus_plus_svensson_european_swaption_cuda(
    ...
    >(
        "cir_plus_plus.svensson.european_swaption",
        device_models,
        model_count,
        device_curves,
        curve_count,
...
template void launch_cir_plus_plus_svensson_european_swaption_cuda<
    SwaptionSide::payer
>(
