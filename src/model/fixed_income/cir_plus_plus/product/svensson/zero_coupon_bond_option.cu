...
template<OptionSide Side>
void launch_cir_plus_plus_svensson_zero_coupon_bond_option_cuda(
    ...
    closed_form::launch_closed_form_cuda<PricingPolicy<Side>>(
        ...
        block_count,
        device_prices,
        "cir_plus_plus.svensson.zero_coupon_bond_option",
        option_side_name(Side),
        "CIR++ zero-coupon bond option kernel"
    );
}

template void launch_cir_plus_plus_svensson_zero_coupon_bond_option_cuda<
    OptionSide::call
>(
