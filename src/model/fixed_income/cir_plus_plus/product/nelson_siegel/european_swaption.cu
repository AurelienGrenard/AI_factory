// Generated Closed-form CIR++/Nelson-Siegel European swaptions.
...
void launch_cir_plus_plus_nelson_siegel_european_swaption_cuda(
    ...
    >(
        "cir_plus_plus.nelson_siegel.european_swaption",
        device_models,
        model_count,
        device_curves,
        curve_count,
...
template void launch_cir_plus_plus_nelson_siegel_european_swaption_cuda<
    SwaptionSide::payer
>(
