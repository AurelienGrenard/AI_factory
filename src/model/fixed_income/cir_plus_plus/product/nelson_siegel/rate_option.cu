// Generated Closed-form CIR++ rate-option composition fitted to a parametric curve.
...
template<OptionSide Side>
void launch_cir_plus_plus_nelson_siegel_rate_option_cuda(
    ...
    closed_form::launch_closed_form_cuda<PricingPolicy<Side>>(
        ...
        block_count,
        device_prices,
        "cir_plus_plus.nelson_siegel.rate_option",
        option_side_name(Side),
        "CIR++ rate_option kernel"
    );
}

template void launch_cir_plus_plus_nelson_siegel_rate_option_cuda<
    OptionSide::call
>(
