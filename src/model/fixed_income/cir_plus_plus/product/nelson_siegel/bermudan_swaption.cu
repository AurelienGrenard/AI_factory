// Generated CIR++/Nelson-Siegel Bermudan swaptions over the common LSM engine.
...
launch_cir_plus_plus_nelson_siegel_bermudan_swaption_cuda(
    ...
    >(
        ...
        "cir_plus_plus.nelson_siegel.bermudan_swaption",
        swaption_side_name(Side),
        "CIR++ Nelson-Siegel Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_cir_plus_plus_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_cir_plus_plus_nelson_siegel_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const curve::nelson_siegel::NelsonSiegelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
