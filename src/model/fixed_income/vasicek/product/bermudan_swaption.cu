// Vasicek Bermudan swaptions over the common Longstaff-Schwartz engine.
...
longstaff_schwartz::LaunchResult launch_vasicek_bermudan_swaption_cuda(
    ...
    >(
        ...
        "Vasicek Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_vasicek_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_vasicek_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, float, unsigned int, std::size_t,
