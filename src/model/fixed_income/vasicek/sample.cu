// Generated Vasicek composition over the common sample engine.
...
void launch_vasicek_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_states}, "vasicek.samples",
        "Vasicek terminal sample kernel");
}

void launch_vasicek_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "vasicek.samples", "Vasicek random terminal sample kernel");
}
...
void launch_vasicek_calendar_samples_cuda(
    ...
    sample::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, threads_per_block, block_count,
        dynamics_seed, {device_states}, "vasicek.samples",
        "Vasicek calendar sample kernel");
}
