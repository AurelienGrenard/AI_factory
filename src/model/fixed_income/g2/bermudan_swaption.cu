// G2 Bermudan swaptions over the common Longstaff-Schwartz engine.
...
template<SwaptionSide Side>
longstaff_schwartz::LaunchResult launch_g2_bermudan_swaption_cuda(
    ...
    >(
        ...
        "G2 Bermudan swaption"
    );
}

template longstaff_schwartz::LaunchResult
launch_g2_bermudan_swaption_cuda<SwaptionSide::payer>(
...
template longstaff_schwartz::LaunchResult
launch_g2_bermudan_swaption_cuda<SwaptionSide::receiver>(
    const ModelParameters*, std::size_t,
    const product::BermudanSwaptionParameters*,
    const product::BermudanSwaptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, float, unsigned int, std::size_t,
