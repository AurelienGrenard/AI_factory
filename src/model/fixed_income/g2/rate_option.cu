// Closed-form rate_option pricing under the G2 short-rate model.
...
template<OptionSide Side>
__global__ void g2_rate_option_kernel(
...
void validate_g2_rate_option_launch(
...
void launch_g2_rate_option_cuda(
    ...
    validate_g2_rate_option_launch(
        device_models,
        model_count,
        device_products,
        product_count,
...
using LaunchSignature = decltype(launch_g2_rate_option_cuda<OptionSide::call>);
template LaunchSignature launch_g2_rate_option_cuda<OptionSide::call>;
template LaunchSignature launch_g2_rate_option_cuda<OptionSide::put>;
