// Generated Ornstein-Uhlenbeck composition over the common sample engine.
...
void launch_ornstein_uhlenbeck_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_states}, "ornstein_uhlenbeck.samples",
        "Ornstein-Uhlenbeck terminal sample kernel");
}

void launch_ornstein_uhlenbeck_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "ornstein_uhlenbeck.samples", "Ornstein-Uhlenbeck random terminal sample kernel");
}
...
void launch_ornstein_uhlenbeck_calendar_samples_cuda(
    ...
    sample::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, threads_per_block, block_count,
        dynamics_seed, {device_states}, "ornstein_uhlenbeck.samples",
        "Ornstein-Uhlenbeck calendar sample kernel");
}
