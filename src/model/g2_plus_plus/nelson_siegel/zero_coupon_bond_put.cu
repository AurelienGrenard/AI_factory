// Closed-form G2++ bond puts fitted to Nelson-Siegel curves.
...
__global__ void g2_plus_plus_nelson_siegel_zero_coupon_bond_put_kernel(
...
void validate_g2_plus_plus_nelson_siegel_zero_coupon_bond_put_launch(
...
void launch_g2_plus_plus_nelson_siegel_zero_coupon_bond_put_cuda(
    const G2PlusPlusModelParameters* device_models,
    std::size_t model_count,
    const curve::nelson_siegel::NelsonSiegelParameters* device_curves,
    std::size_t curve_count,
    ...
    validate_g2_plus_plus_nelson_siegel_zero_coupon_bond_put_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    g2_plus_plus_nelson_siegel_zero_coupon_bond_put_kernel<<<
