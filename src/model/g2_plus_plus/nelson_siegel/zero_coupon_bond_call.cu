// Closed-form G2++ bond calls fitted to Nelson-Siegel curves.
...
__global__ void g2_plus_plus_nelson_siegel_zero_coupon_bond_call_kernel(
...
void validate_g2_plus_plus_nelson_siegel_zero_coupon_bond_call_launch(
...
void launch_g2_plus_plus_nelson_siegel_zero_coupon_bond_call_cuda(
    ...
    validate_g2_plus_plus_nelson_siegel_zero_coupon_bond_call_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    g2_plus_plus_nelson_siegel_zero_coupon_bond_call_kernel<<<
