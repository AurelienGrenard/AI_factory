// Closed-form G2++ floorlet pricing fitted to Svensson curves.
#include "model/g2_plus_plus/svensson/floorlet.cuh"
...
__global__ void g2_plus_plus_svensson_floorlet_kernel(
...
void validate_g2_plus_plus_svensson_floorlet_launch(
...
void launch_g2_plus_plus_svensson_floorlet_cuda(
    const G2PlusPlusModelParameters* device_models,
    std::size_t model_count,
    const curve::svensson::SvenssonParameters* device_curves,
    std::size_t curve_count,
    ...
    validate_g2_plus_plus_svensson_floorlet_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    g2_plus_plus_svensson_floorlet_kernel<<<
