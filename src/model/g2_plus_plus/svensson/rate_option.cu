// Closed-form G2++ rate_option pricing fitted to Svensson curves.
...
template<OptionSide Side>
__global__ void g2_plus_plus_svensson_rate_option_kernel(
...
void validate_g2_plus_plus_svensson_rate_option_launch(
...
void launch_g2_plus_plus_svensson_rate_option_cuda(
    ...
    validate_g2_plus_plus_svensson_rate_option_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    report_cuda_kernel_launch_if_enabled(
        ...
        g2_plus_plus_svensson_rate_option_kernel<Side>,
...
using LaunchSignature = decltype(launch_g2_plus_plus_svensson_rate_option_cuda<OptionSide::call>);
template LaunchSignature launch_g2_plus_plus_svensson_rate_option_cuda<OptionSide::call>;
template LaunchSignature launch_g2_plus_plus_svensson_rate_option_cuda<OptionSide::put>;
