// Closed-form G2++ caplet pricing fitted to Svensson curves.
...
__global__ void g2_plus_plus_svensson_caplet_kernel(
...
void validate_g2_plus_plus_svensson_caplet_launch(
...
void launch_g2_plus_plus_svensson_caplet_cuda(
    ...
    validate_g2_plus_plus_svensson_caplet_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    g2_plus_plus_svensson_caplet_kernel<<<
