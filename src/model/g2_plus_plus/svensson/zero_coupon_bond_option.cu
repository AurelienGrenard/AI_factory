// Closed-form G2++ bond options fitted to Svensson curves.
#include "model/g2_plus_plus/svensson/zero_coupon_bond_option.cuh"

#include "common/check_cuda.cuh"
#include "common/cuda_kernel_diagnostics.cuh"

// Include analytics so NVCC can inline the complete pricing formula.
#include "model/g2_plus_plus/svensson/analytics.cu"
...
void launch_g2_plus_plus_svensson_zero_coupon_bond_option_cuda(
    ...
    validate_g2_plus_plus_svensson_zero_coupon_bond_option_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    report_cuda_kernel_launch_if_enabled(
        ...
        g2_plus_plus_svensson_zero_coupon_bond_option_kernel<Side>,
...
using LaunchSignature = decltype(launch_g2_plus_plus_svensson_zero_coupon_bond_option_cuda<OptionSide::call>);
template LaunchSignature launch_g2_plus_plus_svensson_zero_coupon_bond_option_cuda<OptionSide::call>;
template LaunchSignature launch_g2_plus_plus_svensson_zero_coupon_bond_option_cuda<OptionSide::put>;
