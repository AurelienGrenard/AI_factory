// Kou phoenix-memory-autocall composition over generic CUDA layers.
...
using Schedule = equity::ExactTransitionRegularSchedule<kou::DynamicsPolicy>;
...
void launch_kou_phoenix_memory_autocall_cuda(
    ...
    equity::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Kou phoenix memory autocall kernel"
    );
}
