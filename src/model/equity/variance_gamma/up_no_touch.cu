// Variance-Gamma up-no-touch composition over generic CUDA layers.
...
using PricingPolicy = product::UpNoTouchPricingPolicy<Schedule, Discount>;
...
void launch_variance_gamma_up_no_touch_cuda(
    ...
    equity::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Variance-Gamma up no touch kernel"
    );
}
