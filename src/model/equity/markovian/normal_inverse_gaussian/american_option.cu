// NIG American-option composition over shared Longstaff-Schwartz kernels.
...
using Schedule =
    simulation::ExactTransitionMaturityAlignedExerciseSchedule<
...
launch_normal_inverse_gaussian_american_option_cuda(
