// Generated normal_inverse_gaussian straddle composition over the shared price-delta engine.
...
void launch_normal_inverse_gaussian_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "normal_inverse_gaussian.straddle.price_delta", "default");
}
