// Generated normal_inverse_gaussian phoenix_autocall composition over the shared price-delta engine.
...
void launch_normal_inverse_gaussian_phoenix_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "normal_inverse_gaussian.phoenix_autocall.price_delta", "default");
}
