// Generated normal_inverse_gaussian range_accrual composition over the shared price-delta engine.
...
void launch_normal_inverse_gaussian_range_accrual_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "normal_inverse_gaussian.range_accrual.price_delta", "default");
}
