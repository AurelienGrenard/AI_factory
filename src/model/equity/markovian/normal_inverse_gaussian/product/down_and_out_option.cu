// Normal-Inverse-Gaussian down-and-out-option composition over generic CUDA layers.
...
using PricingPolicy =
    product::DownAndOutOptionPricingPolicy<Schedule, Side>;
...
void launch_normal_inverse_gaussian_down_and_out_option_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "Normal-Inverse-Gaussian down and out option kernel"
    );
}

template void launch_normal_inverse_gaussian_down_and_out_option_cuda<OptionSide::call>(
...
template void launch_normal_inverse_gaussian_down_and_out_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::DownAndOutOptionParameters*,
    const product::DownAndOutOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
