// SABR phoenix-autocall composition over generic CUDA layers.
...
using Schedule = simulation::FixedStepRegularSchedule<sabr::DynamicsPolicy>;
...
void launch_sabr_phoenix_autocall_cuda(
