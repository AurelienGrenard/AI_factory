// Generated sabr up_no_touch composition over the shared price-delta engine.
...
void launch_sabr_up_no_touch_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "sabr.up_no_touch.price_delta", "default");
}
