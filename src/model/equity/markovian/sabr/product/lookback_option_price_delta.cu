// Generated sabr lookback_option composition over the shared price-delta engine.
...
void launch_sabr_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "sabr.lookback_option.price_delta", "default");
}
