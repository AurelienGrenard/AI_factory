// Generated heston_3_2 cliquet composition over the shared price-delta engine.
...
void launch_heston_3_2_cliquet_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "heston_3_2.cliquet.price_delta", "default");
}
