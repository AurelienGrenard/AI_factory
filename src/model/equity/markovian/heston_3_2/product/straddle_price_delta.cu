// Generated heston_3_2 straddle composition over the shared price-delta engine.
...
void launch_heston_3_2_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "heston_3_2.straddle.price_delta", "default");
}
