// Generated heston_3_2 lookback_option composition over the shared price-delta engine.
...
void launch_heston_3_2_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "heston_3_2.lookback_option.price_delta", "default");
}
