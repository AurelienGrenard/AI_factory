// Heston 3/2 double-knock-out-option composition over generic CUDA layers.
...
using PricingPolicy =
    product::DoubleKnockOutOptionPricingPolicy<Schedule, Side>;
...
template<OptionSide Side>
void launch_heston_3_2_double_knock_out_option_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "Heston 3/2 double knock out option kernel"
    );
}

template void launch_heston_3_2_double_knock_out_option_cuda<OptionSide::call>(
    const ModelParameters*, std::size_t,
    const product::DoubleKnockOutOptionParameters*,
...
template void launch_heston_3_2_double_knock_out_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::DoubleKnockOutOptionParameters*,
    const product::DoubleKnockOutOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
