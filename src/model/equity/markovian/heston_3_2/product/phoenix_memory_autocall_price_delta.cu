// Generated heston_3_2 phoenix_memory_autocall composition over the shared price-delta engine.
...
void launch_heston_3_2_phoenix_memory_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "heston_3_2.phoenix_memory_autocall.price_delta", "default");
}
