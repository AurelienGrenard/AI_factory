// Heston 3/2 up-one-touch composition over generic CUDA layers.
...
using PricingPolicy = product::UpOneTouchPricingPolicy<Schedule>;

static_assert(monte_carlo::ScalarMonteCarloPricingPolicy<PricingPolicy>);

}  // namespace

void launch_heston_3_2_up_one_touch_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Heston 3/2 up one touch kernel"
    );
}
