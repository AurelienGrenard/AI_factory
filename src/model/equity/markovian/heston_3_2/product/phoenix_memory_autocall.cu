// Heston 3/2 phoenix-memory-autocall composition over generic CUDA layers.
...
void launch_heston_3_2_phoenix_memory_autocall_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Heston 3/2 phoenix memory autocall kernel"
    );
}
