// Generated Heston 3/2 composition over the common sample engine.
...
using Observation = sample::SpotAndStateSampleObservation<DynamicsPolicy, &State::reciprocal_variance>;
...
void launch_heston_3_2_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots, device_reciprocal_variances}, "heston_3_2.samples",
        "Heston 3/2 terminal sample kernel");
}
...
void launch_heston_3_2_random_terminal_samples_cuda(
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, device_maturity_days, {device_spots, device_reciprocal_variances},
        "heston_3_2.samples", "Heston 3/2 random terminal sample kernel");
}
...
void launch_heston_3_2_calendar_samples_cuda(
    ...
    sample::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, threads_per_block, block_count,
        dynamics_seed, {device_spots, device_reciprocal_variances}, "heston_3_2.samples",
        "Heston 3/2 calendar sample kernel");
}
