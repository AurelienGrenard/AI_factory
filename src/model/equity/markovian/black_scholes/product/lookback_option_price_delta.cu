// Generated black_scholes lookback_option composition over the shared price-delta engine.
...
void launch_black_scholes_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "black_scholes.lookback_option.price_delta", "default");
}
