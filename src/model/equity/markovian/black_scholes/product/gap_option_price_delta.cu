// Generated Black-Scholes GapOption composition over shared closed-form bumping.
...
#include "model/equity/markovian/black_scholes/product/gap_option_impl.cuh"

namespace ai_factory::workbench::model::equity::black_scholes {

template<OptionSide Side>
void launch_black_scholes_gap_option_price_delta_cuda(
    ...
    using PricePolicy = GapOptionClosedFormPricingPolicy<Side>;
    ...
    closed_form::launch_closed_form_price_delta_cuda<Policy>(
        ...
        "black_scholes.gap_option.price_delta", option_side_name(Side));
}

template void launch_black_scholes_gap_option_price_delta_cuda<OptionSide::call>(
    const ModelParameters*, const ModelParameters*, std::size_t, const product::GapOptionParameters*, std::size_t, PriceConstruction, std::size_t, std::size_t, std::size_t, float, unsigned int, std::size_t, ::ai_factory::workbench::equity::price_delta::SpotBumpConfiguration, float*, float*);
template void launch_black_scholes_gap_option_price_delta_cuda<OptionSide::put>(
    const ModelParameters*, const ModelParameters*, std::size_t, const product::GapOptionParameters*, std::size_t, PriceConstruction, std::size_t, std::size_t, std::size_t, float, unsigned int, std::size_t, ::ai_factory::workbench::equity::price_delta::SpotBumpConfiguration, float*, float*);
