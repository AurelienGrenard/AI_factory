// Generated black_scholes cliquet composition over the shared price-delta engine.
...
void launch_black_scholes_cliquet_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "black_scholes.cliquet.price_delta", "default");
}
