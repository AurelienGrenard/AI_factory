// Generated Black-Scholes EuropeanOption composition over shared closed-form bumping.
...
void launch_black_scholes_european_option_price_delta_cuda(
    ...
    using PricePolicy = product::LognormalEuropeanOptionClosedFormPolicy<ModelParameters, Side>;
    ...
    closed_form::launch_closed_form_price_delta_cuda<Policy>(
        ...
        "black_scholes.european_option.price_delta", option_side_name(Side));
}

template void launch_black_scholes_european_option_price_delta_cuda<OptionSide::call>(
    const ModelParameters*, const ModelParameters*, std::size_t, const product::EuropeanOptionParameters*, std::size_t, PriceConstruction, std::size_t, std::size_t, std::size_t, float, unsigned int, std::size_t, ::ai_factory::workbench::equity::price_delta::SpotBumpConfiguration, float*, float*);
template void launch_black_scholes_european_option_price_delta_cuda<OptionSide::put>(
    const ModelParameters*, const ModelParameters*, std::size_t, const product::EuropeanOptionParameters*, std::size_t, PriceConstruction, std::size_t, std::size_t, std::size_t, float, unsigned int, std::size_t, ::ai_factory::workbench::equity::price_delta::SpotBumpConfiguration, float*, float*);
