// Black-Scholes asian-option composition over generic CUDA layers.
...
template void launch_black_scholes_asian_option_cuda<OptionSide::call>(
...
template void launch_black_scholes_asian_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::AsianOptionParameters*,
    const product::AsianOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
