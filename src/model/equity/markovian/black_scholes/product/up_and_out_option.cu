// Black-Scholes up-and-out-option composition over generic CUDA layers.
...
template void launch_black_scholes_up_and_out_option_cuda<OptionSide::call>(
...
template void launch_black_scholes_up_and_out_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::UpAndOutOptionParameters*,
    const product::UpAndOutOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
