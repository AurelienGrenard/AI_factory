// Generated Black-Scholes Straddle composition over shared closed-form bumping.
...
void launch_black_scholes_straddle_price_delta_cuda(
    ...
    using PricePolicy = StraddleClosedFormPricingPolicy;
    ...
    closed_form::launch_closed_form_price_delta_cuda<Policy>(
        ...
        "black_scholes.straddle.price_delta", "default");
}
