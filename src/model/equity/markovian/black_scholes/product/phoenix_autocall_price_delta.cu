// Generated black_scholes phoenix_autocall composition over the shared price-delta engine.
...
void launch_black_scholes_phoenix_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "black_scholes.phoenix_autocall.price_delta", "default");
}
