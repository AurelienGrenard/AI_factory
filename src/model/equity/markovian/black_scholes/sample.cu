// Generated Black-Scholes composition over the common sample engine.
...
void launch_black_scholes_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots}, "black_scholes.samples",
...
void launch_black_scholes_random_terminal_samples_cuda(
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "black_scholes.samples", "Black-Scholes random terminal sample kernel");
}
