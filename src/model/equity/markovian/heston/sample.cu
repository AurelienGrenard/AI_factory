// Generated Heston composition over the common sample engine.
...
using Observation = sample::SpotAndStateSampleObservation<DynamicsPolicy, &State::variance>;
...
void launch_heston_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots, device_variances}, "heston.samples",
        "Heston terminal sample kernel");
}

void launch_heston_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, device_maturity_days, {device_spots, device_variances},
        "heston.samples", "Heston random terminal sample kernel");
}
