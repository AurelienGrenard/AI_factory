// Generated heston up_no_touch composition over the shared price-delta engine.
...
void launch_heston_up_no_touch_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "heston.up_no_touch.price_delta", "default");
}
