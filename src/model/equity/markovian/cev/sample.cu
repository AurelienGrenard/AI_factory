// Generated CEV composition over the common sample engine.
...
void launch_cev_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots}, "cev.samples",
        "CEV terminal sample kernel");
}

void launch_cev_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "cev.samples", "CEV random terminal sample kernel");
}
