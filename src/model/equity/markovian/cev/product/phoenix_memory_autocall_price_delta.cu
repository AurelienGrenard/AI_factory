// Generated cev phoenix_memory_autocall composition over the shared price-delta engine.
...
void launch_cev_phoenix_memory_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "cev.phoenix_memory_autocall.price_delta", "default");
}
