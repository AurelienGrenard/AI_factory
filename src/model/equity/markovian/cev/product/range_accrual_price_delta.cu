// Generated cev range_accrual composition over the shared price-delta engine.
...
void launch_cev_range_accrual_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "cev.range_accrual.price_delta", "default");
}
