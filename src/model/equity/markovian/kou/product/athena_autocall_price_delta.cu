// Generated kou athena_autocall composition over the shared price-delta engine.
...
void launch_kou_athena_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "kou.athena_autocall.price_delta", "default");
}
