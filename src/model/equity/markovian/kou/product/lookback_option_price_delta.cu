// Generated kou lookback_option composition over the shared price-delta engine.
...
void launch_kou_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "kou.lookback_option.price_delta", "default");
}
