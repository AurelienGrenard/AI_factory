// Kou asset-or-nothing-option composition over generic CUDA layers.
...
void launch_kou_asset_or_nothing_option_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "Kou asset or nothing option kernel"
    );
}

template void launch_kou_asset_or_nothing_option_cuda<OptionSide::call>(
...
template void launch_kou_asset_or_nothing_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::AssetOrNothingOptionParameters*,
    const product::AssetOrNothingOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
