// Generated Kou composition over the common sample engine.
...
void launch_kou_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots}, "kou.samples",
        "Kou terminal sample kernel");
}

void launch_kou_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "kou.samples", "Kou random terminal sample kernel");
}
