// Generated stein_stein phoenix_autocall composition over the shared price-delta engine.
...
void launch_stein_stein_phoenix_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "stein_stein.phoenix_autocall.price_delta", "default");
}
