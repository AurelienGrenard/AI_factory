// Generated stein_stein cliquet composition over the shared price-delta engine.
...
void launch_stein_stein_cliquet_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "stein_stein.cliquet.price_delta", "default");
}
