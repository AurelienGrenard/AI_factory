// Generated stein_stein athena_autocall composition over the shared price-delta engine.
...
void launch_stein_stein_athena_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "stein_stein.athena_autocall.price_delta", "default");
}
