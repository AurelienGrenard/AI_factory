// Stein-Stein phoenix-memory-autocall composition over generic CUDA layers.
...
using Schedule = simulation::FixedStepRegularSchedule<stein_stein::DynamicsPolicy>;
...
void launch_stein_stein_phoenix_memory_autocall_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Stein-Stein phoenix memory autocall kernel"
    );
}
