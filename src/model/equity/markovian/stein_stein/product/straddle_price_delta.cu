// Generated stein_stein straddle composition over the shared price-delta engine.
...
void launch_stein_stein_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "stein_stein.straddle.price_delta", "default");
}
