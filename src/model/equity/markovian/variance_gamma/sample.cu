// Generated Variance-Gamma composition over the common sample engine.
...
void launch_variance_gamma_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        "Variance-Gamma terminal sample kernel");
}

void launch_variance_gamma_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "variance_gamma.samples", "Variance-Gamma random terminal sample kernel");
}
