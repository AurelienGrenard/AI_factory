// Generated variance_gamma straddle composition over the shared price-delta engine.
...
void launch_variance_gamma_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "variance_gamma.straddle.price_delta", "default");
}
