// Generated variance_gamma cliquet composition over the shared price-delta engine.
...
void launch_variance_gamma_cliquet_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "variance_gamma.cliquet.price_delta", "default");
}
