// Generated variance_gamma phoenix_autocall composition over the shared price-delta engine.
...
void launch_variance_gamma_phoenix_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "variance_gamma.phoenix_autocall.price_delta", "default");
}
