// Variance-Gamma asian-option composition over generic CUDA layers.
...
void launch_variance_gamma_asian_option_cuda(
    ...
    monte_carlo::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "Variance-Gamma asian option kernel"
    );
}

template void launch_variance_gamma_asian_option_cuda<OptionSide::call>(
...
template void launch_variance_gamma_asian_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::AsianOptionParameters*,
    const product::AsianOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, std::size_t,
