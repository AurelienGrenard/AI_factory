// Generated merton straddle composition over the shared price-delta engine.
...
void launch_merton_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "merton.straddle.price_delta", "default");
}
