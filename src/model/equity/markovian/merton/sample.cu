// Generated Merton composition over the common sample engine.
...
void launch_merton_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots}, "merton.samples",
        "Merton terminal sample kernel");
}
...
void launch_merton_random_terminal_samples_cuda(
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "merton.samples", "Merton random terminal sample kernel");
}
