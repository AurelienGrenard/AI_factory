// Generated schobel_zhu cliquet composition over the shared price-delta engine.
...
using PricingPolicy = equity::price_delta::PathProductPriceDeltaPolicy<
    Schedule, product::CliquetPathPolicy, Path>;
static_assert(monte_carlo::PriceDeltaMonteCarloPolicy<PricingPolicy>);
}  // namespace


void launch_schobel_zhu_cliquet_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.cliquet.price_delta", "default");
}
