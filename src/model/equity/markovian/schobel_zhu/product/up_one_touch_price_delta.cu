// Generated schobel_zhu up_one_touch composition over the shared price-delta engine.
...
void launch_schobel_zhu_up_one_touch_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.up_one_touch.price_delta", "default");
}
