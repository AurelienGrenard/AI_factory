// Generated schobel_zhu straddle composition over the shared price-delta engine.
...
void launch_schobel_zhu_straddle_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.straddle.price_delta", "default");
}
