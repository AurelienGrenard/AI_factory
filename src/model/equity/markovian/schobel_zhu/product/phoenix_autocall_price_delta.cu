// Generated schobel_zhu phoenix_autocall composition over the shared price-delta engine.
...
using PricingPolicy = equity::price_delta::PathProductPriceDeltaPolicy<
    Schedule, product::PhoenixAutocallPathPolicy, Path>;
static_assert(monte_carlo::PriceDeltaMonteCarloPolicy<PricingPolicy>);
}  // namespace


void launch_schobel_zhu_phoenix_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.phoenix_autocall.price_delta", "default");
}
