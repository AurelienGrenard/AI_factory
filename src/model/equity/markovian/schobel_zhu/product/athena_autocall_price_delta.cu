// Generated schobel_zhu athena_autocall composition over the shared price-delta engine.
...
void launch_schobel_zhu_athena_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.athena_autocall.price_delta", "default");
}
