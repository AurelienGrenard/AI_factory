// Generated schobel_zhu range_accrual composition over the shared price-delta engine.
...
void launch_schobel_zhu_range_accrual_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.range_accrual.price_delta", "default");
}
