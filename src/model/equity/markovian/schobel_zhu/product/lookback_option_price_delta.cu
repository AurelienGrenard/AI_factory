// Generated schobel_zhu lookback_option composition over the shared price-delta engine.
...
void launch_schobel_zhu_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "schobel_zhu.lookback_option.price_delta", "default");
}
