// Generated Schobel-Zhu composition over the common sample engine.
...
void launch_schobel_zhu_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots, device_volatilities}, "schobel_zhu.samples",
...
void launch_schobel_zhu_random_terminal_samples_cuda(
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "schobel_zhu.samples", "Schobel-Zhu random terminal sample kernel");
}
