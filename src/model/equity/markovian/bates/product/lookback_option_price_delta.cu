// Generated bates lookback_option composition over the shared price-delta engine.
...
void launch_bates_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<PricingPolicy>(
        ...
        "bates.lookback_option.price_delta", "default");
}
