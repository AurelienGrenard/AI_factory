// Generated Bates composition over the common sample engine.
...
void launch_bates_terminal_samples_cuda(
    ...
    sample::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        dynamics_seed, {device_spots, device_variances}, "bates.samples",
        "Bates terminal sample kernel");
}

void launch_bates_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::launch_device_random_terminal_samples_cuda<TerminalPolicy>(
        ...
        "bates.samples", "Bates random terminal sample kernel");
}
