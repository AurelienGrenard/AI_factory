...
| Digital option | Closed form | strike $K$, cash amount $Q$, maturity $T$, side $\varepsilon$ | $Q\mathbf 1_{\{\varepsilon(S_T-K)>0\}}$ |
| Asset-or-nothing option | Closed form | strike $K$, maturity $T$, side $\varepsilon$ | $S_T\mathbf 1_{\{\varepsilon(S_T-K)>0\}}$ |
| Straddle | Closed form | strike $K$, maturity $T$ | $\lvert S_T-K\rvert$ |
| Gap option | Closed form | trigger $K_1$, payoff strike $K_2$, maturity $T$, side $\varepsilon$ | $\varepsilon(S_T-K_2)\mathbf 1_{\{\varepsilon(S_T-K_1)>0\}}$ |
