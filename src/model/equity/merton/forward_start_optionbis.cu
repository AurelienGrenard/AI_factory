// Experimental Merton forward-start composition over generic CUDA layers.
...
#include "product/forward_start_option/pricing_policybis.cuh"

namespace ai_factory::workbench::merton {
namespace {

using Schedule = equity::ExactTransitionCalendarSchedule<
...
template<OptionSide Side>
void launch_merton_forward_start_optionbis_cuda(
    ...
    equity::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "merton.forward_start_optionbis",
        option_side_name(Side),
        "Merton forward-start option bis kernel"
    );
}

template void launch_merton_forward_start_optionbis_cuda<OptionSide::call>(
    const ModelParameters*, std::size_t,
    const product::ForwardStartOptionParameters*, std::size_t,
    bool, std::size_t, std::size_t, std::size_t, std::size_t,
    float, unsigned int, std::size_t, std::uint64_t, float*, float*
);
template void launch_merton_forward_start_optionbis_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::ForwardStartOptionParameters*, std::size_t,
    bool, std::size_t, std::size_t, std::size_t, std::size_t,
    float, unsigned int, std::size_t, std::uint64_t, float*, float*
