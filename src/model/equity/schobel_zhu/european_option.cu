// Schobel-Zhu european-option composition over generic CUDA layers.
...
using Schedule = equity::FixedStepTerminalSchedule<schobel_zhu::DynamicsPolicy>;
using Discount = equity::ConstantRateDiscountPolicy<schobel_zhu::DynamicsPolicy>;
template<OptionSide Side>
using PricingPolicy =
    product::EuropeanOptionPricingPolicy<Schedule, Discount, Side>;
...
void launch_schobel_zhu_european_option_cuda(
    ...
    equity::launch_monte_carlo_cuda<PricingPolicy<Side>>(
        ...
        "Schobel-Zhu european option kernel"
    );
}

template void launch_schobel_zhu_european_option_cuda<OptionSide::call>(
...
template void launch_schobel_zhu_european_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::EuropeanOptionParameters*, std::size_t,
    bool, std::size_t, std::size_t, std::size_t, std::size_t,
    float, std::uint32_t, unsigned int, std::size_t, std::uint64_t,
