...
template LaunchSignature launch_schobel_zhu_double_knock_out_option_cuda<OptionSide::call>;
template LaunchSignature launch_schobel_zhu_double_knock_out_option_cuda<OptionSide::put>;
