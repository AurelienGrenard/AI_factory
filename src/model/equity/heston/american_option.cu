// Shared multi-block Heston American-option pricing with GPU Longstaff-Schwartz.
...
lsm::LaunchResult launch_heston_american_option_cuda(
    ...
    validate_heston_american_option_launch(
        device_models,
        model_count,
        host_products,
        device_products,
    ...
    for (const lsm::BatchPlan& batch : plan.batches) {
        ...
        report_cuda_kernel_launch_if_enabled(
            "heston.american_option.prepare_rows",
            "common",
            prepare_rows_kernel,
            dim3(row_blocks),
        ...
        report_cuda_kernel_launch_if_enabled(
            "heston.american_option.simulate_paths",
        ...
        for (std::uint32_t backward_level = 1U;
             ...
             ++backward_level) {
            report_cuda_kernel_launch_if_enabled(
                "heston.american_option.regression_partials",
                option_side_name(Side),
            ...
            report_cuda_kernel_launch_if_enabled(
                "heston.american_option.solve_regressions",
                "common",
            ...
            report_cuda_kernel_launch_if_enabled(
                "heston.american_option.update_cashflows",
                option_side_name(Side),
        ...
        report_cuda_kernel_launch_if_enabled(
            "heston.american_option.moment_partials",
            "common",
        ...
        report_cuda_kernel_launch_if_enabled(
            "heston.american_option.finalize_prices",
            option_side_name(Side),
...
using LaunchSignature =
    decltype(launch_heston_american_option_cuda<OptionSide::call>);
