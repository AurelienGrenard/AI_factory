...
| Digital option | MC | strike $`K`$, cash amount $`Q`$, maturity $`T`$, side $`\varepsilon`$ | $`Q\mathbf 1_{\{\varepsilon(S_T-K)\gt 0\}}`$ |
| Asset-or-nothing option | MC | strike $`K`$, maturity $`T`$, side $`\varepsilon`$ | $`S_T\mathbf 1_{\{\varepsilon(S_T-K)\gt 0\}}`$ |
| Straddle | MC | strike $`K`$, maturity $`T`$ | $`\lvert S_T-K\rvert`$ |
| Gap option | MC | trigger $`K_1`$, payoff strike $`K_2`$, maturity $`T`$, side $`\varepsilon`$ | $`\varepsilon(S_T-K_2)\mathbf 1_{\{\varepsilon(S_T-K_1)\gt 0\}}`$ |
