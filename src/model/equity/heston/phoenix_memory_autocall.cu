// Heston phoenix-memory-autocall composition over generic CUDA layers.
...
using Schedule = equity::FixedStepRegularSchedule<heston::DynamicsPolicy>;
...
void launch_heston_phoenix_memory_autocall_cuda(
    ...
    equity::launch_monte_carlo_cuda<PricingPolicy>(
        ...
        "default",
        "Heston phoenix memory autocall kernel"
    );
}
