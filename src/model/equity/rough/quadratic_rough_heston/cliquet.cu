// Quadratic rough-Heston cliquet composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_cliquet_cuda(
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston cliquet kernel"
    );
}

template void launch_quadratic_rough_heston_cliquet_cuda<
    2U
>(
