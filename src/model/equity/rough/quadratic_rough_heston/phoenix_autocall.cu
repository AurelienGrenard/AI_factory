// Quadratic rough-Heston phoenix-autocall composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_phoenix_autocall_cuda(
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston phoenix autocall kernel"
    );
}

template void launch_quadratic_rough_heston_phoenix_autocall_cuda<
    2U
>(
