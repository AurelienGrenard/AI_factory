// Quadratic rough-Heston asset-or-nothing-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_asset_or_nothing_option_cuda(
    ...
    using ProductPolicy = product::AssetOrNothingOptionPathPolicy<Side>;
    ...
    >(
        ...
        "Quadratic rough-Heston asset or nothing option kernel"
    );
}

template void launch_quadratic_rough_heston_asset_or_nothing_option_cuda<
    OptionSide::call, 2U
>(
