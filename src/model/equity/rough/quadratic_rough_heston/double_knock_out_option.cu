// Quadratic rough-Heston double-knock-out-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_double_knock_out_option_cuda(
    ...
    using ProductPolicy = product::DoubleKnockOutOptionPathPolicy<Side>;
    ...
    >(
        ...
        "Quadratic rough-Heston double knock out option kernel"
    );
}

template void launch_quadratic_rough_heston_double_knock_out_option_cuda<
    OptionSide::call, 2U
>(
