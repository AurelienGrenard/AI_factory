// Quadratic rough-Heston european-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_european_option_cuda(
    ...
    >(
        ...
        "Quadratic rough-Heston european option kernel"
    );
}

template void launch_quadratic_rough_heston_european_option_cuda<
    OptionSide::call, 2U
>(
