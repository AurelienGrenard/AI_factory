// Quadratic rough-Heston range-accrual composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_range_accrual_cuda(
    ...
    using ProductPolicy = product::RangeAccrualPathPolicy;
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston range accrual kernel"
    );
}

template void launch_quadratic_rough_heston_range_accrual_cuda<
    2U
>(
