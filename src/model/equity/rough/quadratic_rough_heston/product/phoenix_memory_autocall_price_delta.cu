// Public Quadratic rough-Heston Phoenix-memory-autocall N-factor price/spot-delta launcher.
...
void launch_quadratic_rough_heston_phoenix_memory_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.phoenix_memory_autocall_price_delta", "default");
}
