// Public Quadratic rough-Heston Lookback-option N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_lookback_option_price_delta_cuda(
    ...
    using Product = product::LookbackOptionPathPolicy;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.lookback_option_price_delta", "default");
}

template void launch_quadratic_rough_heston_lookback_option_price_delta_cuda<
    2U
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const PreparedDynamics<2U>*, std::size_t,
    const product::LookbackOptionParameters*,
