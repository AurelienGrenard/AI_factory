// Public Quadratic rough-Heston European-option N-factor price/spot-delta launcher.
...
void launch_quadratic_rough_heston_european_option_price_delta_cuda(
    ...
    using Product = product::EuropeanOptionPathPolicy<Side>;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.european_option_price_delta", option_side_name(Side));
}

template void launch_quadratic_rough_heston_european_option_price_delta_cuda<
    OptionSide::call, 2U
>(
