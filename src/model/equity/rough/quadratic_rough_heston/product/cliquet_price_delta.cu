// Public Quadratic rough-Heston Cliquet N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_cliquet_price_delta_cuda(
    ...
    using Product = product::CliquetPathPolicy;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.cliquet_price_delta", "default");
}

template void launch_quadratic_rough_heston_cliquet_price_delta_cuda<
    2U
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const PreparedDynamics<2U>*, std::size_t,
    const product::CliquetParameters*,
    const product::CliquetParameters*, std::size_t,
