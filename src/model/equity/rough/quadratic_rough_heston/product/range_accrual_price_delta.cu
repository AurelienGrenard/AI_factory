// Public Quadratic rough-Heston Range-accrual N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_range_accrual_price_delta_cuda(
    ...
    using Product = product::RangeAccrualPathPolicy;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.range_accrual_price_delta", "default");
}

template void launch_quadratic_rough_heston_range_accrual_price_delta_cuda<
    2U
>(
