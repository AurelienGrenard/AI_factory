// Public Quadratic rough-Heston Asset-or-nothing-option N-factor price/spot-delta launcher.
...
void launch_quadratic_rough_heston_asset_or_nothing_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.asset_or_nothing_option_price_delta", option_side_name(Side));
}

template void launch_quadratic_rough_heston_asset_or_nothing_option_price_delta_cuda<
    OptionSide::call, 2U
>(
