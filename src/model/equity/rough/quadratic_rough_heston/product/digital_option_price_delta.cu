// Public Quadratic rough-Heston Digital-option N-factor price/spot-delta launcher.
...
void launch_quadratic_rough_heston_digital_option_price_delta_cuda(
    ...
    using Product = product::DigitalOptionPathPolicy<Side>;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "quadratic_rough_heston.digital_option_price_delta", option_side_name(Side));
}

template void launch_quadratic_rough_heston_digital_option_price_delta_cuda<
    OptionSide::call, 2U
>(
