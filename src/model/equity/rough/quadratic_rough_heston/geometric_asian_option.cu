// Quadratic rough-Heston geometric-asian-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_geometric_asian_option_cuda(
    ...
    >(
        ...
        "Quadratic rough-Heston geometric asian option kernel"
    );
}

template void launch_quadratic_rough_heston_geometric_asian_option_cuda<
    OptionSide::call, 2U
>(
