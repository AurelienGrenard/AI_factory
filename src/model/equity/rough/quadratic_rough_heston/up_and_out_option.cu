// Quadratic rough-Heston up-and-out-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_up_and_out_option_cuda(
    ...
    >(
        ...
        "Quadratic rough-Heston up and out option kernel"
    );
}

template void launch_quadratic_rough_heston_up_and_out_option_cuda<
    OptionSide::call, 2U
>(
