// Quadratic rough-Heston up-no-touch composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_up_no_touch_cuda(
    ...
    using ProductPolicy = product::UpNoTouchPathPolicy;
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston up no touch kernel"
    );
}

template void launch_quadratic_rough_heston_up_no_touch_cuda<
    2U
>(
    const ModelParameters*, std::size_t,
    const PreparedDynamics<2U>*, std::size_t,
    const product::UpNoTouchParameters*, std::size_t,
