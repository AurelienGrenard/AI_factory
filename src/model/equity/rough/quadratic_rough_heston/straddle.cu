// Quadratic rough-Heston straddle composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_straddle_cuda(
    ...
    using ProductPolicy = product::StraddlePathPolicy;
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston straddle kernel"
    );
}

template void launch_quadratic_rough_heston_straddle_cuda<
    2U
>(
