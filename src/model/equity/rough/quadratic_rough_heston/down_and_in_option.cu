// Quadratic rough-Heston down-and-in-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_down_and_in_option_cuda(
    ...
    >(
        ...
        "Quadratic rough-Heston down and in option kernel"
    );
}

template void launch_quadratic_rough_heston_down_and_in_option_cuda<
    OptionSide::call, 2U
>(
