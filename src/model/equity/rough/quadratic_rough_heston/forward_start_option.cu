// Quadratic rough-Heston forward-start-option composition over a prepared N-factor lift.
#include "model/equity/rough/quadratic_rough_heston/forward_start_option.cuh"

#include "common/simulation/schedule.cuh"
#include "model/equity/rough/quadratic_rough_heston/markovian_pricing.cuh"
...
using Schedule = simulation::FixedStepCalendarSchedule<DynamicsPolicy<FactorCount>, 2U>;

}  // namespace

template<OptionSide Side, std::size_t FactorCount>
void launch_quadratic_rough_heston_forward_start_option_cuda(
    ...
    using ProductPolicy = product::ForwardStartOptionPathPolicy<Side>;
    ...
    >(
        ...
        "Quadratic rough-Heston forward start option kernel"
    );
}

template void launch_quadratic_rough_heston_forward_start_option_cuda<
    OptionSide::call, 2U
>(
