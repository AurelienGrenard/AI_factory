// Quadratic rough-Heston gap-option composition over a prepared N-factor lift.
...
void launch_quadratic_rough_heston_gap_option_cuda(
    ...
    >(
        ...
        "Quadratic rough-Heston gap option kernel"
    );
}

template void launch_quadratic_rough_heston_gap_option_cuda<
    OptionSide::call, 2U
>(
