// Quadratic rough-Heston lookback-option composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_quadratic_rough_heston_lookback_option_cuda(
    ...
    >(
        ...
        "default",
        "Quadratic rough-Heston lookback option kernel"
    );
}

template void launch_quadratic_rough_heston_lookback_option_cuda<
    2U
>(
