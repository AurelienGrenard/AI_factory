// Rough-Heston cliquet composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_cliquet_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston cliquet kernel"
    );
}

template void launch_rough_heston_cliquet_cuda<
    2U
>(
