// Rough-Heston up-no-touch composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_up_no_touch_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston up no touch kernel"
    );
}

template void launch_rough_heston_up_no_touch_cuda<
    2U
>(
