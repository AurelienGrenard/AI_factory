// Rough-Heston athena-autocall composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_athena_autocall_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston athena autocall kernel"
    );
}

template void launch_rough_heston_athena_autocall_cuda<
    2U
>(
