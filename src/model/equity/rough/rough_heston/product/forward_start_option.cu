// Rough-Heston forward-start-option composition over a prepared N-factor lift.
...
void launch_rough_heston_forward_start_option_cuda(
    ...
    >(
        ...
        "Rough-Heston forward start option kernel"
    );
}

template void launch_rough_heston_forward_start_option_cuda<
    OptionSide::call, 2U
>(
