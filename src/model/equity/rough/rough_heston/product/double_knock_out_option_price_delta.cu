// Public Rough-Heston Double-knock-out-option N-factor price/spot-delta launcher.
...
void launch_rough_heston_double_knock_out_option_price_delta_cuda(
    ...
    using Product = product::DoubleKnockOutOptionPathPolicy<Side>;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.double_knock_out_option_price_delta", option_side_name(Side));
}

template void launch_rough_heston_double_knock_out_option_price_delta_cuda<
    OptionSide::call, 2U
>(
