// Rough-Heston double-knock-out-option composition over a prepared N-factor lift.
...
void launch_rough_heston_double_knock_out_option_cuda(
    ...
    >(
        ...
        "Rough-Heston double knock out option kernel"
    );
}

template void launch_rough_heston_double_knock_out_option_cuda<
    OptionSide::call, 2U
>(
