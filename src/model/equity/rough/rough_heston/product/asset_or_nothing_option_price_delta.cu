// Public Rough-Heston Asset-or-nothing-option N-factor price/spot-delta launcher.
...
void launch_rough_heston_asset_or_nothing_option_price_delta_cuda(
    ...
    using Product = product::AssetOrNothingOptionPathPolicy<Side>;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.asset_or_nothing_option_price_delta", option_side_name(Side));
}

template void launch_rough_heston_asset_or_nothing_option_price_delta_cuda<
    OptionSide::call, 2U
>(
