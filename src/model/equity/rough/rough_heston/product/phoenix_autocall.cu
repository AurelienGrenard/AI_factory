// Rough-Heston phoenix-autocall composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_phoenix_autocall_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston phoenix autocall kernel"
    );
}

template void launch_rough_heston_phoenix_autocall_cuda<
    2U
>(
