// Rough-Heston up-one-touch composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_up_one_touch_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston up one touch kernel"
    );
}

template void launch_rough_heston_up_one_touch_cuda<
    2U
>(
