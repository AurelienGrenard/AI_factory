// Rough-Heston phoenix-memory-autocall composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_phoenix_memory_autocall_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston phoenix memory autocall kernel"
    );
}

template void launch_rough_heston_phoenix_memory_autocall_cuda<
    2U
>(
