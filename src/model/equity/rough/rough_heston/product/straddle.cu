// Rough-Heston straddle composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_straddle_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston straddle kernel"
    );
}

template void launch_rough_heston_straddle_cuda<
    2U
>(
