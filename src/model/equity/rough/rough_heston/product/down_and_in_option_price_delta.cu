// Public Rough-Heston Down-and-in-option N-factor price/spot-delta launcher.
...
void launch_rough_heston_down_and_in_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.down_and_in_option_price_delta", option_side_name(Side));
}

template void launch_rough_heston_down_and_in_option_price_delta_cuda<
    OptionSide::call, 2U
>(
