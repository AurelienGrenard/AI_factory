// Rough-Heston european-option composition over a prepared N-factor lift.
...
void launch_rough_heston_european_option_cuda(
    ...
    >(
        ...
        "Rough-Heston european option kernel"
    );
}

template void launch_rough_heston_european_option_cuda<
    OptionSide::call, 2U
>(
