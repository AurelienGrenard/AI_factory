// Public Rough-Heston Up-one-touch N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_rough_heston_up_one_touch_price_delta_cuda(
    ...
    using Product = product::UpOneTouchPathPolicy;
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.up_one_touch_price_delta", "default");
}

template void launch_rough_heston_up_one_touch_price_delta_cuda<
    2U
>(
