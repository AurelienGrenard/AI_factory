// Rough-Heston gap-option composition over a prepared N-factor lift.
...
void launch_rough_heston_gap_option_cuda(
    ...
    >(
        ...
        "Rough-Heston gap option kernel"
    );
}

template void launch_rough_heston_gap_option_cuda<
    OptionSide::call, 2U
>(
