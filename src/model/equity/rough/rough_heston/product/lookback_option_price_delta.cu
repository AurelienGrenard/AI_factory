// Public Rough-Heston Lookback-option N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_rough_heston_lookback_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.lookback_option_price_delta", "default");
}

template void launch_rough_heston_lookback_option_price_delta_cuda<
    2U
>(
