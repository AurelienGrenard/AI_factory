// Public Rough-Heston Athena-autocall N-factor price/spot-delta launcher.
...
template<std::size_t FactorCount>
void launch_rough_heston_athena_autocall_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.athena_autocall_price_delta", "default");
}

template void launch_rough_heston_athena_autocall_price_delta_cuda<
    2U
>(
