// Rough-Heston up-and-in-option composition over a prepared N-factor lift.
...
void launch_rough_heston_up_and_in_option_cuda(
    ...
    >(
        ...
        "Rough-Heston up and in option kernel"
    );
}

template void launch_rough_heston_up_and_in_option_cuda<
    OptionSide::call, 2U
>(
