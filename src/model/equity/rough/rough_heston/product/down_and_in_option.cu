// Rough-Heston down-and-in-option composition over a prepared N-factor lift.
...
void launch_rough_heston_down_and_in_option_cuda(
    ...
    >(
        ...
        "Rough-Heston down and in option kernel"
    );
}

template void launch_rough_heston_down_and_in_option_cuda<
    OptionSide::call, 2U
>(
