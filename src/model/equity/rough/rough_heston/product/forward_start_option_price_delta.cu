// Public Rough-Heston Forward-start-option N-factor price/spot-delta launcher.
...
void launch_rough_heston_forward_start_option_price_delta_cuda(
    ...
    monte_carlo::launch_monte_carlo_price_delta_cuda<Policy>(
        ...
        "rough_heston.forward_start_option_price_delta", option_side_name(Side));
}

template void launch_rough_heston_forward_start_option_price_delta_cuda<
    OptionSide::call, 2U
>(
