// Rough-Heston digital-option composition over a prepared N-factor lift.
...
void launch_rough_heston_digital_option_cuda(
    ...
    >(
        ...
        "Rough-Heston digital option kernel"
    );
}

template void launch_rough_heston_digital_option_cuda<
    OptionSide::call, 2U
>(
