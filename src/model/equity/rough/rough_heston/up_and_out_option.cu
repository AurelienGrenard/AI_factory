// Rough-Heston up-and-out-option composition over a prepared N-factor lift.
...
void launch_rough_heston_up_and_out_option_cuda(
    ...
    >(
        ...
        "Rough-Heston up and out option kernel"
    );
}

template void launch_rough_heston_up_and_out_option_cuda<
    OptionSide::call, 2U
>(
