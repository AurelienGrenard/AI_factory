// Rough-Heston range-accrual composition over a prepared N-factor lift.
...
template<std::size_t FactorCount>
void launch_rough_heston_range_accrual_cuda(
    ...
    >(
        ...
        "default",
        "Rough-Heston range accrual kernel"
    );
}

template void launch_rough_heston_range_accrual_cuda<
    2U
>(
