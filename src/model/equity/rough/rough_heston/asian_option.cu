// Rough-Heston asian-option composition over a prepared N-factor lift.
...
void launch_rough_heston_asian_option_cuda(
    ...
    >(
        ...
        "Rough-Heston asian option kernel"
    );
}

template void launch_rough_heston_asian_option_cuda<
    OptionSide::call, 2U
>(
