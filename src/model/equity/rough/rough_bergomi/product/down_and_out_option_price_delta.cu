...
void launch_rough_bergomi_down_and_out_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.down_and_out_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_down_and_out_option_price_delta_cuda<
    OptionSide::call
>(
