// Rough-Bergomi up-and-out-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_up_and_out_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.up_and_out_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_up_and_out_option_price_delta_cuda<
    OptionSide::call
>(
