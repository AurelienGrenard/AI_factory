// Rough-Bergomi gap-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_gap_option_price_delta_cuda(
    ...
    using ProductPolicy = product::GapOptionPathPolicy<Side>;
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.gap_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_gap_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::GapOptionParameters*, const product::GapOptionParameters*, std::size_t,
