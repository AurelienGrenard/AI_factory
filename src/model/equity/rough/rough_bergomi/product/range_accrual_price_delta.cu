// Rough-Bergomi range-accrual composition over the Volterra FFT engine.
...
void launch_rough_bergomi_range_accrual_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.range_accrual.price_delta",
        "default"
    );
}
