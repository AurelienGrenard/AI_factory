// Rough-Bergomi double-knock-out-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_double_knock_out_option_cuda(
...
template void launch_rough_bergomi_double_knock_out_option_cuda<
    OptionSide::call
>(
