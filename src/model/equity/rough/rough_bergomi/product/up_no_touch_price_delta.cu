// Rough-Bergomi up-no-touch composition over the Volterra FFT engine.
...
void launch_rough_bergomi_up_no_touch_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.up_no_touch.price_delta",
        "default"
    );
}
