// Rough-Bergomi european-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_european_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.european_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_european_option_price_delta_cuda<
    OptionSide::call
>(
