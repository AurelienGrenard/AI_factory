// Rough-Bergomi forward-start-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_forward_start_option_price_delta_cuda(
    ...
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::CalendarHybridSchedule<2U>,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.forward_start_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_forward_start_option_price_delta_cuda<
    OptionSide::call
>(
