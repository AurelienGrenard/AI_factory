// Rough-Bergomi asset-or-nothing-option composition over the Volterra FFT engine.
...
void launch_rough_bergomi_asset_or_nothing_option_price_delta_cuda(
    ...
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::TerminalHybridSchedule,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_bergomi.asset_or_nothing_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_bergomi_asset_or_nothing_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::AssetOrNothingOptionParameters*, const product::AssetOrNothingOptionParameters*, std::size_t,
