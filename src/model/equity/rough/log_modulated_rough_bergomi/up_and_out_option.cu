// Log-modulated rough-Bergomi up-and-out-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_up_and_out_option_cuda(
...
template void launch_log_modulated_rough_bergomi_up_and_out_option_cuda<
    OptionSide::call
>(
