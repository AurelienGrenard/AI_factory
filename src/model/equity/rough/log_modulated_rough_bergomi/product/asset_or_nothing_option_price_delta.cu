// Log-modulated rough-Bergomi asset-or-nothing-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_asset_or_nothing_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.asset_or_nothing_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_asset_or_nothing_option_price_delta_cuda<
    OptionSide::call
>(
