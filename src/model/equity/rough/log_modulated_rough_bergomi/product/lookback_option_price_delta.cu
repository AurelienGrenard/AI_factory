// Log-modulated rough-Bergomi lookback-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_lookback_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.lookback_option.price_delta",
        "default"
    );
}
