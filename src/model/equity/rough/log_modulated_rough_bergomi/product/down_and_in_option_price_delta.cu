// Log-modulated rough-Bergomi down-and-in-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_down_and_in_option_price_delta_cuda(
    ...
    using ProductPolicy = product::DownAndInOptionPathPolicy<Side>;
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::LogModulatedHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::DenseHybridSchedule,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.down_and_in_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_down_and_in_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::DownAndInOptionParameters*, const product::DownAndInOptionParameters*, std::size_t,
