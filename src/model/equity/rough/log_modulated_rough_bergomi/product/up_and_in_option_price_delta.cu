// Log-modulated rough-Bergomi up-and-in-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_up_and_in_option_price_delta_cuda(
    ...
    using ProductPolicy = product::UpAndInOptionPathPolicy<Side>;
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.up_and_in_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_up_and_in_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::UpAndInOptionParameters*, const product::UpAndInOptionParameters*, std::size_t,
