...
void launch_log_modulated_rough_bergomi_gap_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.gap_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_gap_option_price_delta_cuda<
    OptionSide::call
>(
