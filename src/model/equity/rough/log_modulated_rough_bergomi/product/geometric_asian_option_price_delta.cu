// Log-modulated rough-Bergomi geometric-asian-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_geometric_asian_option_price_delta_cuda(
    ...
    using ProductPolicy = product::GeometricAsianOptionPathPolicy<Side>;
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.geometric_asian_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_geometric_asian_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::GeometricAsianOptionParameters*, const product::GeometricAsianOptionParameters*, std::size_t,
