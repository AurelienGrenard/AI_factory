// Log-modulated rough-Bergomi down-and-out-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_down_and_out_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "log_modulated_rough_bergomi.down_and_out_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_log_modulated_rough_bergomi_down_and_out_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::DownAndOutOptionParameters*, const product::DownAndOutOptionParameters*, std::size_t,
