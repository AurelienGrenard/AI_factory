// Log-modulated rough-Bergomi gap-option composition over the Volterra FFT engine.
...
void launch_log_modulated_rough_bergomi_gap_option_cuda(
...
template void launch_log_modulated_rough_bergomi_gap_option_cuda<
    OptionSide::call
>(
