// Generated Log-modulated rough-Bergomi composition over the shared Volterra FFT sampler.
...
using TerminalPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::LogModulatedHybridKernelPolicy, PathPolicy, volterra::TerminalHybridSchedule, Observation>;
using CalendarPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::LogModulatedHybridKernelPolicy, PathPolicy, volterra::StubbedRegularHybridSchedule, Observation>;
...
void launch_log_modulated_rough_bergomi_terminal_samples_cuda(
    ...
    sample::volterra_fft::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        {device_spots}, "log_modulated_rough_bergomi.samples",
        "Log-modulated rough-Bergomi terminal FFT sample kernel");
}

void launch_log_modulated_rough_bergomi_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::volterra_fft::launch_device_random_terminal_samples_cuda<
        ...
        device_maturity_days, {device_spots}, "log_modulated_rough_bergomi.samples",
        "Log-modulated rough-Bergomi random terminal FFT sample kernel");
}

void launch_log_modulated_rough_bergomi_calendar_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::volterra_fft::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, block_count, dynamics_seed,
        {device_spots}, "log_modulated_rough_bergomi.samples",
        "Log-modulated rough-Bergomi calendar FFT sample kernel");
}
