// Generated Log-modulated rough-Bergomi composition over the shared FFT sampler.
...
using TerminalPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::LogModulatedHybridDriverPolicy, PathPolicy, volterra::TerminalHybridSchedule, Observation>;
using CalendarPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::LogModulatedHybridDriverPolicy, PathPolicy, volterra::StubbedRegularHybridSchedule, Observation>;
