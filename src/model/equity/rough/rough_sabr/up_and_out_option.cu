// Rough-SABR up-and-out-option composition over the Volterra FFT engine.
...
void launch_rough_sabr_up_and_out_option_cuda(
...
template void launch_rough_sabr_up_and_out_option_cuda<
    OptionSide::call
>(
