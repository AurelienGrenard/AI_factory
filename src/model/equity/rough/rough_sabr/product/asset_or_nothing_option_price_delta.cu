// Rough-SABR asset-or-nothing-option composition over the Volterra FFT engine.
...
void launch_rough_sabr_asset_or_nothing_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_sabr.asset_or_nothing_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_sabr_asset_or_nothing_option_price_delta_cuda<
    OptionSide::call
>(
