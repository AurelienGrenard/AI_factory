// Rough-SABR up-and-in-option composition over the Volterra FFT engine.
...
void launch_rough_sabr_up_and_in_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_sabr.up_and_in_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_sabr_up_and_in_option_price_delta_cuda<
    OptionSide::call
>(
