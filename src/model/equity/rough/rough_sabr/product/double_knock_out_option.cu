...
void launch_rough_sabr_double_knock_out_option_cuda(
    ...
    launch_rough_sabr_hybrid_fft_cuda<
        ProductPolicy,
...
template void launch_rough_sabr_double_knock_out_option_cuda<
    OptionSide::call
>(
