// Rough-SABR down-and-in-option composition over the Volterra FFT engine.
...
void launch_rough_sabr_down_and_in_option_price_delta_cuda(
    ...
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::DenseHybridSchedule,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_sabr.down_and_in_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_sabr_down_and_in_option_price_delta_cuda<
    OptionSide::call
>(
