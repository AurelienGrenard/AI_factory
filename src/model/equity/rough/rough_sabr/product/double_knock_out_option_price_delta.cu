...
void launch_rough_sabr_double_knock_out_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_sabr.double_knock_out_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_sabr_double_knock_out_option_price_delta_cuda<
    OptionSide::call
>(
