// Generated Rough-SABR composition over the shared FFT sampler.
...
using TerminalPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::FractionalHybridDriverPolicy, PathPolicy, volterra::TerminalHybridSchedule, Observation>;
using CalendarPolicy = sample::VolterraFftModelSamplingPolicy<
    volterra::FractionalHybridDriverPolicy, PathPolicy, volterra::StubbedRegularHybridSchedule, Observation>;
...
void launch_rough_sabr_terminal_samples_cuda(
    ...
    sample::volterra_fft::launch_device_terminal_samples_cuda<TerminalPolicy>(
        ...
        {device_spots}, "rough_sabr.samples",
        "Rough-SABR terminal FFT sample kernel");
}

void launch_rough_sabr_random_terminal_samples_cuda(
    const ModelParameters* device_parameters, std::size_t parameter_count,
    ...
    sample::volterra_fft::launch_device_random_terminal_samples_cuda<
        ...
        device_maturity_days, {device_spots}, "rough_sabr.samples",
        "Rough-SABR random terminal FFT sample kernel");
}
...
void launch_rough_sabr_calendar_samples_cuda(
    ...
    sample::volterra_fft::launch_device_calendar_samples_cuda<CalendarPolicy>(
        ...
        sample_offset, launch_sample_count, block_count, dynamics_seed,
        {device_spots}, "rough_sabr.samples",
        "Rough-SABR calendar FFT sample kernel");
}
