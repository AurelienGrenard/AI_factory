// Rough Stein-Stein down-and-out-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_down_and_out_option_cuda(
...
template void launch_rough_stein_stein_down_and_out_option_cuda<
    OptionSide::call
>(
