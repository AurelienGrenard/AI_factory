...
void launch_rough_stein_stein_double_knock_out_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.double_knock_out_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_stein_stein_double_knock_out_option_price_delta_cuda<
    OptionSide::call
>(
