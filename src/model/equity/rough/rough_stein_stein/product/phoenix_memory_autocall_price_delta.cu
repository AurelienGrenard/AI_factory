...
void launch_rough_stein_stein_phoenix_memory_autocall_price_delta_cuda(
    ...
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalResolventHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::RegularHybridSchedule,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.phoenix_memory_autocall.price_delta",
        "default"
    );
}
