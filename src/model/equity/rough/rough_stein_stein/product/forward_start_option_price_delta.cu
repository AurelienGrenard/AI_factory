// Rough Stein-Stein forward-start-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_forward_start_option_price_delta_cuda(
    ...
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalResolventHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::CalendarHybridSchedule<2U>,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.forward_start_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_stein_stein_forward_start_option_price_delta_cuda<
    OptionSide::call
>(
