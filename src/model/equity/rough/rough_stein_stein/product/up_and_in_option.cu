// Rough Stein-Stein up-and-in-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_up_and_in_option_cuda(
...
template void launch_rough_stein_stein_up_and_in_option_cuda<
    OptionSide::call
>(
