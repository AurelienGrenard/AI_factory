...
void launch_rough_stein_stein_geometric_asian_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.geometric_asian_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_stein_stein_geometric_asian_option_price_delta_cuda<
    OptionSide::call
>(
