// Rough Stein-Stein double-knock-out-option composition over the Volterra FFT engine.
...
#include "model/equity/rough/rough_stein_stein/volterra_fft_pricing.cuh"
...
void launch_rough_stein_stein_double_knock_out_option_cuda(
    ...
    launch_rough_stein_stein_hybrid_fft_cuda<
        ProductPolicy,
...
template void launch_rough_stein_stein_double_knock_out_option_cuda<
    OptionSide::call
>(
