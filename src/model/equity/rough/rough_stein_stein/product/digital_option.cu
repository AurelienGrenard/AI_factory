// Rough Stein-Stein digital-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_digital_option_cuda(
...
template void launch_rough_stein_stein_digital_option_cuda<
    OptionSide::call
>(
