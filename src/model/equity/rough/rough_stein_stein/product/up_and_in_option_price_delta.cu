...
void launch_rough_stein_stein_up_and_in_option_price_delta_cuda(
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.up_and_in_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_stein_stein_up_and_in_option_price_delta_cuda<
    OptionSide::call
>(
