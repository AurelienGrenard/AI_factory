// Rough Stein-Stein european-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_european_option_price_delta_cuda(
    ...
    using ProductPolicy = product::EuropeanOptionPathPolicy<Side>;
    volterra::hybrid_fft::launch_price_delta_cuda<
        volterra::FractionalResolventHybridKernelPolicy, PathPolicy, ProductPolicy, volterra::TerminalHybridSchedule,
    ...
    >(
        ...
        device_deltas,
        device_delta_errors,
        "rough_stein_stein.european_option.price_delta",
        option_side_name(Side)
    );
}

template void launch_rough_stein_stein_european_option_price_delta_cuda<
    OptionSide::call
>(
    const ModelParameters*, const ModelParameters*, std::size_t,
    const product::EuropeanOptionParameters*, const product::EuropeanOptionParameters*, std::size_t,
