// Rough Stein-Stein geometric-asian-option composition over the Volterra FFT engine.
...
void launch_rough_stein_stein_geometric_asian_option_cuda(
...
template void launch_rough_stein_stein_geometric_asian_option_cuda<
    OptionSide::call
>(
