// Closed-form Hull-White caplet pricing fitted to Svensson curves.
#include "model/hull_white/svensson/caplet.cuh"
...
__global__ void hull_white_svensson_caplet_kernel(
...
void validate_hull_white_svensson_caplet_launch(
    ...
    if (result_offset >= result_count
        ...
        throw std::invalid_argument(
            "The Hull-White caplet launch batch exceeds the result array."
        );
    }
...
void launch_hull_white_svensson_caplet_cuda(
    ...
    validate_hull_white_svensson_caplet_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    hull_white_svensson_caplet_kernel<<<
