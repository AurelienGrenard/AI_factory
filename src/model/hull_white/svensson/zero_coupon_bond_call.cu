// Closed-form Hull-White bond calls fitted to Svensson curves.
...
__global__ void hull_white_svensson_zero_coupon_bond_call_kernel(
...
void validate_hull_white_svensson_zero_coupon_bond_call_launch(
...
void launch_hull_white_svensson_zero_coupon_bond_call_cuda(
    const HullWhiteModelParameters* device_models,
    std::size_t model_count,
    const curve::svensson::SvenssonParameters* device_curves,
    std::size_t curve_count,
    ...
    validate_hull_white_svensson_zero_coupon_bond_call_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    hull_white_svensson_zero_coupon_bond_call_kernel<<<
