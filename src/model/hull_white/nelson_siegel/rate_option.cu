...
template LaunchSignature launch_hull_white_nelson_siegel_rate_option_cuda<OptionSide::call>;
template LaunchSignature launch_hull_white_nelson_siegel_rate_option_cuda<OptionSide::put>;
