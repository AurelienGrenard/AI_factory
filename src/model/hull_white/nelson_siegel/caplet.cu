// Closed-form Hull-White caplet pricing fitted to Nelson-Siegel curves.
...
void validate_hull_white_nelson_siegel_caplet_launch(
...
void launch_hull_white_nelson_siegel_caplet_cuda(
    ...
    validate_hull_white_nelson_siegel_caplet_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    hull_white_nelson_siegel_caplet_kernel<<<
