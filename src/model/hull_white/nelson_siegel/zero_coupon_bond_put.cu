// Closed-form Hull-White bond puts fitted to Nelson-Siegel curves.
#include "model/hull_white/nelson_siegel/zero_coupon_bond_put.cuh"
...
__global__ void hull_white_nelson_siegel_zero_coupon_bond_put_kernel(
...
void validate_hull_white_nelson_siegel_zero_coupon_bond_put_launch(
...
void launch_hull_white_nelson_siegel_zero_coupon_bond_put_cuda(
    const HullWhiteModelParameters* device_models,
    std::size_t model_count,
    const curve::nelson_siegel::NelsonSiegelParameters* device_curves,
    std::size_t curve_count,
    ...
    validate_hull_white_nelson_siegel_zero_coupon_bond_put_launch(
        device_models,
        model_count,
        device_curves,
        curve_count,
    ...
    hull_white_nelson_siegel_zero_coupon_bond_put_kernel<<<
