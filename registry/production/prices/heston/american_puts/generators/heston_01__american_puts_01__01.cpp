// Build one Heston American-put price database from JSON inputs to CUDA outputs.
...
const std::filesystem::path output_root =
    "registry/production/prices/heston/american_puts";
const std::filesystem::path generation_script =
    "registry/production/prices/heston/american_puts/generators/"
...
int main() {
    ...
    try {
        ...
        execution = heston::launch_heston_american_put_cuda(
            device_models,
            models.size(),
            products.data(),
            device_products,
