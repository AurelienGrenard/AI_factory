"""Generate the asian_arithmetic_calls_01 production product database."""
...
DATABASE_ID = "asian_arithmetic_calls_01"
ROW_COUNT = 1_000
SEED = 731_000_001
...
def main() -> None:
    write_product_recipe_database(
        ...
        product_family="asian_arithmetic_calls",
        title="Arithmetic Asian call production product parameter database",
        payoff_key="asian_arithmetic_call",
        expression="max((1/N) sum_i S_{t_i} - K, 0)",
