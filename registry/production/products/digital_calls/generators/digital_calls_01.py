"""Generate the digital_calls_01 production product database."""
...
DATABASE_ID = "digital_calls_01"


def main() -> None:
    write_product_recipe_database(
        database_id=DATABASE_ID,
        product_family="digital_calls",
        title="Cash-or-nothing digital call production product parameter database",
        payoff_key="digital_call",
        expression="1 if S_T > K else 0",
        scaling_rule="V(s, K) = V(1, K / s)",
