...
if __name__=="__main__":print(generate_result(tier="production",model_id="hull_white_01",curve_id="nelson_siegel_01",product_id="zero_coupon_bonds_01",result_version="01",engine="cpp_gpu_analytic",row_count=1000))
