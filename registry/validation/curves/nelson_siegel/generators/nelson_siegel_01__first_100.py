"""Slice the first 100 Nelson-Siegel production curves."""
...
from tools.registry.curve.slicing import DEFAULT_VALIDATION_ROW_COUNT, write_curve_slice
...
def main() -> None:
    print(
        write_curve_slice(
            ...
            source_id="nelson_siegel_01",
            target_id="nelson_siegel_01__first_100",
