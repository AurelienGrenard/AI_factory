...
if __name__=="__main__":print(write_product_slice(project_root=PROJECT_ROOT,source_id="interest_rate_swaps_01",target_id="interest_rate_swaps_01__first_100",row_count=100))
