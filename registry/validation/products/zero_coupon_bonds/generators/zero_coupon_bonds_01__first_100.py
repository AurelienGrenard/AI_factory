...
if __name__=="__main__":print(write_product_slice(project_root=PROJECT_ROOT,source_id="zero_coupon_bonds_01",target_id="zero_coupon_bonds_01__first_100",row_count=100))
