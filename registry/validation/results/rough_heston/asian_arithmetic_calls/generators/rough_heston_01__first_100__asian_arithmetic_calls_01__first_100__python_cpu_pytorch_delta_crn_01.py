"""Generate rough_heston_01__first_100__asian_arithmetic_calls_01__first_100__python_cpu_pytorch_delta_crn_01."""
...
from tools.registry.result.rough_heston.asian_arithmetic_calls import (
    AUDIT_ROW_COUNT,
    DEFAULT_NUM_PATHS,
...
def main() -> None:
    ...
    print(
        generate_validation_reprice_result(
            engine="python_cpu_pytorch_delta_crn",
            device="cpu",
