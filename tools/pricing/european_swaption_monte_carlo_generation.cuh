...
void generate_european_swaption_monte_carlo_prices(
    ...
    offline::cuda::MonteCarloGenerationCheckpoint checkpoint(result_count);
    offline::cuda::GenerationProgress progress(
    ...
    const auto publish = [&](const auto&... input_paths) {
      write_monte_carlo_price_dataset(
        ...
        recipe.paths_per_price, "", execution_metadata,
