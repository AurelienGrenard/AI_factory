...
inline datasets::ModelSampleRecipe recipe(
    ...
    return {
        ...
        "block-cooperative hybrid FFT at dt=1/504",
        {
            ...
            {"proposal_draw_order", {"spot", "risk_free_rate", "dividend_yield", "volatility_level", "mean_reversion", "volatility_of_volatility", "hurst_exponent", "rho"}},
...
inline int generate(int argc, char** argv, datasets::ModelSampleRecipe value) {
    const auto native_block = model_binding::rough_stein_stein_sample_block_dimensions(value.maximum_maturity_days);
