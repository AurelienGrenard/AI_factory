// Generated Build one ${model_display} ${curve_display} ${payoff_name} price dataset.
#include "model/fixed_income/${model}/product/${curve}/rate_option.cuh"
...
const std::string numerical_method =
    "${model_display} closed-form ${pricing_formula}";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_${model}_${curve}_rate_option_cuda<OptionSide::${option_side}>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
