// Generated ${model} European price/selected-gradient launcher and host scenario builder.
#pragma once
#include "common/price_gradients/launch.cuh"
#include "common/option_side.cuh"
#include "model/equity/markovian/${model}/price_gradients/parameter_policy.cuh"
...
inline EuropeanOptionPriceGradientPlan prepare_${model}_european_option_price_gradients(
