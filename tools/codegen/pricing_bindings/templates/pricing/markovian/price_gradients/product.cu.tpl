// Generated ${model} European composition over the common selected-gradient MC engine.
...
void launch_${model}_european_option_price_gradients_cuda(
    ...
    if (configuration.method != pg::PricingMethod::monte_carlo)
        throw std::invalid_argument("${model} European gradients require Monte Carlo.");
