// Generated Black-Scholes $product_type composition over shared closed-form bumping.
#include "model/equity/markovian/black_scholes/product/${product}_price_delta.cuh"
...
void launch_black_scholes_${product}_price_delta_cuda(
    ...
    $calendar_guard
    using PricePolicy = $price_policy;
    ...
    closed_form::launch_closed_form_price_delta_cuda<Policy>(
        ...
        $time_configuration, threads_per_block, block_count, device_prices, device_deltas,
        "black_scholes.${product}.price_delta", $diagnostic_variant);
}
