// Generated Closed-form rate-option composition under the ${model_display} short-rate model.
...
template void launch_${model}_rate_option_cuda<OptionSide::call>(
...
template void launch_${model}_rate_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::RateOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, float,
    unsigned int, std::size_t, float*
