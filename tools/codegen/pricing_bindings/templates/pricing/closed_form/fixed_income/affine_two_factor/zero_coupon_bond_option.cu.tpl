// Generated Closed-form zero-coupon-bond-option composition under ${model_display}.
#include "model/fixed_income/${model}/product/zero_coupon_bond_option.cuh"
...
template<OptionSide Side>
void launch_${model}_zero_coupon_bond_option_cuda(
    ...
    closed_form::launch_closed_form_cuda<PricingPolicy<Side>>(
        ...
        block_count,
        device_prices,
        "${model}.zero_coupon_bond_option",
        option_side_name(Side),
        "${model_display} zero-coupon bond option kernel"
    );
}

template void launch_${model}_zero_coupon_bond_option_cuda<OptionSide::call>(
...
template void launch_${model}_zero_coupon_bond_option_cuda<OptionSide::put>(
    const ModelParameters*, std::size_t,
    const product::ZeroCouponBondOptionParameters*, std::size_t,
    PriceConstruction, std::size_t, std::size_t, std::size_t, float,
    unsigned int, std::size_t, float*
