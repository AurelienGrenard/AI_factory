// Generated Closed-form ${model_display} rate-option composition fitted to a parametric curve.
...
template<OptionSide Side>
void launch_${model}_${curve}_rate_option_cuda(
    ...
    closed_form::launch_closed_form_cuda<PricingPolicy<Side>>(
        ...
        block_count,
        device_prices,
        "${model}.${curve}.rate_option",
        option_side_name(Side),
        "${model_display} rate_option kernel"
    );
}

template void launch_${model}_${curve}_rate_option_cuda<
    OptionSide::call
>(
