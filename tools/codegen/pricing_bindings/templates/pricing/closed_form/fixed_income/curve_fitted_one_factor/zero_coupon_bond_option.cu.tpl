// Generated Closed-form ${model_display} zero-coupon-bond-option composition.
...
template<OptionSide Side>
void launch_${model}_${curve}_zero_coupon_bond_option_cuda(
    ...
    closed_form::launch_closed_form_cuda<PricingPolicy<Side>>(
        ...
        block_count,
        device_prices,
        "${model}.${curve}.zero_coupon_bond_option",
        option_side_name(Side),
        "${model_display} zero-coupon bond option kernel"
    );
}

template void launch_${model}_${curve}_zero_coupon_bond_option_cuda<
    OptionSide::call
>(
