// Generated $display composition over the prepared Markovian N-factor sample engine.
...
void launch_${model_name}_terminal_samples_cuda(
    ...
    sample::launch_device_prepared_terminal_samples_cuda<
        ...
        block_count, dynamics_seed, {$output_values}, "$model_name.samples",
...
#define AI_FACTORY_INSTANTIATE_SAMPLE(FACTORS) \
    template void launch_${model_name}_terminal_samples_cuda<FACTORS>( \
    ...
    template void launch_${model_name}_random_terminal_samples_cuda<FACTORS>( \
        const PreparedDynamics<FACTORS>*, std::size_t, std::size_t, \
        std::uint32_t, std::uint32_t, std::size_t, std::size_t, unsigned int, \
        std::size_t, std::uint64_t, std::uint64_t, std::uint32_t* \
        $output_types); \
    template void launch_${model_name}_calendar_samples_cuda<FACTORS>( \
        const PreparedDynamics<FACTORS>*, std::size_t, std::size_t, \
