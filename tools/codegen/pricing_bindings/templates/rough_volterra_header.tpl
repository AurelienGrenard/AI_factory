// Public {model_display} {header_product_comment} hybrid-FFT launcher.
#pragma once

#include "common/option_side.cuh"
#include "common/price_construction.cuh"
#include "model/equity/rough/{model}/parameters.hpp"
#include "model/equity/rough/{model}/pricing_workspace.cuh"
