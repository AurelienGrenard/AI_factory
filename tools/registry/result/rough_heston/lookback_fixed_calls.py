"""Shared Rough Heston fixed-lookback priced result recipes."""
...
from ai_factory.pytorch.rough_heston.lookback_fixed_calls import (
...
def source_files_for_engine(engine: str) -> list[str]:
    common = ["tools/registry/result/rough_heston/lookback_fixed_calls.py"]
    if engine.startswith("python_"):
        return [
            ...
            "src_python/ai_factory/pytorch/rough_heston/lookback_fixed_calls.py",
            *common,
        ]
    if engine in {"cpp_cpu_philox", "cpp_cpu_philox_delta_crn"}:
        return [
            ...
            "src_cpp/ai_factory/cpu/rough_heston/lookback_fixed_calls.cpp",
    ...
    if engine in {"cpp_gpu_philox", "cpp_gpu_philox_delta_crn"}:
        return [
            ...
            "src_cpp/ai_factory/cuda/rough_heston/lookback_fixed_calls.cu",
