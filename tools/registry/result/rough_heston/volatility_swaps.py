"""Shared Rough Heston volatility swap priced result recipes."""
...
from ai_factory.pytorch.rough_heston.volatility_swaps import (
...
def source_files_for_engine(engine: str) -> list[str]:
    common = ["tools/registry/result/rough_heston/volatility_swaps.py"]
    if engine.startswith("python_"):
        return [
            ...
            "src_python/ai_factory/pytorch/rough_heston/volatility_swaps.py",
            *common,
        ]
    if engine in {"cpp_cpu_philox", "cpp_cpu_philox_delta_crn"}:
        return [
            ...
            "src_cpp/ai_factory/cpu/rough_heston/volatility_swaps.cpp",
    ...
    if engine in {"cpp_gpu_philox", "cpp_gpu_philox_delta_crn"}:
        return [
            ...
            "src_cpp/ai_factory/cuda/rough_heston/volatility_swaps.cu",
