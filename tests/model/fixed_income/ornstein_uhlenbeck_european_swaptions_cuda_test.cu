...
using WorkDistribution = ai_factory::workbench::closed_form::WorkDistribution;
using RegularLauncher = void (*)(
    ...
    std::size_t, float*, std::uint32_t, WorkDistribution
);
