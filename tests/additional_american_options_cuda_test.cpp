...
void validate_side(
    ...
    lsm::validate_regression_diagnostics(
        execution, "additional American option"
    );
    ai_factory::workbench::check_cuda(
        ...
        "cudaMemcpy additional American prices"
    );
    ai_factory::workbench::check_cuda(
        cudaMemcpy(
        ...
        "cudaMemcpy additional American errors"
    );
...
void validate_model(
    ...
    ai_factory::workbench::check_cuda(
        ...
        "cudaMemcpy additional American models"
    );
    ai_factory::workbench::check_cuda(
        cudaMemcpy(
        ...
        "cudaMemcpy additional American products"
    );
