...
using Model = ai_factory::workbench::model::hull_white::HullWhiteModelParameters;
...
int main() {
    ...
    namespace hw = model::hull_white::nelson_siegel;
    ...
    check_launcher(
        ...
        curves,
        floorlets,
        hw::launch_hull_white_nelson_siegel_floorlet_cuda,
        [](const Model& model,
           const Curve& curve,
    ...
    check_launcher(
        ...
        curves,
        calls,
        hw::launch_hull_white_nelson_siegel_zero_coupon_bond_call_cuda,
        [](const Model& model,
           const Curve& curve,
    ...
    check_launcher(
        ...
        curves,
        puts,
        hw::launch_hull_white_nelson_siegel_zero_coupon_bond_put_cuda,
        [](const Model& model,
           const Curve& curve,
