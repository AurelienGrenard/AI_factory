...
int main() {
    ...
    require(
        ...
        "The first named diagnostic phase was not reserved."
    );
    require(
        reserve_cuda_kernel_phase_launch_diagnostics(
            "diagnostic.pipeline",
        ...
        "A distinct diagnostic phase collided with the first phase."
    );
    require(
        !reserve_cuda_kernel_phase_launch_diagnostics(
            "diagnostic.pipeline",
        ...
        "A repeated named diagnostic phase was not deduplicated."
    );
