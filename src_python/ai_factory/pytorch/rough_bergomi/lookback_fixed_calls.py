"""Rough Bergomi fixed-strike lookback call pricing in PyTorch."""
...
from ai_factory.pytorch.rough_bergomi.pathwise import simulate_max_spot_batch
...
def price_batch(
    ...
    *,
    ...
    return call_price_batch(
        ...
        num_steps=num_steps,
        device=device,
        simulate_batch=simulate_max_spot_batch,
        strike_key="strike",
        dtype=dtype,
