"""Validate Heston European-call datasets against Premia's closed formula."""

from validation.premia.model.equity.heston.european_option import (
    validation_from_premia_heston_option,
)
...
def validation_from_premia(path, tolerances=ValidationTolerances()):
    ...
    return validation_from_premia_heston_option(path, "call", tolerances)
