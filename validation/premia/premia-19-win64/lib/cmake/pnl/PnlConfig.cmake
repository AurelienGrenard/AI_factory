...
if (PNL_FOUND)
    if (MSVC)
        ...
        set(PNL_INCLUDE_DIRS ${PNL_INCLUDE_DIR} )
        set(PNL_LIBRARIES ${PNL_LIBRARY} /usr/local/src/libs/lapack-3.7.1/build-win64/lib/libblas.lib;/usr/local/src/libs/lapack-3.7.1/build-win64/lib/liblapack.lib;/usr/local/src/libs/lapack-3.7.1/build-win64/lib/libblas.lib)
    endif(MSVC)
