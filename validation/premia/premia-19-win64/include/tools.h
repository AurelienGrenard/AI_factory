...
PremiaAsset* premia_get_asset_from_name(const char *name);
Model* premia_get_model_from_name(PremiaAsset *asset, const char *name);
Option* premia_get_option_from_name(PremiaAsset *asset, Model *model, const char *name);
Option* premia_get_option_and_family_from_name(PremiaAsset *asset, Model *model, const char *name, Family* family);
PricingMethod* premia_get_method_from_name(PremiaAsset *asset, Model *model, Option *option, const char *name);
