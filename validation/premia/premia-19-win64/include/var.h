...
extern int charPtr_to_PnlVect(PnlVect *x, const char *s);

extern int premia_clone_vars(VAR **res, int flag, const VAR *vars, int n);

extern void free_premia_model(Model *);
extern void free_premia_option(Option *);
extern void free_premia_method(PricingMethod *);
extern void free_premia_var(VAR *x);
