"""Validate Variance-Gamma asset-or-nothing calls against QuantLib identities."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    ...
    return validation_from_quantlib_variance_gamma_option(
        path, "asset_or_nothing_call", tolerances
    )
