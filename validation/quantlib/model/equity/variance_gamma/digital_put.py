"""Validate Variance-Gamma digital puts against QuantLib's Variance-Gamma distribution."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    ...
    return validation_from_quantlib_variance_gamma_option(path, "digital_put", tolerances)
