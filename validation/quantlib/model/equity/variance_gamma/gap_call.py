"""Validate Variance-Gamma gap calls against QuantLib digital identities."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every generated gap-call price with QuantLib."""

    return validation_from_quantlib_variance_gamma_option(path, "gap_call", tolerances)
