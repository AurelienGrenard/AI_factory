"""Compare discrete up one-touches with QuantLib's independent discrete Bates paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    ...
    return validation_from_quantlib_bates_option(path, "up_one_touch", tolerances)
