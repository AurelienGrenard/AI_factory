"""Validate Heston Cliquets against independent QuantLib paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every generated Cliquet price with independent QuantLib MC."""

    return validation_from_quantlib_heston_option(path, "cliquet", tolerances)
