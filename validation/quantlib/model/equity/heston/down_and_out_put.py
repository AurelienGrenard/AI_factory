"""Validate discrete Heston down-and-out puts with independent QuantLib paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every discretely monitored down-and-out-put price with QuantLib."""

    return validation_from_quantlib_heston_option(
        path, "down_and_out_put", tolerances
    )
