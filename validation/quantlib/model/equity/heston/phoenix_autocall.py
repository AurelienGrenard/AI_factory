"""Validate Heston Phoenix autocalls against independent QuantLib paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every Phoenix-autocall price with independent QuantLib MC."""

    return validation_from_quantlib_heston_option(
        path, "phoenix_autocall", tolerances
    )
