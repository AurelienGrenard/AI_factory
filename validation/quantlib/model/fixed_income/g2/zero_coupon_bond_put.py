"""Validate standalone G2 zero-coupon bond puts."""

from validation.quantlib.model.fixed_income.g2.reference import quantlib_model
...
def validation_from_quantlib(path, tolerances=ValidationTolerances()):
    return validation_from_quantlib_rate_option(
        path, quantlib_model, "zero_coupon_bond_put", False, tolerances
    )
