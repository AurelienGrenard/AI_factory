"""Validate Heston geometric Asian calls against independent QuantLib MC."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every geometric-Asian-call price with independent QuantLib MC."""

    return validation_from_quantlib_heston_option(
        path, "geometric_asian_call", tolerances
    )
