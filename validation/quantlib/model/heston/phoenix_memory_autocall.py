"""Validate Heston Phoenix Memory autocalls with independent QuantLib paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every Phoenix-Memory price with independent QuantLib MC."""

    return validation_from_quantlib_heston_option(
        path, "phoenix_memory_autocall", tolerances
    )
