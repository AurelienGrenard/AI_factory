"""Validate Heston Range Accruals against independent QuantLib paths."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every Range Accrual price with independent QuantLib MC."""

    return validation_from_quantlib_heston_option(path, "range_accrual", tolerances)
