"""Validate Heston American puts against QuantLib's finite-difference engine."""
...
def validation_from_quantlib(path, tolerances=_TOLERANCES):
    """Compare every generated early-exercise put price with QuantLib PDE."""

    return validation_from_quantlib_heston_option(path, "american_put", tolerances)
