...
const std::filesystem::path dataset_path =
    "datasets/price/g2/zero_coupon_bond_puts/"
    "g2_01__zero_coupon_bond_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc G2 zero-coupon bond put prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "G2 ZCB put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy G2 zero-coupon bond put prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree G2 ZCB put prices");
