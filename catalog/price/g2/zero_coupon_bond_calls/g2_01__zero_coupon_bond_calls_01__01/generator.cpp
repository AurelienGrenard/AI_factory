...
const std::filesystem::path dataset_path =
    "datasets/price/g2/zero_coupon_bond_calls/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc G2 zero-coupon bond call prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "G2 ZCB call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy G2 zero-coupon bond call prices"
        );
    } catch (...) {
