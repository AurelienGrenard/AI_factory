...
const std::filesystem::path dataset_path =
    "datasets/price/vasicek/floorlets/"
    "vasicek_01__floorlets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Vasicek floorlet prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "Vasicek floorlet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Vasicek floorlet prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Vasicek floorlet prices");
