...
const std::filesystem::path dataset_path =
    "datasets/price/vasicek/zero_coupon_bond_puts/"
    "vasicek_01__zero_coupon_bond_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Vasicek zero-coupon bond put prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "Vasicek ZCB put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Vasicek zero-coupon bond put prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Vasicek ZCB put prices");
