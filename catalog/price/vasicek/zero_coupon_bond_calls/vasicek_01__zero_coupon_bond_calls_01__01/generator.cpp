...
const std::filesystem::path dataset_path =
    "datasets/price/vasicek/zero_coupon_bond_calls/"
...
const std::string url =
    ...
    "vasicek/zero_coupon_bond_calls/"
    "vasicek_01__zero_coupon_bond_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Vasicek zero-coupon bond call prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "Vasicek ZCB call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Vasicek zero-coupon bond call prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Vasicek ZCB call prices");
