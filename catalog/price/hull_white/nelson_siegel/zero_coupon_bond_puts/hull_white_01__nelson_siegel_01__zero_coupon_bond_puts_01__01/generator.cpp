// Build one Hull-White Nelson-Siegel zero-coupon bond put dataset.
...
const std::filesystem::path dataset_path =
    "datasets/price/hull_white/nelson_siegel/zero_coupon_bond_puts/"
...
int main() {
    ...
    try {
        ...
        fitted::launch_hull_white_nelson_siegel_zero_coupon_bond_put_cuda(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Hull-White zero_coupon_bond_put warmup");
