...
const std::filesystem::path dataset_path =
    "datasets/price/hull_white/svensson/zero_coupon_bond_puts/"
    "hull_white_01__svensson_01__zero_coupon_bond_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        fitted::launch_hull_white_svensson_zero_coupon_bond_put_cuda(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
