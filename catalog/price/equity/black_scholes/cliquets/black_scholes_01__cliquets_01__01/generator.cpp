// Build one BlackScholes Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/cliquets/"
    "black_scholes_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/cliquets/"
    "black_scholes_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/Cliquet/"
    "black_scholes_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes Cliquet standard errors"
        );
        ...
        black_scholes::launch_black_scholes_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes Cliquet standard errors"
    );
