// Build one BlackScholes Double-knock-out-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/double_knock_out_option.cuh"
...
// Rare surviving paths dominate long-dated stress rows; use a larger budget
// so a zero-hit sample is not reported as a zero price and zero uncertainty.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/double_knock_out_calls/"
    "black_scholes_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/double_knock_out_calls/"
    "black_scholes_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/DoubleKnockOutCall/"
    "black_scholes_01__double_knock_out_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Double-knock-out calls"
        );
        check_cuda(
            cudaMalloc(
                &device_prices,
            ...
            "cudaMalloc BlackScholes call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes call standard errors"
        );
        ...
        check_cuda(
            ...
            "cudaMemcpy Double-knock-out calls"
        );
        ...
        black_scholes::launch_black_scholes_double_knock_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Double-knock-out calls");
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes call standard errors"
    );
