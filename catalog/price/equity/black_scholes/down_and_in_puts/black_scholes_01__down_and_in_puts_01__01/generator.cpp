...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/down_and_in_puts/"
    "black_scholes_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/down_and_in_puts/"
    "black_scholes_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/black_scholes/down_and_in_puts/"
    "black_scholes_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes down-and-in put standard errors"
        );
        ...
        black_scholes::launch_black_scholes_down_and_in_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes down-and-in put standard errors"
    );
