// Build one BlackScholes fixed-strike lookback price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/lookback_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/lookback_options/"
    "black_scholes_01__lookback_options_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/lookback_options/"
    "black_scholes_01__lookback_options_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/LookbackOption/"
    "black_scholes_01__lookback_options_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes lookback prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes lookback standard errors"
        );
        ...
        black_scholes::launch_black_scholes_lookback_option_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes lookback warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes lookback prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes lookback standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes lookback prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes lookback standard errors"
    );
