// Build one Black-Scholes European call price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/european_calls/"
    "black_scholes_01__european_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/european_calls/"
    "black_scholes_01__european_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/"
    "equity/black_scholes/european_calls/"
    "black_scholes_01__european_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Black-Scholes European call prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        bs::launch_black_scholes_european_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_products,
            warmup_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Black-Scholes European call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Black-Scholes European call prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Black-Scholes European call prices");
