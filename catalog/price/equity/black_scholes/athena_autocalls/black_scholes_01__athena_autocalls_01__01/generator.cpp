// Build one BlackScholes Athena-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/athena_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/athena_autocalls/"
    "black_scholes_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/athena_autocalls/"
    "black_scholes_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/AthenaAutocall/"
    "black_scholes_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes Athena autocall standard errors"
        );
        ...
        black_scholes::launch_black_scholes_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes Athena autocall standard errors"
    );
