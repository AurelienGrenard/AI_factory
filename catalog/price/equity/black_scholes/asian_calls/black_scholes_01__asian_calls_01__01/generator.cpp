// Build one BlackScholes Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/asian_calls/"
    "black_scholes_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/asian_calls/"
    "black_scholes_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/AsianCall/"
    "black_scholes_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes Asian call standard errors"
        );
        ...
        black_scholes::launch_black_scholes_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes Asian call standard errors"
    );
