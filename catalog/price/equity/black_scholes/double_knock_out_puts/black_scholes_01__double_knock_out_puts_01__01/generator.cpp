// Build one BlackScholes Double-knock-out-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/double_knock_out_puts/"
    "black_scholes_01__double_knock_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/double_knock_out_puts/"
    "black_scholes_01__double_knock_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/black_scholes/double_knock_out_puts/"
    "black_scholes_01__double_knock_out_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes put standard errors"
        );
        ...
        black_scholes::launch_black_scholes_double_knock_out_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Double-knock-out puts");
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes put standard errors"
    );
