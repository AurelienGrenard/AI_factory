// Build one BlackScholes Up-and-in-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/black_scholes/up_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/up_and_in_calls/"
    "black_scholes_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/up_and_in_calls/"
    "black_scholes_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/UpAndInCall/"
    "black_scholes_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc BlackScholes up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc BlackScholes up-and-in call standard errors"
        );
        ...
        black_scholes::launch_black_scholes_up_and_in_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "BlackScholes up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy BlackScholes up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy BlackScholes up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree BlackScholes up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree BlackScholes up-and-in call standard errors"
    );
