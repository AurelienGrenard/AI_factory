// Build one Black-Scholes range_accruals price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/black_scholes/range_accruals/"
    "black_scholes_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/black_scholes/range_accruals/"
    "black_scholes_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/"
    "equity/black_scholes/range_accruals/"
    "black_scholes_01__range_accruals_01__01.json";
const std::string numerical_method =
    "Black-Scholes closed-form range accrual";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc range_accrualss"
        );
        check_cuda(
            cudaMalloc(&device_prices, result_count * sizeof(float)),
            "cudaMalloc Black-Scholes range_accruals prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        bs::launch_black_scholes_range_accrual_cuda(
            device_models,
            warmup_count,
            device_products,
            warmup_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Black-Scholes range_accruals warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Black-Scholes range_accruals prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree range_accrualss");
    check_cuda(cudaFree(device_prices), "cudaFree Black-Scholes range_accruals prices");
