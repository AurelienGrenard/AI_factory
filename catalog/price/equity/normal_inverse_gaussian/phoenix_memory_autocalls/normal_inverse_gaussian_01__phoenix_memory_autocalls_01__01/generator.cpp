// Build one NormalInverseGaussian Phoenix-Memory-autocall price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/phoenix_memory_autocalls/"
    "normal_inverse_gaussian_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/phoenix_memory_autocalls/"
    "normal_inverse_gaussian_01__phoenix_memory_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/PhoenixMemoryAutocall/"
    "normal_inverse_gaussian_01__phoenix_memory_autocalls_01__01.json";
...
int main() {
    ...
    product::PhoenixMemoryAutocallParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::PhoenixMemoryAutocallParameters)
            ),
            "cudaMalloc Phoenix Memory autocalls"
        );
        check_cuda(
            cudaMalloc(
                &device_prices,
            ...
            "cudaMalloc NormalInverseGaussian Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian Phoenix Memory autocall standard errors"
        );
        ...
        check_cuda(
            ...
            "cudaMemcpy Phoenix Memory autocalls"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_phoenix_memory_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Phoenix Memory autocalls");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian Phoenix Memory autocall standard errors"
    );
