// Build one NormalInverseGaussian Double-knock-out-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/double_knock_out_calls/"
    "normal_inverse_gaussian_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/double_knock_out_calls/"
    "normal_inverse_gaussian_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/DoubleKnockOutCall/"
    "normal_inverse_gaussian_01__double_knock_out_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_double_knock_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
