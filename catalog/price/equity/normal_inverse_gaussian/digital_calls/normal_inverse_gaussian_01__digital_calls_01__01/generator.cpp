// Build one NormalInverseGaussian digital-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/digital_calls/"
    "normal_inverse_gaussian_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/digital_calls/"
    "normal_inverse_gaussian_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/digital_calls/"
    "normal_inverse_gaussian_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc NormalInverseGaussian digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian digital call standard errors"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_digital_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Digital calls");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian digital call standard errors"
    );
