// Build one NormalInverseGaussian Up-and-out-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/normal_inverse_gaussian/up_and_out_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/up_and_out_calls/"
    "normal_inverse_gaussian_01__up_and_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/up_and_out_calls/"
    "normal_inverse_gaussian_01__up_and_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/UpAndOutCall/"
    "normal_inverse_gaussian_01__up_and_out_calls_01__01.json";
...
int main() {
    ...
    product::UpAndOutOptionParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::UpAndOutOptionParameters)
            ),
            "cudaMalloc Up-and-out calls"
        );
        check_cuda(
            cudaMalloc(
                &device_prices,
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_up_and_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
    ...
    check_cuda(cudaFree(device_products), "cudaFree Up-and-out calls");
