// Build one NormalInverseGaussian gap-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/normal_inverse_gaussian/gap_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/gap_calls/"
    "normal_inverse_gaussian_01__gap_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/gap_calls/"
    "normal_inverse_gaussian_01__gap_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/gap_calls/"
    "normal_inverse_gaussian_01__gap_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc NormalInverseGaussian gap call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian gap call standard errors"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_gap_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian gap call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian gap call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian gap call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Gap calls");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian gap call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian gap call standard errors"
    );
