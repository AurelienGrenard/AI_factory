// Build one NormalInverseGaussian Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/asian_puts/"
    "normal_inverse_gaussian_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/asian_puts/"
    "normal_inverse_gaussian_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/asian_puts/"
    "normal_inverse_gaussian_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc NormalInverseGaussian Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian Asian put standard errors"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Asian puts");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian Asian put standard errors"
    );
