...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/geometric_asian_puts/"
    "normal_inverse_gaussian_01__geometric_asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/geometric_asian_puts/"
    "normal_inverse_gaussian_01__geometric_asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/geometric_asian_puts/"
    "normal_inverse_gaussian_01__geometric_asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Geometric Asian puts"
        );
        check_cuda(
            cudaMalloc(
                &device_prices,
            ...
            "cudaMalloc NormalInverseGaussian Geometric Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian Geometric Asian put standard errors"
        );
        ...
        check_cuda(
            ...
            "cudaMemcpy Geometric Asian puts"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_geometric_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian Geometric Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian Geometric Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian Geometric Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Geometric Asian puts");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian Geometric Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian Geometric Asian put standard errors"
    );
