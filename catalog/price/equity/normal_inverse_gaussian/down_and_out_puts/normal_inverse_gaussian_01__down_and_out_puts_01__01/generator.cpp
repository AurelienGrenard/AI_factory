// Build one NormalInverseGaussian Down-and-out-put price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/normal_inverse_gaussian/down_and_out_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/down_and_out_puts/"
    "normal_inverse_gaussian_01__down_and_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/down_and_out_puts/"
    "normal_inverse_gaussian_01__down_and_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/down_and_out_puts/"
    "normal_inverse_gaussian_01__down_and_out_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_down_and_out_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
