// Build one NormalInverseGaussian gap-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/gap_puts/"
    "normal_inverse_gaussian_01__gap_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/gap_puts/"
    "normal_inverse_gaussian_01__gap_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/gap_puts/"
    "normal_inverse_gaussian_01__gap_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc NormalInverseGaussian gap put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian gap put standard errors"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_gap_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian gap put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian gap put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian gap put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian gap put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian gap put standard errors"
    );
