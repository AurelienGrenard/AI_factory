// Build one NormalInverseGaussian asset-or-nothing price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/normal_inverse_gaussian/asset_or_nothing_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/normal_inverse_gaussian/asset_or_nothing_calls/"
    "normal_inverse_gaussian_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/asset_or_nothing_calls/"
    "normal_inverse_gaussian_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Asset-or-nothing calls"
        );
        check_cuda(
            cudaMalloc(
                &device_prices,
            ...
            "cudaMalloc NormalInverseGaussian asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian asset-or-nothing call standard errors"
        );
        ...
        check_cuda(
            ...
            "cudaMemcpy Asset-or-nothing calls"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_products), "cudaFree Asset-or-nothing calls");
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree NormalInverseGaussian asset-or-nothing call standard errors"
    );
