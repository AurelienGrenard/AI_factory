...
const std::filesystem::path dataset_path =
    ...
    "normal_inverse_gaussian_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/normal_inverse_gaussian/asset_or_nothing_puts/"
    "normal_inverse_gaussian_01__asset_or_nothing_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/normal_inverse_gaussian/"
    "asset_or_nothing_puts/"
    "normal_inverse_gaussian_01__asset_or_nothing_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc NormalInverseGaussian asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc NormalInverseGaussian asset-or-nothing put standard errors"
        );
        ...
        normal_inverse_gaussian::launch_normal_inverse_gaussian_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "NormalInverseGaussian asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy NormalInverseGaussian asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy NormalInverseGaussian asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree NormalInverseGaussian asset-or-nothing put prices");
    check_cuda(
