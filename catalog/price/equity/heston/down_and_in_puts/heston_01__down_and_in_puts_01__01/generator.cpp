// Build one Heston Down-and-in-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/down_and_in_puts/"
    "heston_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/down_and_in_puts/"
    "heston_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/heston/down_and_in_puts/"
    "heston_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston down-and-in put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston down-and-in put standard errors"
    );
