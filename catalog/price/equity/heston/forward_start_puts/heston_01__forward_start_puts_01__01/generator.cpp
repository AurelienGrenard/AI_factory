// Build one Heston Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/forward_start_puts/"
    "heston_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/forward_start_puts/"
    "heston_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/heston/forward_start_puts/"
    "heston_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston put standard errors"
    );
