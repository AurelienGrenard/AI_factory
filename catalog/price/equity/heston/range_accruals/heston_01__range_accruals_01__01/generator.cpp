// Build one Heston Range Accrual price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/range_accruals/"
    "heston_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/range_accruals/"
    "heston_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/RangeAccrual/"
    "heston_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Range Accrual standard errors"
        );
        ...
        heston::launch_heston_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Range Accrual standard errors"
    );
