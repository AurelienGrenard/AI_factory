...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/straddles/"
    "heston_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/straddles/"
    "heston_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/heston/straddles/"
    "heston_01__straddles_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston straddle prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston straddle standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston straddle warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston straddle prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston straddle standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston straddle prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston straddle standard errors"
    );
