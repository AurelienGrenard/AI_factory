// Build one Heston Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/heston/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/cliquets/"
    "heston_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/cliquets/"
    "heston_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/Cliquet/"
    "heston_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Cliquet standard errors"
        );
        ...
        heston::launch_heston_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Cliquet standard errors"
    );
