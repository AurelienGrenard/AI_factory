// Build one Heston Phoenix-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/heston/phoenix_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/phoenix_autocalls/"
    "heston_01__phoenix_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/phoenix_autocalls/"
    "heston_01__phoenix_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/PhoenixAutocall/"
    "heston_01__phoenix_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Phoenix autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Phoenix autocall standard errors"
        );
        ...
        heston::launch_heston_phoenix_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Phoenix autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Phoenix autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Phoenix autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Phoenix autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Phoenix autocall standard errors"
    );
