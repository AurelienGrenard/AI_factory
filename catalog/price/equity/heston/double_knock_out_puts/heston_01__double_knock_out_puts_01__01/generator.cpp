...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/double_knock_out_puts/"
    "heston_01__double_knock_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/double_knock_out_puts/"
    "heston_01__double_knock_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/heston/double_knock_out_puts/"
    "heston_01__double_knock_out_puts_01__01.json";
