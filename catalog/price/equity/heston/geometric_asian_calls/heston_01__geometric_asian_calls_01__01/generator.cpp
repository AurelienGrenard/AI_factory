// Build one Heston Geometric-Asian-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/geometric_asian_calls/"
    "heston_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/geometric_asian_calls/"
    "heston_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/GeometricAsianCall/"
    "heston_01__geometric_asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Geometric Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Geometric Asian call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Geometric Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Geometric Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Geometric Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Geometric Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Geometric Asian call standard errors"
    );
