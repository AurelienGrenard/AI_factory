// Build one Heston Athena-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/heston/athena_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/heston/athena_autocalls/"
    "heston_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/heston/athena_autocalls/"
    "heston_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/AthenaAutocall/"
    "heston_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Athena autocall standard errors"
        );
        ...
        heston::launch_heston_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Athena autocall standard errors"
    );
