...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/american_calls/"
    "variance_gamma_01__american_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/american_calls/"
    "variance_gamma_01__american_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/american_calls/"
    "variance_gamma_01__american_calls_01__01.json";
const std::string numerical_method = "Exact Gamma subordination + Longstaff-Schwartz";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma American call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma American call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_american_option_cuda<OptionSide::call>(
            device_models,
            1U,
            products.data(),
            device_products,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma American-call warmup");

        // Plan the reusable workspace and time every production batch.
        wall_start = std::chrono::steady_clock::now();
        execution = variance_gamma::launch_variance_gamma_american_option_cuda<OptionSide::call>(
            device_models,
            models.size(),
            products.data(),
            device_products,
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma American call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma American call standard errors"
        );
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma American call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma American call standard errors"
    );
