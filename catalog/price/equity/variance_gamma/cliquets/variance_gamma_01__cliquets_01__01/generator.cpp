// Build one VarianceGamma Cliquet price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/cliquets/"
    "variance_gamma_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/cliquets/"
    "variance_gamma_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/Cliquet/"
    "variance_gamma_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma Cliquet standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma Cliquet standard errors"
    );
