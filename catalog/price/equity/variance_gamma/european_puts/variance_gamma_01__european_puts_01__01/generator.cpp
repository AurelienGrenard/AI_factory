// Build one VarianceGamma European-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/european_puts/"
    "variance_gamma_01__european_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/european_puts/"
    "variance_gamma_01__european_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/european_puts/"
    "variance_gamma_01__european_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        variance_gamma::launch_variance_gamma_european_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
