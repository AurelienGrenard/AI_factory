// Build one VarianceGamma Double-knock-out-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/double_knock_out_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/double_knock_out_calls/"
    "variance_gamma_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/double_knock_out_calls/"
    "variance_gamma_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/DoubleKnockOutCall/"
    "variance_gamma_01__double_knock_out_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        variance_gamma::launch_variance_gamma_double_knock_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
