// Build one VarianceGamma Down-and-in-put price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/down_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/down_and_in_puts/"
    "variance_gamma_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/down_and_in_puts/"
    "variance_gamma_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/down_and_in_puts/"
    "variance_gamma_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma down-and-in put standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_down_and_in_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma down-and-in put standard errors"
    );
