// Build one VarianceGamma European-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/european_option.cuh"
...
constexpr std::size_t monte_carlo_paths_per_price = 262'144U;
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/european_calls/"
    "variance_gamma_01__european_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/european_calls/"
    "variance_gamma_01__european_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/EuropeanCall/"
    "variance_gamma_01__european_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        variance_gamma::launch_variance_gamma_european_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
