...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/asset_or_nothing_puts/"
    "variance_gamma_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/asset_or_nothing_puts/"
    "variance_gamma_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma asset-or-nothing put standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma asset-or-nothing put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma asset-or-nothing put standard errors"
    );
