// Build one VarianceGamma fixed-strike lookback price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/lookback_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/lookback_options/"
    "variance_gamma_01__lookback_options_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/lookback_options/"
    "variance_gamma_01__lookback_options_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/LookbackOption/"
    "variance_gamma_01__lookback_options_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma lookback prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma lookback standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_lookback_option_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma lookback warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma lookback prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma lookback standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma lookback prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma lookback standard errors"
    );
