...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/gap_calls/"
    "variance_gamma_01__gap_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/gap_calls/"
    "variance_gamma_01__gap_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/gap_calls/"
    "variance_gamma_01__gap_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma gap call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma gap call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma gap call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma gap call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma gap call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma gap call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma gap call standard errors"
    );
