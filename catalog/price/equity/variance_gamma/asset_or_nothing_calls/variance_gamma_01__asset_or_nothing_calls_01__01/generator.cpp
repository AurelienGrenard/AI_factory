// Build one VarianceGamma asset-or-nothing price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/asset_or_nothing_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/asset_or_nothing_calls/"
    "variance_gamma_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/asset_or_nothing_calls/"
    "variance_gamma_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma asset-or-nothing call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma asset-or-nothing call standard errors"
    );
