// Build one VarianceGamma Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/asian_puts/"
    "variance_gamma_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/asian_puts/"
    "variance_gamma_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/asian_puts/"
    "variance_gamma_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma Asian put standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma Asian put standard errors"
    );
