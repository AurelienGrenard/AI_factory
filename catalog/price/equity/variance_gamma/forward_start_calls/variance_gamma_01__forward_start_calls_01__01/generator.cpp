// Build one VarianceGamma Forward-start-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/forward_start_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/forward_start_calls/"
    "variance_gamma_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/forward_start_calls/"
    "variance_gamma_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/ForwardStartCall/"
    "variance_gamma_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_forward_start_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma call standard errors"
    );
