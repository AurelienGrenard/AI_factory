// Build one VarianceGamma Up-and-in-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/up_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/up_and_in_calls/"
    "variance_gamma_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/up_and_in_calls/"
    "variance_gamma_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/UpAndInCall/"
    "variance_gamma_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma up-and-in call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_up_and_in_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma up-and-in call standard errors"
    );
