// Build one VarianceGamma digital-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/digital_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/digital_calls/"
    "variance_gamma_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/digital_calls/"
    "variance_gamma_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/digital_calls/"
    "variance_gamma_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma digital call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_digital_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma digital call standard errors"
    );
