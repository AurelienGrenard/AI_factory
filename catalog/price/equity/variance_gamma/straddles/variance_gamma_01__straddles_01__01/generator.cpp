// Build one VarianceGamma straddle price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/straddle.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/straddles/"
    "variance_gamma_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/straddles/"
    "variance_gamma_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/straddles/"
    "variance_gamma_01__straddles_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma straddle prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma straddle standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_straddle_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma straddle warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma straddle prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma straddle standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma straddle prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma straddle standard errors"
    );
