// Build one VarianceGamma digital-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/digital_puts/"
    "variance_gamma_01__digital_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/digital_puts/"
    "variance_gamma_01__digital_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/digital_puts/"
    "variance_gamma_01__digital_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma digital put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma digital put standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_digital_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma digital put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma digital put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma digital put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma digital put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma digital put standard errors"
    );
