// Build one VarianceGamma Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/forward_start_puts/"
    "variance_gamma_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/forward_start_puts/"
    "variance_gamma_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/variance_gamma/forward_start_puts/"
    "variance_gamma_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma put standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_forward_start_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma put standard errors"
    );
