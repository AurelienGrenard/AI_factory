...
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/range_accruals/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma Range Accrual standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma Range Accrual prices");
    check_cuda(
