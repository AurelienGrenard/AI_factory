// Build one VarianceGamma Asian-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/asian_calls/"
    "variance_gamma_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/asian_calls/"
    "variance_gamma_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/AsianCall/"
    "variance_gamma_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma Asian call standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma Asian call standard errors"
    );
