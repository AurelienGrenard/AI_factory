// Build one VarianceGamma Athena-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/variance_gamma/athena_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/variance_gamma/athena_autocalls/"
    "variance_gamma_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/variance_gamma/athena_autocalls/"
    "variance_gamma_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/AthenaAutocall/"
    "variance_gamma_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc VarianceGamma Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc VarianceGamma Athena autocall standard errors"
        );
        ...
        variance_gamma::launch_variance_gamma_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "VarianceGamma Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy VarianceGamma Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy VarianceGamma Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree VarianceGamma Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree VarianceGamma Athena autocall standard errors"
    );
