...
const std::filesystem::path dataset_path =
    "datasets/price/equity/cev/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/cev/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/cev/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01.json";
