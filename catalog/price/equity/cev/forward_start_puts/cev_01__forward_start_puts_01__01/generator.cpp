...
const std::filesystem::path dataset_path =
    "datasets/price/equity/cev/forward_start_puts/"
    "cev_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/cev/forward_start_puts/"
    "cev_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/cev/forward_start_puts/"
    "cev_01__forward_start_puts_01__01.json";
