...
const std::filesystem::path dataset_path =
    "datasets/price/equity/rough_bergomi/european_puts/"
    "rough_bergomi_01__european_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/rough_bergomi/european_puts/"
    "rough_bergomi_01__european_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/rough_bergomi/"
    "european_puts/rough_bergomi_01__european_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc rough-Bergomi put prices"
        );
        check_cuda(
            cudaMalloc(
                &device_standard_errors, result_count * sizeof(float)
            ),
            "cudaMalloc rough-Bergomi put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "rough-Bergomi put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy rough-Bergomi put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy rough-Bergomi put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree rough-Bergomi put standard errors"
    );
