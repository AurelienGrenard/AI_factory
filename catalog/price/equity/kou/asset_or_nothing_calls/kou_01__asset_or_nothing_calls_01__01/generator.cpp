...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/asset_or_nothing_calls/"
    "kou_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/asset_or_nothing_calls/"
    "kou_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou asset-or-nothing call standard errors"
        );
        ...
        kou::launch_kou_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou asset-or-nothing call standard errors"
    );
