// Build one Kou Phoenix-Memory-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/phoenix_memory_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/phoenix_memory_autocalls/"
    "kou_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/phoenix_memory_autocalls/"
    "kou_01__phoenix_memory_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/PhoenixMemoryAutocall/"
    "kou_01__phoenix_memory_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Phoenix Memory autocall standard errors"
        );
        ...
        kou::launch_kou_phoenix_memory_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Phoenix Memory autocall standard errors"
    );
