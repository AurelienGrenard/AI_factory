// Build one Kou Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/forward_start_puts/"
    "kou_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/forward_start_puts/"
    "kou_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/forward_start_puts/"
    "kou_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou put standard errors"
        );
        ...
        kou::launch_kou_forward_start_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou put standard errors"
    );
