// Build one Kou digital-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/digital_calls/"
    "kou_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/digital_calls/"
    "kou_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/digital_calls/"
    "kou_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou digital call standard errors"
        );
        ...
        kou::launch_kou_digital_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou digital call standard errors"
    );
