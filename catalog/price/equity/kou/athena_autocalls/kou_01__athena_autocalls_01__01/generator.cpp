// Build one Kou Athena-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/athena_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/athena_autocalls/"
    "kou_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/athena_autocalls/"
    "kou_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/AthenaAutocall/"
    "kou_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Athena autocall standard errors"
        );
        ...
        kou::launch_kou_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Athena autocall standard errors"
    );
