// Build one Kou Down-and-in-put price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/down_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/down_and_in_puts/"
    "kou_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/down_and_in_puts/"
    "kou_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/down_and_in_puts/"
    "kou_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou down-and-in put standard errors"
        );
        ...
        kou::launch_kou_down_and_in_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou down-and-in put standard errors"
    );
