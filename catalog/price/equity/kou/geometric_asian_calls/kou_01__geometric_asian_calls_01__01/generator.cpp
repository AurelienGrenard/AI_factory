// Build one Kou Geometric-Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/geometric_asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/geometric_asian_calls/"
    "kou_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/geometric_asian_calls/"
    "kou_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/GeometricAsianCall/"
    "kou_01__geometric_asian_calls_01__01.json";
...
int main() {
    ...
    const std::vector<kou::KouModelParameters> models =
    ...
    kou::KouModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(kou::KouModelParameters)
            ),
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Geometric Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Geometric Asian call standard errors"
        );
        ...
        kou::launch_kou_geometric_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Geometric Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Geometric Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Geometric Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Geometric Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Geometric Asian call standard errors"
    );
