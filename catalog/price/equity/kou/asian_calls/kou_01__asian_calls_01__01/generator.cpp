// Build one Kou Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/asian_calls/"
    "kou_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/asian_calls/"
    "kou_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/AsianCall/"
    "kou_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Asian call standard errors"
        );
        ...
        kou::launch_kou_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Asian call standard errors"
    );
