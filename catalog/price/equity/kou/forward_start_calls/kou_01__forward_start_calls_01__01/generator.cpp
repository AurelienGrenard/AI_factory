// Build one Kou Forward-start-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/forward_start_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/forward_start_calls/"
    "kou_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/forward_start_calls/"
    "kou_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/ForwardStartCall/"
    "kou_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou call standard errors"
        );
        ...
        kou::launch_kou_forward_start_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou call standard errors"
    );
