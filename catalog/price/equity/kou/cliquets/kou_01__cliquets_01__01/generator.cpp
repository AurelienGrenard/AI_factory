// Build one Kou Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/cliquets/"
    "kou_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/cliquets/"
    "kou_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/Cliquet/"
    "kou_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Cliquet standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Cliquet standard errors"
    );
