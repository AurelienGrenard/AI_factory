// Build one Kou Phoenix-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/phoenix_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/phoenix_autocalls/"
    "kou_01__phoenix_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/phoenix_autocalls/"
    "kou_01__phoenix_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/PhoenixAutocall/"
    "kou_01__phoenix_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Phoenix autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Phoenix autocall standard errors"
        );
        ...
        kou::launch_kou_phoenix_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Phoenix autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Phoenix autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Phoenix autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Phoenix autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Phoenix autocall standard errors"
    );
