...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/asset_or_nothing_puts/"
    "kou_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/asset_or_nothing_puts/"
    "kou_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        kou::launch_kou_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
