// Build one Kou Range Accrual price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/range_accrual.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/range_accruals/"
    "kou_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/range_accruals/"
    "kou_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/RangeAccrual/"
    "kou_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Range Accrual standard errors"
        );
        ...
        kou::launch_kou_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Range Accrual standard errors"
    );
