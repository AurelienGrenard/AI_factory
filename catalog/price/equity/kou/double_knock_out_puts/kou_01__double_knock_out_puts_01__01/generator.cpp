// Build one Kou Double-knock-out-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/double_knock_out_puts/"
    "kou_01__double_knock_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/double_knock_out_puts/"
    "kou_01__double_knock_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/double_knock_out_puts/"
    "kou_01__double_knock_out_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        kou::launch_kou_double_knock_out_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
