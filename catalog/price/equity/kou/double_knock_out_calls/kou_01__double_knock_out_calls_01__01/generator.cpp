// Build one Kou Double-knock-out-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/double_knock_out_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/double_knock_out_calls/"
    "kou_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/double_knock_out_calls/"
    "kou_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/DoubleKnockOutCall/"
    "kou_01__double_knock_out_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        kou::launch_kou_double_knock_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
