// Build one Kou fixed-strike lookback price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/kou/lookback_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/lookback_options/"
    "kou_01__lookback_options_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/lookback_options/"
    "kou_01__lookback_options_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/LookbackOption/"
    "kou_01__lookback_options_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou lookback prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou lookback standard errors"
        );
        ...
        kou::launch_kou_lookback_option_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou lookback warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou lookback prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou lookback standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou lookback prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou lookback standard errors"
    );
