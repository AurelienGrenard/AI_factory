// Build one Kou Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/kou/asian_puts/"
    "kou_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/kou/asian_puts/"
    "kou_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/kou/asian_puts/"
    "kou_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Kou Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Kou Asian put standard errors"
        );
        ...
        kou::launch_kou_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Kou Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Kou Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Kou Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Kou Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Kou Asian put standard errors"
    );
