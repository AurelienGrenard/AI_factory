// Build one SchobelZhu Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/asian_calls/"
    "schobel_zhu_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/asian_calls/"
    "schobel_zhu_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/AsianCall/"
    "schobel_zhu_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Asian call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Asian call standard errors"
    );
