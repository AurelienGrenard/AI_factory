// Build one SchobelZhu Up-and-in-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/up_and_in_calls/"
    "schobel_zhu_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/up_and_in_calls/"
    "schobel_zhu_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/UpAndInCall/"
    "schobel_zhu_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu up-and-in call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_up_and_in_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu up-and-in call standard errors"
    );
