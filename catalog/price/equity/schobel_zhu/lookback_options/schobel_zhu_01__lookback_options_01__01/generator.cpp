// Build one SchobelZhu fixed-strike lookback price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/lookback_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/lookback_options/"
    "schobel_zhu_01__lookback_options_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/lookback_options/"
    "schobel_zhu_01__lookback_options_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/LookbackOption/"
    "schobel_zhu_01__lookback_options_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu lookback prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu lookback standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_lookback_option_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu lookback warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu lookback prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu lookback standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu lookback prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu lookback standard errors"
    );
