// Build one SchobelZhu Phoenix-Memory-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/phoenix_memory_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/phoenix_memory_autocalls/"
    "schobel_zhu_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/phoenix_memory_autocalls/"
    "schobel_zhu_01__phoenix_memory_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/PhoenixMemoryAutocall/"
    "schobel_zhu_01__phoenix_memory_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Phoenix Memory autocall standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_phoenix_memory_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Phoenix Memory autocall standard errors"
    );
