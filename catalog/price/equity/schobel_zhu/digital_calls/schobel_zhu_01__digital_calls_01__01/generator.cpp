// Build one SchobelZhu digital-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/digital_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/digital_calls/"
    "schobel_zhu_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/digital_calls/"
    "schobel_zhu_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/schobel_zhu/digital_calls/"
    "schobel_zhu_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu digital call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_digital_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu digital call standard errors"
    );
