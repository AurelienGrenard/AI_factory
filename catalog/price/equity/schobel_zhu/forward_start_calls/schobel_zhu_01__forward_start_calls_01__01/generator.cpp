// Build one SchobelZhu Forward-start-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/forward_start_calls/"
    "schobel_zhu_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/forward_start_calls/"
    "schobel_zhu_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/ForwardStartCall/"
    "schobel_zhu_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_forward_start_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu call standard errors"
    );
