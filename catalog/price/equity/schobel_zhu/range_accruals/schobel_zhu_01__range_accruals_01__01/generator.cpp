// Build one SchobelZhu Range Accrual price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/range_accruals/"
    "schobel_zhu_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/range_accruals/"
    "schobel_zhu_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/RangeAccrual/"
    "schobel_zhu_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Range Accrual standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Range Accrual standard errors"
    );
