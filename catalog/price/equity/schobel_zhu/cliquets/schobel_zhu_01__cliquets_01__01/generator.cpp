// Build one SchobelZhu Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/cliquets/"
    "schobel_zhu_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/cliquets/"
    "schobel_zhu_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/Cliquet/"
    "schobel_zhu_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Cliquet standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Cliquet standard errors"
    );
