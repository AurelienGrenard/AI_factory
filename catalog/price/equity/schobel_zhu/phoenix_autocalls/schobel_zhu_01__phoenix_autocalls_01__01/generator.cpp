// Build one SchobelZhu Phoenix-autocall price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/phoenix_autocalls/"
    "schobel_zhu_01__phoenix_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/phoenix_autocalls/"
    "schobel_zhu_01__phoenix_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/PhoenixAutocall/"
    "schobel_zhu_01__phoenix_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Phoenix autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Phoenix autocall standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_phoenix_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Phoenix autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Phoenix autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Phoenix autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Phoenix autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Phoenix autocall standard errors"
    );
