...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/asset_or_nothing_puts/"
    "schobel_zhu_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/asset_or_nothing_puts/"
    "schobel_zhu_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu asset-or-nothing put standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu asset-or-nothing put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu asset-or-nothing put standard errors"
    );
