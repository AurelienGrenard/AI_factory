...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/asset_or_nothing_calls/"
    "schobel_zhu_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/asset_or_nothing_calls/"
    "schobel_zhu_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/schobel_zhu/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu asset-or-nothing call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu asset-or-nothing call standard errors"
    );
