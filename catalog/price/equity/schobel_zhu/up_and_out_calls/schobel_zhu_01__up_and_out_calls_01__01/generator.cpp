// Build one SchobelZhu Up-and-out-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/up_and_out_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/up_and_out_calls/"
    "schobel_zhu_01__up_and_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/up_and_out_calls/"
    "schobel_zhu_01__up_and_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/UpAndOutCall/"
    "schobel_zhu_01__up_and_out_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        schobel_zhu::launch_schobel_zhu_up_and_out_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
