// Build one SchobelZhu Geometric-Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/geometric_asian_puts/"
    "schobel_zhu_01__geometric_asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/geometric_asian_puts/"
    "schobel_zhu_01__geometric_asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/schobel_zhu/geometric_asian_puts/"
    "schobel_zhu_01__geometric_asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Geometric Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Geometric Asian put standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_geometric_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Geometric Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Geometric Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Geometric Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Geometric Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Geometric Asian put standard errors"
    );
