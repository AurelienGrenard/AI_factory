// Build one SchobelZhu Athena-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/schobel_zhu/athena_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/athena_autocalls/"
    "schobel_zhu_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/athena_autocalls/"
    "schobel_zhu_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/AthenaAutocall/"
    "schobel_zhu_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu Athena autocall standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu Athena autocall standard errors"
    );
