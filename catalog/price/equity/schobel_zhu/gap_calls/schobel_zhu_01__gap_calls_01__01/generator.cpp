// Build one SchobelZhu gap-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/schobel_zhu/gap_calls/"
    "schobel_zhu_01__gap_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/schobel_zhu/gap_calls/"
    "schobel_zhu_01__gap_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/schobel_zhu/gap_calls/"
    "schobel_zhu_01__gap_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc SchobelZhu gap call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc SchobelZhu gap call standard errors"
        );
        ...
        schobel_zhu::launch_schobel_zhu_gap_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "SchobelZhu gap call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy SchobelZhu gap call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy SchobelZhu gap call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree SchobelZhu gap call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree SchobelZhu gap call standard errors"
    );
