// Build one Bates digital-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/digital_calls/"
    "bates_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/digital_calls/"
    "bates_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/digital_calls/"
    "bates_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates digital call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates digital call standard errors"
    );
