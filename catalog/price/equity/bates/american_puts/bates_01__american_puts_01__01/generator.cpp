// Build one Bates American-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/american_puts/"
    "bates_01__american_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/american_puts/"
    "bates_01__american_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/american_puts/"
    "bates_01__american_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates American put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates American put standard errors"
        );
        ...
        bates::launch_bates_american_option_cuda<OptionSide::put>(
            device_models,
            1U,
            products.data(),
            device_products,
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates American-put warmup");

        // Plan the reusable workspace and time every production batch.
        wall_start = std::chrono::steady_clock::now();
        execution = bates::launch_bates_american_option_cuda<OptionSide::put>(
            device_models,
            models.size(),
            products.data(),
            device_products,
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates American put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates American put standard errors"
        );
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates American put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates American put standard errors"
    );
