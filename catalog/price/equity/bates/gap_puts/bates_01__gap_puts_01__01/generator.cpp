// Build one Bates gap-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/gap_puts/"
    "bates_01__gap_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/gap_puts/"
    "bates_01__gap_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/gap_puts/"
    "bates_01__gap_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates gap put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates gap put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates gap put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates gap put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates gap put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates gap put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates gap put standard errors"
    );
