...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/asset_or_nothing_calls/"
    "bates_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/asset_or_nothing_calls/"
    "bates_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates asset-or-nothing call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates asset-or-nothing call standard errors"
    );
