...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/lookback_options/"
    "bates_01__lookback_options_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/lookback_options/"
    "bates_01__lookback_options_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/LookbackOption/"
    "bates_01__lookback_options_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates lookback prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates lookback standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates lookback warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates lookback prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates lookback standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates lookback prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates lookback standard errors"
    );
