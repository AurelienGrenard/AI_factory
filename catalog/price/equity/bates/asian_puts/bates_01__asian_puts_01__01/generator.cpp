// Build one Bates Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/asian_puts/"
    "bates_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/asian_puts/"
    "bates_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/asian_puts/"
    "bates_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Asian put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates Asian put standard errors"
    );
