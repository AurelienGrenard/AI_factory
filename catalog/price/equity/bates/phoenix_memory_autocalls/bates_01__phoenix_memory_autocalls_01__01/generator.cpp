// Build one Bates Phoenix-Memory-autocall price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/phoenix_memory_autocalls/"
    "bates_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/phoenix_memory_autocalls/"
    "bates_01__phoenix_memory_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/PhoenixMemoryAutocall/"
    "bates_01__phoenix_memory_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Phoenix Memory autocall standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates Phoenix Memory autocall standard errors"
    );
