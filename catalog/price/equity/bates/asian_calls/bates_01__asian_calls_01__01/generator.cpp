// Build one Bates Asian-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/asian_calls/"
    "bates_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/asian_calls/"
    "bates_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/AsianCall/"
    "bates_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Asian call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates Asian call standard errors"
    );
