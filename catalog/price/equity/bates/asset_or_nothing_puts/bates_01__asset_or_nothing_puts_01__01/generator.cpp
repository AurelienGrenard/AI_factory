...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/asset_or_nothing_puts/"
    "bates_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/asset_or_nothing_puts/"
    "bates_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates asset-or-nothing put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates asset-or-nothing put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates asset-or-nothing put standard errors"
    );
