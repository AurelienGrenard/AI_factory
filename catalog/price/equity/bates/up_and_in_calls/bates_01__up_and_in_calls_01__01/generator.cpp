// Build one Bates Up-and-in-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/up_and_in_calls/"
    "bates_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/up_and_in_calls/"
    "bates_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/UpAndInCall/"
    "bates_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates up-and-in call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates up-and-in call standard errors"
    );
