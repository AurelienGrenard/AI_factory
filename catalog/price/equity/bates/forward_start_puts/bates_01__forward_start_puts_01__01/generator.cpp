// Build one Bates Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/forward_start_puts/"
    "bates_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/forward_start_puts/"
    "bates_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/forward_start_puts/"
    "bates_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates put standard errors"
    );
