...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/digital_puts/"
    "bates_01__digital_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/digital_puts/"
    "bates_01__digital_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/digital_puts/"
    "bates_01__digital_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates digital put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates digital put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates digital put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates digital put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates digital put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates digital put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates digital put standard errors"
    );
