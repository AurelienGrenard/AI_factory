// Build one Bates Double-knock-out-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/double_knock_out_puts/"
    "bates_01__double_knock_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/double_knock_out_puts/"
    "bates_01__double_knock_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/double_knock_out_puts/"
    "bates_01__double_knock_out_puts_01__01.json";
