// Build one Bates Forward-start-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/forward_start_calls/"
    "bates_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/forward_start_calls/"
    "bates_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/ForwardStartCall/"
    "bates_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates call standard errors"
    );
