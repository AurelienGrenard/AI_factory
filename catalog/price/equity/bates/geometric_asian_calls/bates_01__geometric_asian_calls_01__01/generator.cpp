// Build one Bates Geometric-Asian-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/geometric_asian_calls/"
    "bates_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/geometric_asian_calls/"
    "bates_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/GeometricAsianCall/"
    "bates_01__geometric_asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Geometric Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Geometric Asian call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Geometric Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Geometric Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Geometric Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Geometric Asian call prices");
    check_cuda(
