...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/straddles/"
    "bates_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/straddles/"
    "bates_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/straddles/"
    "bates_01__straddles_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates straddle prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates straddle standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates straddle warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates straddle prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates straddle standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates straddle prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates straddle standard errors"
    );
