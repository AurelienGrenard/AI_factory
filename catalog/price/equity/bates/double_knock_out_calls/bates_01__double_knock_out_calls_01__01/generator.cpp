// Build one Bates Double-knock-out-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/double_knock_out_calls/"
    "bates_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/double_knock_out_calls/"
    "bates_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/DoubleKnockOutCall/"
    "bates_01__double_knock_out_calls_01__01.json";
