// Build one Bates gap-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/gap_calls/"
    "bates_01__gap_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/gap_calls/"
    "bates_01__gap_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/gap_calls/"
    "bates_01__gap_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates gap call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates gap call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates gap call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates gap call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates gap call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates gap call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates gap call standard errors"
    );
