// Build one Bates European-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/european_calls/"
    "bates_01__european_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/european_calls/"
    "bates_01__european_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/EuropeanCall/"
    "bates_01__european_calls_01__01.json";
