// Build one Bates Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/bates/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/cliquets/"
    "bates_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/cliquets/"
    "bates_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/Cliquet/"
    "bates_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Cliquet standard errors"
        );
        ...
        bates::launch_bates_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates Cliquet standard errors"
    );
