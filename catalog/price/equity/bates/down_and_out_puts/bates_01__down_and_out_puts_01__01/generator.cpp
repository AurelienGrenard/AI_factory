// Build one Bates Down-and-out-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/down_and_out_puts/"
    "bates_01__down_and_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/down_and_out_puts/"
    "bates_01__down_and_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/down_and_out_puts/"
    "bates_01__down_and_out_puts_01__01.json";
