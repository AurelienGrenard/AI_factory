// Build one Bates Range Accrual price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/bates/range_accrual.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/range_accruals/"
    "bates_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/range_accruals/"
    "bates_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/RangeAccrual/"
    "bates_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates Range Accrual standard errors"
        );
        ...
        bates::launch_bates_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates Range Accrual standard errors"
    );
