// Build one Bates Down-and-in-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/bates/down_and_in_puts/"
    "bates_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/bates/down_and_in_puts/"
    "bates_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/bates/down_and_in_puts/"
    "bates_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Bates down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Bates down-and-in put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Bates down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Bates down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Bates down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Bates down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Bates down-and-in put standard errors"
    );
