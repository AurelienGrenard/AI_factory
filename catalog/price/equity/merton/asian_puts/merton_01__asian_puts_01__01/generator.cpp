// Build one Merton Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/asian_puts/"
    "merton_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/asian_puts/"
    "merton_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/asian_puts/"
    "merton_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Asian put standard errors"
        );
        ...
        merton::launch_merton_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Asian put standard errors"
    );
