// Build one Merton Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/merton/asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/asian_calls/"
    "merton_01__asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/asian_calls/"
    "merton_01__asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/AsianCall/"
    "merton_01__asian_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Asian call standard errors"
        );
        ...
        merton::launch_merton_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Asian call standard errors"
    );
