// Build one Merton Athena-autocall price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/athena_autocalls/"
    "merton_01__athena_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/athena_autocalls/"
    "merton_01__athena_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/AthenaAutocall/"
    "merton_01__athena_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Athena autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Athena autocall standard errors"
        );
        ...
        merton::launch_merton_athena_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Athena autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Athena autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Athena autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Athena autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Athena autocall standard errors"
    );
