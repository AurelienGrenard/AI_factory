...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/asset_or_nothing_puts/"
    "merton_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/asset_or_nothing_puts/"
    "merton_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton asset-or-nothing put standard errors"
        );
        ...
        merton::launch_merton_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton asset-or-nothing put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton asset-or-nothing put standard errors"
    );
