// Build one Merton Geometric-Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/merton/geometric_asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/geometric_asian_calls/"
    "merton_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/geometric_asian_calls/"
    "merton_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/GeometricAsianCall/"
    "merton_01__geometric_asian_calls_01__01.json";
...
int main() {
    ...
    const std::vector<merton::MertonModelParameters> models =
    ...
    merton::MertonModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(merton::MertonModelParameters)
            ),
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Geometric Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Geometric Asian call standard errors"
        );
        ...
        merton::launch_merton_geometric_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Geometric Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Geometric Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Geometric Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Geometric Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Geometric Asian call standard errors"
    );
