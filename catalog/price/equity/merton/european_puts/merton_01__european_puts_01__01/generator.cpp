// Build one Merton European-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/european_puts/"
    "merton_01__european_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/european_puts/"
    "merton_01__european_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/european_puts/"
    "merton_01__european_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        merton::launch_merton_european_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
