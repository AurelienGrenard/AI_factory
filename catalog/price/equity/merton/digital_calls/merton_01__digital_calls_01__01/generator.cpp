// Build one Merton digital-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/digital_calls/"
    "merton_01__digital_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/digital_calls/"
    "merton_01__digital_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/digital_calls/"
    "merton_01__digital_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton digital call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton digital call standard errors"
        );
        ...
        merton::launch_merton_digital_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton digital call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton digital call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton digital call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton digital call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton digital call standard errors"
    );
