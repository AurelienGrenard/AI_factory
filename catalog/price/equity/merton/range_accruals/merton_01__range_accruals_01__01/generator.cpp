// Build one Merton Range Accrual price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/range_accruals/"
    "merton_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/range_accruals/"
    "merton_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/RangeAccrual/"
    "merton_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Range Accrual standard errors"
        );
        ...
        merton::launch_merton_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Range Accrual standard errors"
    );
