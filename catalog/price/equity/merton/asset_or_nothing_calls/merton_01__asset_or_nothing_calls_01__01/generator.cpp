// Build one Merton asset-or-nothing price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/asset_or_nothing_calls/"
    "merton_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/asset_or_nothing_calls/"
    "merton_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton asset-or-nothing call standard errors"
        );
        ...
        merton::launch_merton_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton asset-or-nothing call standard errors"
    );
