// Build one Merton gap-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/gap_puts/"
    "merton_01__gap_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/gap_puts/"
    "merton_01__gap_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/gap_puts/"
    "merton_01__gap_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton gap put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton gap put standard errors"
        );
        ...
        merton::launch_merton_gap_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton gap put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton gap put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton gap put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton gap put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton gap put standard errors"
    );
