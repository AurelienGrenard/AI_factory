// Build one Merton Geometric-Asian-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/geometric_asian_puts/"
    "merton_01__geometric_asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/geometric_asian_puts/"
    "merton_01__geometric_asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/geometric_asian_puts/"
    "merton_01__geometric_asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Geometric Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Geometric Asian put standard errors"
        );
        ...
        merton::launch_merton_geometric_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Geometric Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Geometric Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Geometric Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Geometric Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Geometric Asian put standard errors"
    );
