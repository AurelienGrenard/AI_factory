// Build one Merton straddle price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/merton/straddle.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/straddles/"
    "merton_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/straddles/"
    "merton_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/straddles/"
    "merton_01__straddles_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton straddle prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton straddle standard errors"
        );
        ...
        merton::launch_merton_straddle_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton straddle warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton straddle prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton straddle standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton straddle prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton straddle standard errors"
    );
