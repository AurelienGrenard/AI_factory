...
#include "model/equity/merton/phoenix_memory_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/phoenix_memory_autocalls/"
    "merton_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/phoenix_memory_autocalls/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Phoenix Memory autocall standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Phoenix Memory autocall standard errors"
    );
