// Build one Merton Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/forward_start_puts/"
    "merton_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/forward_start_puts/"
    "merton_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/forward_start_puts/"
    "merton_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton put standard errors"
        );
        ...
        merton::launch_merton_forward_start_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton put standard errors"
    );
