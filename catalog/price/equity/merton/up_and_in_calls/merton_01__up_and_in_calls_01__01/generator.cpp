// Build one Merton Up-and-in-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/merton/up_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/up_and_in_calls/"
    "merton_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/up_and_in_calls/"
    "merton_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/UpAndInCall/"
    "merton_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton up-and-in call standard errors"
        );
        ...
        merton::launch_merton_up_and_in_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton up-and-in call standard errors"
    );
