...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/digital_puts/"
    "merton_01__digital_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/digital_puts/"
    "merton_01__digital_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/equity/merton/digital_puts/"
    "merton_01__digital_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        merton::launch_merton_digital_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
