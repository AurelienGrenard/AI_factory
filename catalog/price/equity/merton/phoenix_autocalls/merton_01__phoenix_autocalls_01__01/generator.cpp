// Build one Merton Phoenix-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/merton/phoenix_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/phoenix_autocalls/"
    "merton_01__phoenix_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/phoenix_autocalls/"
    "merton_01__phoenix_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/PhoenixAutocall/"
    "merton_01__phoenix_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Phoenix autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Phoenix autocall standard errors"
        );
        ...
        merton::launch_merton_phoenix_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Phoenix autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Phoenix autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Phoenix autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Phoenix autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Phoenix autocall standard errors"
    );
