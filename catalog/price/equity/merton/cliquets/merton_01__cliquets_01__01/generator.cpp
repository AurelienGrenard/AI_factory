...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/cliquets/"
    "merton_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/cliquets/"
    "merton_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/Cliquet/"
    "merton_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton Cliquet prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Merton Cliquet standard errors"
        );
        ...
        merton::launch_merton_cliquet_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton Cliquet prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Merton Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton Cliquet standard errors"
    );
