// Build one Merton Forward-start-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/price/equity/merton/forward_start_calls/"
    "merton_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/equity/merton/forward_start_calls/"
    "merton_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/ForwardStartCall/"
    "merton_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Merton call standard errors"
        );
        ...
        merton::launch_merton_forward_start_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "Merton call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Merton call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Merton call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Merton call standard errors"
    );
