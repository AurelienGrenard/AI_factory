...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/ornstein_uhlenbeck/floorlets/"
    "ornstein_uhlenbeck_01__floorlets_01__01.json";
...
const std::string url =
    ...
    "fixed_income/ornstein_uhlenbeck/floorlets/"
    "ornstein_uhlenbeck_01__floorlets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "OU floorlet warmup");
    ...
    check_cuda(cudaFree(device_prices), "cudaFree OU floorlet prices");
