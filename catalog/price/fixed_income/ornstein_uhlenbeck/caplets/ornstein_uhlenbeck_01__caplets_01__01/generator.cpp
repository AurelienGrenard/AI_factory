// Build one Ornstein-Uhlenbeck caplet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/ornstein_uhlenbeck/caplets/"
    "ornstein_uhlenbeck_01__caplets_01__01.json";
...
const std::string url =
    ...
    "fixed_income/ornstein_uhlenbeck/caplets/"
    "ornstein_uhlenbeck_01__caplets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "OU caplet warmup");
    ...
    check_cuda(cudaFree(device_prices), "cudaFree OU caplet prices");
