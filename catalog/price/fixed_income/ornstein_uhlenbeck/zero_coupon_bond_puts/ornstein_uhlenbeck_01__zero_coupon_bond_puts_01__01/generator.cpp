...
const std::filesystem::path model_dataset_path =
    "datasets/model/fixed_income/ornstein_uhlenbeck/ornstein_uhlenbeck_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/ornstein_uhlenbeck/zero_coupon_bond_puts/"
...
const std::string url =
    ...
    "fixed_income/ornstein_uhlenbeck/zero_coupon_bond_puts/"
    "ornstein_uhlenbeck_01__zero_coupon_bond_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        ou::launch_ornstein_uhlenbeck_zero_coupon_bond_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_products,
            warmup_count,
