...
const std::string url =
    ...
    "fixed_income/ornstein_uhlenbeck/zero_coupon_bond_calls/"
    "ornstein_uhlenbeck_01__zero_coupon_bond_calls_01__01.json";
const std::string numerical_method =
    "Ornstein-Uhlenbeck closed-form zero-coupon bond call";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc OU zero-coupon bond call prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        ou::launch_ornstein_uhlenbeck_zero_coupon_bond_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_products,
            warmup_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "OU ZCB call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy OU zero-coupon bond call prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree OU ZCB call prices");
