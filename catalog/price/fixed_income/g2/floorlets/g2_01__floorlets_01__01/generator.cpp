...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/g2/floorlets/"
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "G2 floorlet warmup");
    ...
    check_cuda(cudaFree(device_prices), "cudaFree G2 floorlet prices");
