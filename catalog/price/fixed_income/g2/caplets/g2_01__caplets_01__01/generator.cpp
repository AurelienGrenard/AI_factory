...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/g2/caplets/"
...
int main() {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree G2 caplet prices");
