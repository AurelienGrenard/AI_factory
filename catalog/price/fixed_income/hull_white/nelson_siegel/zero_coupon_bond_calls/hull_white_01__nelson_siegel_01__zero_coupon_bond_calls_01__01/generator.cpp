// Build one Hull-White Nelson-Siegel zero-coupon bond call dataset.
...
const std::filesystem::path model_dataset_path =
    "datasets/model/fixed_income/hull_white/hull_white_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/hull_white/nelson_siegel/zero_coupon_bond_calls/"
...
const std::string url =
    "https://datasets.ai-factory.example/v1/price/fixed_income/hull_white/"
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "Hull-White zero_coupon_bond_call warmup");
