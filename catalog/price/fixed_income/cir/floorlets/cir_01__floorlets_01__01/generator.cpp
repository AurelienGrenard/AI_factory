...
const std::filesystem::path dataset_path =
    "datasets/price/fixed_income/cir/floorlets/"
    "cir_01__floorlets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CIR floorlet prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "CIR floorlet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CIR floorlet prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CIR floorlet prices");
