...
const std::filesystem::path product_dataset_path =
    "datasets/product/fixed_income/zero_coupon_bond_puts/zero_coupon_bond_puts_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/g2_plus_plus/svensson/zero_coupon_bond_puts/"
    "g2_plus_plus_01__svensson_01__zero_coupon_bond_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/g2_plus_plus/svensson/zero_coupon_bond_puts/"
    "g2_plus_plus_01__svensson_01__zero_coupon_bond_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/g2_plus_plus/"
...
int main() {
    ...
    try {
        ...
        fitted::launch_g2_plus_plus_svensson_zero_coupon_bond_put_cuda(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
