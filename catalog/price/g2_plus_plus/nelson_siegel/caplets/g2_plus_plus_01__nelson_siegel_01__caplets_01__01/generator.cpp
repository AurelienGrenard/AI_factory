// Build one G2++ Nelson-Siegel caplet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/price/g2_plus_plus/nelson_siegel/caplets/"
    "g2_plus_plus_01__nelson_siegel_01__caplets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "G2++ caplet warmup");
