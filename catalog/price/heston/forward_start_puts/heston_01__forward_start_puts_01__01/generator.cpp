...
const std::filesystem::path dataset_path =
    "datasets/price/heston/forward_start_puts/"
...
const std::string url =
    "https://datasets.ai-factory.example/v1/price/heston/forward_start_puts/"
    "heston_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    const std::vector<product::ForwardStartPutParameters> products =
        product::load_forward_start_puts(product_dataset_path);
    ...
    product::ForwardStartPutParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::ForwardStartPutParameters)
            ),
