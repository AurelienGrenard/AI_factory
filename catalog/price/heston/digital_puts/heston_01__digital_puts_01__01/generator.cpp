// Build one Heston digital-put price dataset from JSON inputs.
...
const std::filesystem::path product_dataset_path =
    "datasets/product/equity/digital_puts/digital_puts_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/digital_puts/"
    "heston_01__digital_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/heston/digital_puts/"
    "heston_01__digital_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/heston/digital_puts/"
    "heston_01__digital_puts_01__01.json";
...
int main() {
    ...
    const std::vector<product::DigitalPutParameters> products =
        product::load_digital_puts(product_dataset_path);
    ...
    product::DigitalPutParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::DigitalPutParameters)
            ),
        ...
        check_cuda(
            ...
            "cudaMalloc Heston digital put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston digital put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston digital put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston digital put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston digital put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston digital put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston digital put standard errors"
    );
