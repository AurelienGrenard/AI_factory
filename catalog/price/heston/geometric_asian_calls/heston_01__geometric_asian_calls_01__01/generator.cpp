...
int main() {
    ...
    const std::vector<product::GeometricAsianCallParameters> products =
        product::load_geometric_asian_calls(product_dataset_path);
    ...
    product::GeometricAsianCallParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::GeometricAsianCallParameters)
            ),
