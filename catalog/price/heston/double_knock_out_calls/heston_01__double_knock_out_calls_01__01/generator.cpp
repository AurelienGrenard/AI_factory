// Build one Heston Double-knock-out-call price dataset from JSON inputs.
...
const std::filesystem::path product_dataset_path =
    "datasets/product/equity/double_knock_out_calls/double_knock_out_calls_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/double_knock_out_calls/"
    "heston_01__double_knock_out_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/heston/double_knock_out_calls/"
    "heston_01__double_knock_out_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/DoubleKnockOutCall/"
    "heston_01__double_knock_out_calls_01__01.json";
...
int main() {
    ...
    const std::vector<product::DoubleKnockOutCallParameters> products =
        product::load_double_knock_out_calls(product_dataset_path);
    ...
    product::DoubleKnockOutCallParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::DoubleKnockOutCallParameters)
            ),
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston call warmup");
