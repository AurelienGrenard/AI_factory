// Build one Heston Forward-start-call price dataset from JSON inputs.
...
const std::filesystem::path product_dataset_path =
    "datasets/product/equity/forward_start_calls/forward_start_calls_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/forward_start_calls/"
    "heston_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/heston/forward_start_calls/"
    "heston_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/ForwardStartCall/"
    "heston_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    const std::vector<product::ForwardStartCallParameters> products =
        product::load_forward_start_calls(product_dataset_path);
    ...
    product::ForwardStartCallParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::ForwardStartCallParameters)
            ),
