// Build one Heston Geometric-Asian-put price dataset from JSON inputs.
...
const std::filesystem::path product_dataset_path =
    "datasets/product/equity/geometric_asian_puts/geometric_asian_puts_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/geometric_asian_puts/"
    "heston_01__geometric_asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/price/heston/geometric_asian_puts/"
    "heston_01__geometric_asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/price/heston/geometric_asian_puts/"
    "heston_01__geometric_asian_puts_01__01.json";
...
int main() {
    ...
    const std::vector<product::GeometricAsianPutParameters> products =
        product::load_geometric_asian_puts(product_dataset_path);
    ...
    product::GeometricAsianPutParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::GeometricAsianPutParameters)
            ),
        ...
        check_cuda(
            ...
            "cudaMalloc Heston Geometric Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston Geometric Asian put standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston Geometric Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston Geometric Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston Geometric Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston Geometric Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston Geometric Asian put standard errors"
    );
