// Build one Heston Up-and-out-call price dataset from JSON inputs.
...
const std::filesystem::path product_dataset_path =
    "datasets/product/equity/up_and_out_calls/up_and_out_calls_01.json";
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/up_and_out_calls/"
...
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/UpAndOutCall/"
    "heston_01__up_and_out_calls_01__01.json";
...
int main() {
    ...
    const std::vector<product::UpAndOutCallParameters> products =
        product::load_up_and_out_calls(product_dataset_path);
    ...
    product::UpAndOutCallParameters* device_products = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_products,
                products.size() * sizeof(product::UpAndOutCallParameters)
            ),
