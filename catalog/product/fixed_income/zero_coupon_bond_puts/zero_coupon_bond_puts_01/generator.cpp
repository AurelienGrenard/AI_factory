// Generate puts on zero-coupon bonds with broad strike coverage.
...
// Generate the zero-coupon bond put dataset and catalog entry.
int main() {
    ...
    const std::string url =
        ...
        "zero_coupon_bond_puts/zero_coupon_bond_puts_01.json";
    ...
    write_product_dataset(
        "zero_coupon_bond_puts_01",
        "Zero-Coupon Bond Puts",
        dataset_path,
        catalog_path,
        url,
        {
