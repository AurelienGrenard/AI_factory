// Generate calls on zero-coupon bonds with broad strike coverage.
...
// Generate the zero-coupon bond call dataset and catalog entry.
int main() {
    ...
    const std::string url =
        ...
        "zero_coupon_bond_calls/zero_coupon_bond_calls_01.json";
    ...
    write_product_dataset(
        "zero_coupon_bond_calls_01",
        "Zero-Coupon Bond Calls",
        dataset_path,
        catalog_path,
        url,
        {
