...
// Generate the American-call dataset and catalog entry.
int main() {
    ...
    const std::string url =
        "https://datasets.ai-factory.example/v1/product/american_calls/"
        "american_calls_01.json";
    ...
    write_product_dataset(
        ...
        {
            {"expression", "max(S_t - K, 0) at each exercise date"},
            {
                "interpretation",
