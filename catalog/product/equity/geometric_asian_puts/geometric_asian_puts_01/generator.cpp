...
// Generate the Geometric-Asian-put dataset and catalog entry.
int main() {
    ...
    const std::filesystem::path catalog_path =
        "catalog/product/equity/geometric_asian_puts/geometric_asian_puts_01/dataset.yaml";
    const std::string url =
        "https://datasets.ai-factory.example/v1/product/geometric_asian_puts/"
        "geometric_asian_puts_01.json";
    ...
    write_product_dataset(
        ...
        {
            {"expression", "max(K - geometric_mean(S_[0,T]), 0)"},
