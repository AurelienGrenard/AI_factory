// Generate asset-or-nothing puts on the standard equity grid.
...
int main() {
    ...
    const std::filesystem::path dataset_path =
        "datasets/product/equity/asset_or_nothing_puts/"
        "asset_or_nothing_puts_01.json";
    ...
    const std::string url =
        ...
        "asset_or_nothing_puts/asset_or_nothing_puts_01.json";
    ...
    write_product_dataset(
        "asset_or_nothing_puts_01",
        "Asset-or-Nothing Puts",
        dataset_path,
        catalog_path,
        url,
        {
