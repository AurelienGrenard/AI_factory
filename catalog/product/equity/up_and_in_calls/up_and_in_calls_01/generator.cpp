...
// Generate the Up-and-in-call dataset and catalog entry.
int main() {
    ...
    const std::filesystem::path catalog_path =
        "catalog/product/equity/up_and_in_calls/up_and_in_calls_01/dataset.yaml";
    const std::string url =
        "https://datasets.ai-factory.example/v1/product/up_and_in_calls/"
        "up_and_in_calls_01.json";
