...
// Generate the Down-and-in-put dataset and catalog entry.
int main() {
    ...
    const std::filesystem::path catalog_path =
        "catalog/product/equity/down_and_in_puts/down_and_in_puts_01/dataset.yaml";
    const std::string url =
        "https://datasets.ai-factory.example/v1/product/down_and_in_puts/"
        "down_and_in_puts_01.json";
