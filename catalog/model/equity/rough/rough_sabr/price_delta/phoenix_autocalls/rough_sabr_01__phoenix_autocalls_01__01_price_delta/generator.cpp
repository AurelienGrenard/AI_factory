...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/phoenix_autocalls/rough_sabr_01__phoenix_autocalls_01__01_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/phoenix_autocalls/rough_sabr_01__phoenix_autocalls_01__01/generator.cpp", "centered_crn", .01, 2U};
