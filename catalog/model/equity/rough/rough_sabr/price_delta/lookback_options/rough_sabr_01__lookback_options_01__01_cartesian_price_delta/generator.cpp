// Generated Cartesian-product rough_sabr lookback_option paired recipe with one shared FFT workspace.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_sabr/parameters/rough_sabr_01.json", "datasets/product/lookback_option/lookback_options_01.json", "datasets/model/equity/rough/rough_sabr/price_delta/lookback_options/rough_sabr_01__lookback_options_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/price_delta/lookback_options/rough_sabr_01__lookback_options_01__01_cartesian_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/lookback_options/rough_sabr_01__lookback_options_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/lookback_options/rough_sabr_01__lookback_options_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
