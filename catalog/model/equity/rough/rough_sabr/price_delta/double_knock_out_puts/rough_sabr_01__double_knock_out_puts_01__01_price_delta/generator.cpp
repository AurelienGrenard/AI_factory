...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_sabr/parameters/rough_sabr_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
