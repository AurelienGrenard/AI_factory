...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_sabr/parameters/rough_sabr_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_cartesian_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/double_knock_out_puts/rough_sabr_01__double_knock_out_puts_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
