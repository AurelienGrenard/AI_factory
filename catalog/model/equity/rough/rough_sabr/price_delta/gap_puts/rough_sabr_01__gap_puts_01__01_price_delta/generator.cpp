...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_sabr/parameters/rough_sabr_01.json", "datasets/product/gap_option/gap_put_options_01.json", "datasets/model/equity/rough/rough_sabr/price_delta/gap_puts/rough_sabr_01__gap_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_sabr/price_delta/gap_puts/rough_sabr_01__gap_puts_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/gap_puts/rough_sabr_01__gap_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/gap_puts/rough_sabr_01__gap_puts_01__01/generator.cpp", "centered_crn", .01, 2U};
