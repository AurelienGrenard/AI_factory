...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_sabr/parameters/rough_sabr_01.json", "datasets/product/forward_start_option/forward_start_options_01.json", "datasets/model/equity/rough/rough_sabr/price_delta/forward_start_calls/rough_sabr_01__forward_start_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/price_delta/forward_start_calls/rough_sabr_01__forward_start_calls_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/price_delta/forward_start_calls/rough_sabr_01__forward_start_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_sabr/prices/forward_start_calls/rough_sabr_01__forward_start_calls_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
