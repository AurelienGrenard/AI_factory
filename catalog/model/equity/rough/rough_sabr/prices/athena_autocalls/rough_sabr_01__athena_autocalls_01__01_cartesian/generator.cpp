// Generated Rough-SABR athena-autocalls Volterra-FFT price recipe.
#include "model/equity/rough/rough_sabr/product/athena_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_sabr/prices/athena_autocalls/rough_sabr_01__athena_autocalls_01__01_cartesian.json",
        "catalog/model/equity/rough/rough_sabr/prices/athena_autocalls/rough_sabr_01__athena_autocalls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/prices/athena_autocalls/rough_sabr_01__athena_autocalls_01__01_cartesian.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828790590537728ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "rough_sabr", "athena_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_sabr_athena_autocall_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
