// Generated Rough-SABR down-and-in-puts Volterra-FFT price recipe.
#include "model/equity/rough/rough_sabr/product/down_and_in_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_sabr/prices/down_and_in_puts/rough_sabr_01__down_and_in_puts_01__01_cartesian.json",
        "catalog/model/equity/rough/rough_sabr/prices/down_and_in_puts/rough_sabr_01__down_and_in_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/prices/down_and_in_puts/rough_sabr_01__down_and_in_puts_01__01_cartesian.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828816360341504ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "rough_sabr", "down_and_in_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_sabr_down_and_in_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
