// Generated Rough-SABR forward-start-puts Volterra-FFT price recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01.json",
        "catalog/model/equity/rough/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01.json",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_sabr_forward_start_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
