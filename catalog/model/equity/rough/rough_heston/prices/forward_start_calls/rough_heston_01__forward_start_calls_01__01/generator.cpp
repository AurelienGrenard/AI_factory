...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_heston/prices/forward_start_calls/rough_heston_01__forward_start_calls_01__01.json",
        "catalog/model/equity/rough/rough_heston/prices/forward_start_calls/rough_heston_01__forward_start_calls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/prices/forward_start_calls/rough_heston_01__forward_start_calls_01__01.json",
