...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_heston/prices/range_accruals/rough_heston_01__range_accruals_01__01_cartesian.json",
        "catalog/model/equity/rough/rough_heston/prices/range_accruals/rough_heston_01__range_accruals_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/prices/range_accruals/rough_heston_01__range_accruals_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "range_accrual", ""}).threads_per_block,
        11668828739050930176ULL,
        "1 / 504",
        nlohmann::ordered_json{
            {"simulation_steps_per_day", simulation_steps_per_day},
            {"factor_count", factor_count},
        },
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "range_accrual", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_prepared_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_heston_range_accrual_cuda<
                        factor_count
                    >(
                        device_models,
                        model_count,
