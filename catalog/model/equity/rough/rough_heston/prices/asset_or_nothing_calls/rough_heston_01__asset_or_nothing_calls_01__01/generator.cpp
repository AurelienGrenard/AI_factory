// Generated Rough-Heston asset-or-nothing-calls N-factor price recipe.
#include "model/equity/rough/rough_heston/product/asset_or_nothing_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_heston/prices/asset_or_nothing_calls/rough_heston_01__asset_or_nothing_calls_01__01.json",
        "catalog/model/equity/rough/rough_heston/prices/asset_or_nothing_calls/rough_heston_01__asset_or_nothing_calls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/prices/asset_or_nothing_calls/rough_heston_01__asset_or_nothing_calls_01__01.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "asset_or_nothing_option", ""}).threads_per_block,
        11668828648856616960ULL,
        "1 / 504",
        nlohmann::ordered_json{
            {"simulation_steps_per_day", simulation_steps_per_day},
            {"factor_count", factor_count},
        },
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "asset_or_nothing_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_prepared_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_heston_asset_or_nothing_option_cuda<
