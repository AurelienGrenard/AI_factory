// Generated Rough-Heston phoenix-autocalls N-factor price recipe.
#include "model/equity/rough/rough_heston/product/phoenix_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_heston/prices/phoenix_autocalls/rough_heston_01__phoenix_autocalls_01__01.json",
        "catalog/model/equity/rough/rough_heston/prices/phoenix_autocalls/rough_heston_01__phoenix_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/prices/phoenix_autocalls/rough_heston_01__phoenix_autocalls_01__01.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "phoenix_autocall", ""}).threads_per_block,
        11668828730460995584ULL,
        "1 / 504",
        nlohmann::ordered_json{
            {"simulation_steps_per_day", simulation_steps_per_day},
            {"factor_count", factor_count},
        },
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "rough_heston", "phoenix_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_prepared_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_heston_phoenix_autocall_cuda<
                        factor_count
                    >(
                        device_models,
                        model_count,
