...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/asian_option/asian_options_01.json", "datasets/model/equity/rough/rough_heston/price_delta/asian_puts/rough_heston_01__asian_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/asian_puts/rough_heston_01__asian_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/asian_puts/rough_heston_01__asian_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/asian_puts/rough_heston_01__asian_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
