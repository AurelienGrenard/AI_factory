// Generated Cartesian-product rough_heston down_and_in_option paired recipe using the existing host N-factor preparation.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/down_and_in_option/down_and_in_options_01.json", "datasets/model/equity/rough/rough_heston/price_delta/down_and_in_puts/rough_heston_01__down_and_in_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/down_and_in_puts/rough_heston_01__down_and_in_puts_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/down_and_in_puts/rough_heston_01__down_and_in_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/down_and_in_puts/rough_heston_01__down_and_in_puts_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
