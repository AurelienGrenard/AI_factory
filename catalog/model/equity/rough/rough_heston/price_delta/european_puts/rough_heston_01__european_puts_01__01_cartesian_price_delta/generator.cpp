...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/rough/rough_heston/price_delta/european_puts/rough_heston_01__european_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/european_puts/rough_heston_01__european_puts_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/european_puts/rough_heston_01__european_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/european_puts/rough_heston_01__european_puts_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
    return pricing::generate_prepared_price_delta_dataset(
        ...
        [](const auto* host_models, const auto* device_models, std::size_t model_count,
           ...
           float* prices, float* price_errors, float* deltas, float* delta_errors) {
            model::equity::rough_heston::launch_rough_heston_european_option_price_delta_cuda<OptionSide::put, 7U>(
