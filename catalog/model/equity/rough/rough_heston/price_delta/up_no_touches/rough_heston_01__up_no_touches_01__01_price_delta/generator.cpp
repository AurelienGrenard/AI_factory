// Generated rough_heston up_no_touch paired recipe using the existing host N-factor preparation.
#include "model/equity/rough/rough_heston/product/up_no_touch_price_delta.cuh"
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/up_no_touch/up_no_touches_01.json", "datasets/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/up_no_touches/rough_heston_01__up_no_touches_01__01/recipe.yaml", "centered_crn", .01, 2U};
    return pricing::generate_prepared_price_delta_dataset(
        ...
        [](const auto* host_models, const auto* device_models, std::size_t model_count,
           ...
           float* prices, float* price_errors, float* deltas, float* delta_errors) {
            model::equity::rough_heston::launch_rough_heston_up_no_touch_price_delta_cuda<7U>(
