...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/up_no_touch/up_no_touches_01.json", "datasets/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/up_no_touches/rough_heston_01__up_no_touches_01__01_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/up_no_touches/rough_heston_01__up_no_touches_01__01/generator.cpp", "centered_crn", .01, 2U};
