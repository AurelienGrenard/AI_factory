// Generated Cartesian-product rough_heston european_option paired recipe using the existing host N-factor preparation.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_heston/parameters/rough_heston_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/rough/rough_heston/price_delta/european_calls/rough_heston_01__european_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/price_delta/european_calls/rough_heston_01__european_calls_01__01_cartesian_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_heston/price_delta/european_calls/rough_heston_01__european_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_heston/prices/european_calls/rough_heston_01__european_calls_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
    return pricing::generate_prepared_price_delta_dataset(
        ...
        11668828691806289920ULL, 7U, "7-factor Markovian lift", model::equity::rough_heston::load_models, product::load_european_options,
        ...
        [](const auto* host_models, const auto* device_models, std::size_t model_count,
           ...
           float* prices, float* price_errors, float* deltas, float* delta_errors) {
            model::equity::rough_heston::launch_rough_heston_european_option_price_delta_cuda<OptionSide::call, 7U>(
