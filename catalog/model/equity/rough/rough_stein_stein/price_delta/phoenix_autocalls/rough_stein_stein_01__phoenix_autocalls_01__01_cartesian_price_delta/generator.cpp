...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_stein_stein/parameters/rough_stein_stein_01.json", "datasets/product/phoenix_autocall/phoenix_autocalls_01.json", "datasets/model/equity/rough/rough_stein_stein/price_delta/phoenix_autocalls/rough_stein_stein_01__phoenix_autocalls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/price_delta/phoenix_autocalls/rough_stein_stein_01__phoenix_autocalls_01__01_cartesian_price_delta/dataset.yaml",
