...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_stein_stein/parameters/rough_stein_stein_01.json", "datasets/product/gap_option/gap_call_options_01.json", "datasets/model/equity/rough/rough_stein_stein/price_delta/gap_calls/rough_stein_stein_01__gap_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/price_delta/gap_calls/rough_stein_stein_01__gap_calls_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_stein_stein/price_delta/gap_calls/rough_stein_stein_01__gap_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/prices/gap_calls/rough_stein_stein_01__gap_calls_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
    return pricing::generate_volterra_price_delta_dataset<volterra::TerminalHybridSchedule, product::GapOptionPathPolicy<OptionSide::call>>(
        ...
        [](auto... arguments) {
            model::equity::rough_stein_stein::launch_rough_stein_stein_gap_option_price_delta_cuda<OptionSide::call>(arguments...);
        });
}
