...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_stein_stein/parameters/rough_stein_stein_01.json", "datasets/product/down_and_out_option/down_and_out_options_01.json", "datasets/model/equity/rough/rough_stein_stein/price_delta/down_and_out_puts/rough_stein_stein_01__down_and_out_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/price_delta/down_and_out_puts/rough_stein_stein_01__down_and_out_puts_01__01_price_delta/dataset.yaml",
