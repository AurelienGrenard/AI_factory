// Generated rough_stein_stein up_and_out_option paired recipe with one shared FFT workspace.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_stein_stein/parameters/rough_stein_stein_01.json", "datasets/product/up_and_out_option/up_and_out_options_01.json", "datasets/model/equity/rough/rough_stein_stein/price_delta/up_and_out_calls/rough_stein_stein_01__up_and_out_calls_01__01_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/price_delta/up_and_out_calls/rough_stein_stein_01__up_and_out_calls_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_stein_stein/price_delta/up_and_out_calls/rough_stein_stein_01__up_and_out_calls_01__01_price_delta.json", "catalog/model/equity/rough/rough_stein_stein/prices/up_and_out_calls/rough_stein_stein_01__up_and_out_calls_01__01/generator.cpp", "centered_crn", .01, 2U};
