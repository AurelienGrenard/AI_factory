// Generated Rough Stein-Stein athena-autocalls Volterra-FFT price recipe.
#include "model/equity/rough/rough_stein_stein/product/athena_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_stein_stein/prices/athena_autocalls/rough_stein_stein_01__athena_autocalls_01__01.json",
        "catalog/model/equity/rough/rough_stein_stein/prices/athena_autocalls/rough_stein_stein_01__athena_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_stein_stein/prices/athena_autocalls/rough_stein_stein_01__athena_autocalls_01__01.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828923734523904ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "rough_stein_stein", "athena_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_stein_stein_athena_autocall_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
