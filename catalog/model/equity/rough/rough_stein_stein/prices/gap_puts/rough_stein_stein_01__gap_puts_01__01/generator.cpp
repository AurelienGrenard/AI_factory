...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_stein_stein/prices/gap_puts/rough_stein_stein_01__gap_puts_01__01.json",
        "catalog/model/equity/rough/rough_stein_stein/prices/gap_puts/rough_stein_stein_01__gap_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_stein_stein/prices/gap_puts/rough_stein_stein_01__gap_puts_01__01.json",
