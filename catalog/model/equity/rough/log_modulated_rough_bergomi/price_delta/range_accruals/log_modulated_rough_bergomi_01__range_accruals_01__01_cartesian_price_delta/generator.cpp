// Generated Cartesian-product log_modulated_rough_bergomi range_accrual paired recipe with one shared FFT workspace.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/log_modulated_rough_bergomi/parameters/log_modulated_rough_bergomi_01.json", "datasets/product/range_accrual/range_accruals_01.json", "datasets/model/equity/rough/log_modulated_rough_bergomi/price_delta/range_accruals/log_modulated_rough_bergomi_01__range_accruals_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/log_modulated_rough_bergomi/price_delta/range_accruals/log_modulated_rough_bergomi_01__range_accruals_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/log_modulated_rough_bergomi/price_delta/range_accruals/log_modulated_rough_bergomi_01__range_accruals_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/range_accruals/log_modulated_rough_bergomi_01__range_accruals_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
