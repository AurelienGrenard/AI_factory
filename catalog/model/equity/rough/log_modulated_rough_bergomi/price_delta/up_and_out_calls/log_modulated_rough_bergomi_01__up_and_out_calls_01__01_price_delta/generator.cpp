...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/log_modulated_rough_bergomi/parameters/log_modulated_rough_bergomi_01.json", "datasets/product/up_and_out_option/up_and_out_options_01.json", "datasets/model/equity/rough/log_modulated_rough_bergomi/price_delta/up_and_out_calls/log_modulated_rough_bergomi_01__up_and_out_calls_01__01_price_delta.json", "catalog/model/equity/rough/log_modulated_rough_bergomi/price_delta/up_and_out_calls/log_modulated_rough_bergomi_01__up_and_out_calls_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/log_modulated_rough_bergomi/price_delta/up_and_out_calls/log_modulated_rough_bergomi_01__up_and_out_calls_01__01_price_delta.json", "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/up_and_out_calls/log_modulated_rough_bergomi_01__up_and_out_calls_01__01/generator.cpp", "centered_crn", .01, 2U};
