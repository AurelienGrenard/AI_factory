// Generated Log-modulated rough-Bergomi up-no-touches Volterra-FFT price recipe.
#include "model/equity/rough/log_modulated_rough_bergomi/product/up_no_touch.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/log_modulated_rough_bergomi/prices/up_no_touches/log_modulated_rough_bergomi_01__up_no_touches_01__01_cartesian.json",
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/up_no_touches/log_modulated_rough_bergomi_01__up_no_touches_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/log_modulated_rough_bergomi/prices/up_no_touches/log_modulated_rough_bergomi_01__up_no_touches_01__01_cartesian.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828356798840832ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "log_modulated_rough_bergomi", "up_no_touch", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_log_modulated_rough_bergomi_up_no_touch_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
