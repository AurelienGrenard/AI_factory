...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/up_and_in_calls/log_modulated_rough_bergomi_01__up_and_in_calls_01__01_cartesian/dataset.yaml",
