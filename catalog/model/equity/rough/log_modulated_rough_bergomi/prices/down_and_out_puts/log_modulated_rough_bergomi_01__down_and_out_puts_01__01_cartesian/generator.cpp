...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/down_and_out_puts/log_modulated_rough_bergomi_01__down_and_out_puts_01__01_cartesian/dataset.yaml",
