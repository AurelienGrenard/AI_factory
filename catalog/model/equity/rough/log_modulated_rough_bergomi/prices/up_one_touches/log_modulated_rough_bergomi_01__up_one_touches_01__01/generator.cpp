...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/log_modulated_rough_bergomi/prices/up_one_touches/log_modulated_rough_bergomi_01__up_one_touches_01__01.json",
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/up_one_touches/log_modulated_rough_bergomi_01__up_one_touches_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/log_modulated_rough_bergomi/prices/up_one_touches/log_modulated_rough_bergomi_01__up_one_touches_01__01.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828361093808128ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "log_modulated_rough_bergomi", "up_one_touch", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_log_modulated_rough_bergomi_up_one_touch_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
