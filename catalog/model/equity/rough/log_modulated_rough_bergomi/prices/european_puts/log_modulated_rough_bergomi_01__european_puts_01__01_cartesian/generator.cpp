...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/european_puts/log_modulated_rough_bergomi_01__european_puts_01__01_cartesian/dataset.yaml",
