...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/digital_calls/log_modulated_rough_bergomi_01__digital_calls_01__01_cartesian/dataset.yaml",
