...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/asset_or_nothing_puts/log_modulated_rough_bergomi_01__asset_or_nothing_puts_01__01_cartesian/dataset.yaml",
