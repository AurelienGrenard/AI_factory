...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/log_modulated_rough_bergomi/prices/digital_puts/log_modulated_rough_bergomi_01__digital_puts_01__01.json",
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/digital_puts/log_modulated_rough_bergomi_01__digital_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/log_modulated_rough_bergomi/prices/digital_puts/log_modulated_rough_bergomi_01__digital_puts_01__01.json",
