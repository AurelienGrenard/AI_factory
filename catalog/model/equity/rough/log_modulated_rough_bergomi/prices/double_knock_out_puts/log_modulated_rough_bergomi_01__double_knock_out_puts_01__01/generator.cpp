...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/log_modulated_rough_bergomi/prices/double_knock_out_puts/log_modulated_rough_bergomi_01__double_knock_out_puts_01__01/dataset.yaml",
