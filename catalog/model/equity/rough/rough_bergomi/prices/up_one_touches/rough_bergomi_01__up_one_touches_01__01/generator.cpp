// Generated Rough-Bergomi up-one-touches Volterra-FFT price recipe.
#include "model/equity/rough/rough_bergomi/product/up_one_touch.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_bergomi/prices/up_one_touches/rough_bergomi_01__up_one_touches_01__01.json",
        "catalog/model/equity/rough/rough_bergomi/prices/up_one_touches/rough_bergomi_01__up_one_touches_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/prices/up_one_touches/rough_bergomi_01__up_one_touches_01__01.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828627381780480ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "rough_bergomi", "up_one_touch", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_bergomi_up_one_touch_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
