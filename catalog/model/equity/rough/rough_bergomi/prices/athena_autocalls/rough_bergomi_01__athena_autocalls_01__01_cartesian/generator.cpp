// Generated Rough-Bergomi athena-autocalls Volterra-FFT price recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_cartesian.json",
        "catalog/model/equity/rough/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_cartesian.json",
    ...
    const pricing::VolterraMonteCarloProfile profile{
        ...
        11668828524302565376ULL,
        "1 / 504",
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_fft, "rough_bergomi", "athena_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_volterra_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_rough_bergomi_athena_autocall_cuda(
                        device_models,
                        model_count,
                        device_products,
                        product_count,
