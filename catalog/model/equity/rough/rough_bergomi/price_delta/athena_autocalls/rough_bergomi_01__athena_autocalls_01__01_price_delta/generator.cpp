...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_bergomi/parameters/rough_bergomi_01.json", "datasets/product/athena_autocall/athena_autocalls_01.json", "datasets/model/equity/rough/rough_bergomi/price_delta/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/price_delta/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01/generator.cpp", "centered_crn", .01, 2U};
