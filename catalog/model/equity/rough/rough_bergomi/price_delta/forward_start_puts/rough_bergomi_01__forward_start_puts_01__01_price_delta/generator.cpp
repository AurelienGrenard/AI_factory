...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_bergomi/parameters/rough_bergomi_01.json", "datasets/product/forward_start_option/forward_start_options_01.json", "datasets/model/equity/rough/rough_bergomi/price_delta/forward_start_puts/rough_bergomi_01__forward_start_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/price_delta/forward_start_puts/rough_bergomi_01__forward_start_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/forward_start_puts/rough_bergomi_01__forward_start_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/forward_start_puts/rough_bergomi_01__forward_start_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
