...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_bergomi/parameters/rough_bergomi_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/rough/rough_bergomi/price_delta/double_knock_out_calls/rough_bergomi_01__double_knock_out_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_bergomi/price_delta/double_knock_out_calls/rough_bergomi_01__double_knock_out_calls_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/double_knock_out_calls/rough_bergomi_01__double_knock_out_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/double_knock_out_calls/rough_bergomi_01__double_knock_out_calls_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
