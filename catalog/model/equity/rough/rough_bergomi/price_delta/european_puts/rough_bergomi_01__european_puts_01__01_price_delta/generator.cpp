// Generated rough_bergomi european_option paired recipe with one shared FFT workspace.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_bergomi/parameters/rough_bergomi_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/rough/rough_bergomi/price_delta/european_puts/rough_bergomi_01__european_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/price_delta/european_puts/rough_bergomi_01__european_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/european_puts/rough_bergomi_01__european_puts_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/european_puts/rough_bergomi_01__european_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
    return pricing::generate_volterra_price_delta_dataset<volterra::TerminalHybridSchedule, product::EuropeanOptionPathPolicy<OptionSide::put>>(
        ...
        [](auto... arguments) {
            model::equity::rough_bergomi::launch_rough_bergomi_european_option_price_delta_cuda<OptionSide::put>(arguments...);
        });
}
