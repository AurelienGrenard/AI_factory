...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/range_accruals/rough_bergomi_01__range_accruals_01__01_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/range_accruals/rough_bergomi_01__range_accruals_01__01/recipe.yaml", "centered_crn", .01, 2U};
