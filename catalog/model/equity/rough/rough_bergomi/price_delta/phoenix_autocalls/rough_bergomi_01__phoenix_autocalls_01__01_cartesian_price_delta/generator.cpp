// Generated Cartesian-product rough_bergomi phoenix_autocall paired recipe with one shared FFT workspace.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/rough_bergomi/parameters/rough_bergomi_01.json", "datasets/product/phoenix_autocall/phoenix_autocalls_01.json", "datasets/model/equity/rough/rough_bergomi/price_delta/phoenix_autocalls/rough_bergomi_01__phoenix_autocalls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_bergomi/price_delta/phoenix_autocalls/rough_bergomi_01__phoenix_autocalls_01__01_cartesian_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/rough_bergomi/price_delta/phoenix_autocalls/rough_bergomi_01__phoenix_autocalls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/rough_bergomi/prices/phoenix_autocalls/rough_bergomi_01__phoenix_autocalls_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
