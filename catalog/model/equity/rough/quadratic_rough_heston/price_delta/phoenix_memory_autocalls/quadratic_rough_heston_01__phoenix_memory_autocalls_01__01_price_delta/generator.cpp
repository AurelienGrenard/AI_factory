// Generated quadratic_rough_heston phoenix_memory_autocall paired recipe using the existing host N-factor preparation.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/quadratic_rough_heston/parameters/quadratic_rough_heston_01.json", "datasets/product/phoenix_memory_autocall/phoenix_memory_autocalls_01.json", "datasets/model/equity/rough/quadratic_rough_heston/price_delta/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/price_delta/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/price_delta/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/prices/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01/generator.cpp", "centered_crn", .01, 2U};
