...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/price_delta/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/prices/phoenix_memory_autocalls/quadratic_rough_heston_01__phoenix_memory_autocalls_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
