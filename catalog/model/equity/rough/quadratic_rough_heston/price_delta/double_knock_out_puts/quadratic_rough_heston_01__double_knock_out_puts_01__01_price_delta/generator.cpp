// Generated quadratic_rough_heston double_knock_out_option paired recipe using the existing host N-factor preparation.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/quadratic_rough_heston/parameters/quadratic_rough_heston_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/prices/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
    return pricing::generate_prepared_price_delta_dataset(
        ...
        11668828412633415680ULL, 7U, "7-factor Markovian lift", model::equity::quadratic_rough_heston::load_models, product::load_double_knock_out_options,
        ...
        [](const auto* host_models, const auto* device_models, std::size_t model_count,
           ...
           float* prices, float* price_errors, float* deltas, float* delta_errors) {
            model::equity::quadratic_rough_heston::launch_quadratic_rough_heston_double_knock_out_option_price_delta_cuda<OptionSide::put, 7U>(
