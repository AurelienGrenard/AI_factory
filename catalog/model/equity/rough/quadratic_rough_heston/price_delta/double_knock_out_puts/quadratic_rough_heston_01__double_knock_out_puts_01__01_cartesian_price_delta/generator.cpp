...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/quadratic_rough_heston/parameters/quadratic_rough_heston_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/price_delta/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/prices/double_knock_out_puts/quadratic_rough_heston_01__double_knock_out_puts_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
