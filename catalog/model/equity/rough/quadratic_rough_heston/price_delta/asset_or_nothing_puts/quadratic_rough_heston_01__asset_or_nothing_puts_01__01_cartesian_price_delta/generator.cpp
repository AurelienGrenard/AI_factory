...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/rough/quadratic_rough_heston/parameters/quadratic_rough_heston_01.json", "datasets/product/asset_or_nothing_option/asset_or_nothing_options_01.json", "datasets/model/equity/rough/quadratic_rough_heston/price_delta/asset_or_nothing_puts/quadratic_rough_heston_01__asset_or_nothing_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/price_delta/asset_or_nothing_puts/quadratic_rough_heston_01__asset_or_nothing_puts_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/price_delta/asset_or_nothing_puts/quadratic_rough_heston_01__asset_or_nothing_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/rough/quadratic_rough_heston/prices/asset_or_nothing_puts/quadratic_rough_heston_01__asset_or_nothing_puts_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
