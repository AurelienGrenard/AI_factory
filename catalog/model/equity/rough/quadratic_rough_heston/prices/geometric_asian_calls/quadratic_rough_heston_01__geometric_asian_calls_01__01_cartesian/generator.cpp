...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/quadratic_rough_heston/prices/geometric_asian_calls/quadratic_rough_heston_01__geometric_asian_calls_01__01_cartesian/dataset.yaml",
