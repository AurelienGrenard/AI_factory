...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/quadratic_rough_heston/prices/asset_or_nothing_puts/quadratic_rough_heston_01__asset_or_nothing_puts_01__01_cartesian/dataset.yaml",
