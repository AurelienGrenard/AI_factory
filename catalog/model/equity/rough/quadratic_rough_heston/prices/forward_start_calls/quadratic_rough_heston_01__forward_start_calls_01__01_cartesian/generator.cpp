...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/quadratic_rough_heston/prices/forward_start_calls/quadratic_rough_heston_01__forward_start_calls_01__01_cartesian/dataset.yaml",
