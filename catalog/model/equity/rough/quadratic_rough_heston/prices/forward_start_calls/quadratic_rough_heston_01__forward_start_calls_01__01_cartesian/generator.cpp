// Generated Quadratic rough-Heston forward-start-calls N-factor price recipe.
#include "model/equity/rough/quadratic_rough_heston/product/forward_start_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/quadratic_rough_heston/prices/forward_start_calls/quadratic_rough_heston_01__forward_start_calls_01__01_cartesian.json",
        "catalog/model/equity/rough/quadratic_rough_heston/prices/forward_start_calls/quadratic_rough_heston_01__forward_start_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/prices/forward_start_calls/quadratic_rough_heston_01__forward_start_calls_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "quadratic_rough_heston", "forward_start_option", ""}).threads_per_block,
        11668828434108252160ULL,
        "1 / 504",
        nlohmann::ordered_json{
            {"simulation_steps_per_day", simulation_steps_per_day},
            {"factor_count", factor_count},
        },
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::rough_n_factor, "quadratic_rough_heston", "forward_start_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_prepared_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_quadratic_rough_heston_forward_start_option_cuda<
