...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough/quadratic_rough_heston/prices/forward_start_puts/quadratic_rough_heston_01__forward_start_puts_01__01.json",
        "catalog/model/equity/rough/quadratic_rough_heston/prices/forward_start_puts/quadratic_rough_heston_01__forward_start_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough/quadratic_rough_heston/prices/forward_start_puts/quadratic_rough_heston_01__forward_start_puts_01__01.json",
