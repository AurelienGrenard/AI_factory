...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/rough/quadratic_rough_heston/prices/forward_start_puts/quadratic_rough_heston_01__forward_start_puts_01__01_cartesian/dataset.yaml",
