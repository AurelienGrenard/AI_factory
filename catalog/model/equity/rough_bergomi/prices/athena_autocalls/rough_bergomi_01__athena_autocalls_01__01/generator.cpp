...
#include "model/equity/rough/rough_bergomi/athena_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01.json",
        "catalog/model/equity/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_bergomi/prices/athena_autocalls/rough_bergomi_01__athena_autocalls_01__01.json",
