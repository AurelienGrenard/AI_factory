...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_bergomi/prices/asian_puts/rough_bergomi_01__asian_puts_01__01.json",
        "catalog/model/equity/rough_bergomi/prices/asian_puts/rough_bergomi_01__asian_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_bergomi/prices/asian_puts/rough_bergomi_01__asian_puts_01__01.json",
