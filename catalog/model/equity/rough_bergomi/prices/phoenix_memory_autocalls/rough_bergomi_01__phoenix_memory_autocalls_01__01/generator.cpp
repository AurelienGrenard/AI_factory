...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_bergomi/prices/phoenix_memory_autocalls/rough_bergomi_01__phoenix_memory_autocalls_01__01.json",
        "catalog/model/equity/rough_bergomi/prices/phoenix_memory_autocalls/rough_bergomi_01__phoenix_memory_autocalls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_bergomi/prices/phoenix_memory_autocalls/rough_bergomi_01__phoenix_memory_autocalls_01__01.json",
