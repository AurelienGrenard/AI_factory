...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/black_scholes/prices/lookback_options/black_scholes_01__lookback_options_01__01.json",
        "catalog/model/equity/black_scholes/prices/lookback_options/black_scholes_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/LookbackOption/black_scholes_01__lookback_options_01__01.json",
