...
const std::filesystem::path dataset_path =
    "datasets/model/equity/black_scholes/prices/phoenix_memory_autocalls/"
    "black_scholes_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/black_scholes/prices/phoenix_memory_autocalls/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(black_scholes::ModelParameters)
            ),
