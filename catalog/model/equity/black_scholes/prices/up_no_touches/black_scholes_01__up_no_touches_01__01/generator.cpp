...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/black_scholes/prices/up_no_touches/black_scholes_01__up_no_touches_01__01.json",
        "catalog/model/equity/black_scholes/prices/up_no_touches/black_scholes_01__up_no_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/UpNoTouch/black_scholes_01__up_no_touches_01__01.json",
