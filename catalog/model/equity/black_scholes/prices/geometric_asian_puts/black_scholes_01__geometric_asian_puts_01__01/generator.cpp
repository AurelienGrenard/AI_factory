...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01.json",
        "catalog/model/equity/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01.json",
        "Black-Scholes closed-form geometric-asian-puts",
        PriceConstruction::Aligned,
    };
    const pricing::AnalyticalProfile profile{1.0f / 504.0f, 256U, 2U};
