...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/black_scholes/prices/up_one_touches/black_scholes_01__up_one_touches_01__01.json",
        "catalog/model/equity/black_scholes/prices/up_one_touches/black_scholes_01__up_one_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/BlackScholes/UpOneTouch/black_scholes_01__up_one_touches_01__01.json",
