...
const std::filesystem::path dataset_path =
    "datasets/model/equity/black_scholes/prices/down_and_out_puts/"
    "black_scholes_01__down_and_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/black_scholes/prices/down_and_out_puts/"
    "black_scholes_01__down_and_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/black_scholes/prices/down_and_out_puts/"
    "black_scholes_01__down_and_out_puts_01__01.json";
