...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/black_scholes/prices/european_puts/black_scholes_01__european_puts_01__01.json",
        "catalog/model/equity/black_scholes/prices/european_puts/black_scholes_01__european_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/black_scholes/prices/european_puts/black_scholes_01__european_puts_01__01.json",
