...
const std::filesystem::path dataset_path =
    "datasets/model/equity/black_scholes/prices/geometric_asian_calls/"
    "black_scholes_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/black_scholes/prices/geometric_asian_calls/"
    "black_scholes_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/"
    "equity/black_scholes/prices/geometric_asian_calls/"
    "black_scholes_01__geometric_asian_calls_01__01.json";
