...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01.json",
        "catalog/model/equity/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_sabr/prices/forward_start_puts/rough_sabr_01__forward_start_puts_01__01.json",
