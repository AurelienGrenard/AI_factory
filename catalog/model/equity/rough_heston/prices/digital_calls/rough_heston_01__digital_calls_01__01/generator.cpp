...
#include "model/equity/rough/rough_heston/digital_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_heston/prices/digital_calls/rough_heston_01__digital_calls_01__01.json",
        "catalog/model/equity/rough_heston/prices/digital_calls/rough_heston_01__digital_calls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_heston/prices/digital_calls/rough_heston_01__digital_calls_01__01.json",
