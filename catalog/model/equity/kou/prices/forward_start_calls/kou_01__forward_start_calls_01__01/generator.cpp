...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/forward_start_calls/kou_01__forward_start_calls_01__01.json",
        "catalog/model/equity/kou/prices/forward_start_calls/kou_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/ForwardStartCall/kou_01__forward_start_calls_01__01.json",
