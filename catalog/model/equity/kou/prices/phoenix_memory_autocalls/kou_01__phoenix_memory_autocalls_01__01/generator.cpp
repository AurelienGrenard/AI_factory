...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/phoenix_memory_autocalls/kou_01__phoenix_memory_autocalls_01__01.json",
        "catalog/model/equity/kou/prices/phoenix_memory_autocalls/kou_01__phoenix_memory_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/PhoenixMemoryAutocall/kou_01__phoenix_memory_autocalls_01__01.json",
