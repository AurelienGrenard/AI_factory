...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/lookback_options/kou_01__lookback_options_01__01.json",
        "catalog/model/equity/kou/prices/lookback_options/kou_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/LookbackOption/kou_01__lookback_options_01__01.json",
