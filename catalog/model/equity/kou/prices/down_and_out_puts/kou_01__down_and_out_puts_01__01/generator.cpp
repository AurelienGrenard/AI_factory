...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/down_and_out_puts/kou_01__down_and_out_puts_01__01.json",
        "catalog/model/equity/kou/prices/down_and_out_puts/kou_01__down_and_out_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/kou/prices/down_and_out_puts/kou_01__down_and_out_puts_01__01.json",
