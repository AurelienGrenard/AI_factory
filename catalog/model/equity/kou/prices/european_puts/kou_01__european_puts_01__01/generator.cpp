...
const std::filesystem::path dataset_path =
    "datasets/model/equity/kou/prices/european_puts/"
    "kou_01__european_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/kou/prices/european_puts/"
    "kou_01__european_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/kou/prices/european_puts/"
    "kou_01__european_puts_01__01.json";
