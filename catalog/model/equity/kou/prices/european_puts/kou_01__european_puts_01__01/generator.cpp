...
#include "model/equity/markovian/kou/european_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/european_puts/kou_01__european_puts_01__01.json",
        "catalog/model/equity/kou/prices/european_puts/kou_01__european_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/kou/prices/european_puts/kou_01__european_puts_01__01.json",
