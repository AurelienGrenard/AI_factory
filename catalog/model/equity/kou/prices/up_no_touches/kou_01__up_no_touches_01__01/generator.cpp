...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/kou/prices/up_no_touches/kou_01__up_no_touches_01__01.json",
        "catalog/model/equity/kou/prices/up_no_touches/kou_01__up_no_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Kou/UpNoTouch/kou_01__up_no_touches_01__01.json",
