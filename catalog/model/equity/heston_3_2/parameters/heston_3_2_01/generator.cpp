...
int main() {
    ...
    write_model_dataset(
        ...
        "catalog/model/equity/heston_3_2/parameters/heston_3_2_01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/heston_3_2/parameters/heston_3_2_01.json",
        {
