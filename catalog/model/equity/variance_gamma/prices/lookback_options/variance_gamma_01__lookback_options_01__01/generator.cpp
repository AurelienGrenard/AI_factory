...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/lookback_options/variance_gamma_01__lookback_options_01__01.json",
        "catalog/model/equity/variance_gamma/prices/lookback_options/variance_gamma_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/LookbackOption/variance_gamma_01__lookback_options_01__01.json",
