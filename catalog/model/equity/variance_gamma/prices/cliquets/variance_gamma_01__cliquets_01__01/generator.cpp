...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/cliquets/variance_gamma_01__cliquets_01__01.json",
        "catalog/model/equity/variance_gamma/prices/cliquets/variance_gamma_01__cliquets_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/Cliquet/variance_gamma_01__cliquets_01__01.json",
