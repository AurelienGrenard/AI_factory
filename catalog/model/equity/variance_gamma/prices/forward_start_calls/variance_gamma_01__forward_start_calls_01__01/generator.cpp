...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/forward_start_calls/variance_gamma_01__forward_start_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/forward_start_calls/variance_gamma_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/ForwardStartCall/variance_gamma_01__forward_start_calls_01__01.json",
