...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/double_knock_out_calls/variance_gamma_01__double_knock_out_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/double_knock_out_calls/variance_gamma_01__double_knock_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/DoubleKnockOutCall/variance_gamma_01__double_knock_out_calls_01__01.json",
