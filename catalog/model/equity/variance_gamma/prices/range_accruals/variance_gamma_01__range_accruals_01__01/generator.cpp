...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/range_accruals/variance_gamma_01__range_accruals_01__01.json",
        "catalog/model/equity/variance_gamma/prices/range_accruals/variance_gamma_01__range_accruals_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/RangeAccrual/variance_gamma_01__range_accruals_01__01.json",
