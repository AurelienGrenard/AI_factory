...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/digital_calls/variance_gamma_01__digital_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/digital_calls/variance_gamma_01__digital_calls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/variance_gamma/prices/digital_calls/variance_gamma_01__digital_calls_01__01.json",
