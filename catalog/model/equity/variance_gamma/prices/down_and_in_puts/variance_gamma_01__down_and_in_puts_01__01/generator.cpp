...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/down_and_in_puts/variance_gamma_01__down_and_in_puts_01__01.json",
        "catalog/model/equity/variance_gamma/prices/down_and_in_puts/variance_gamma_01__down_and_in_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/variance_gamma/prices/down_and_in_puts/variance_gamma_01__down_and_in_puts_01__01.json",
