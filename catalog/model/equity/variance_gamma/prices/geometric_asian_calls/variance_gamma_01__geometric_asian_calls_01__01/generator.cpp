...
const std::filesystem::path dataset_path =
    "datasets/model/equity/variance_gamma/prices/geometric_asian_calls/"
    "variance_gamma_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/variance_gamma/prices/geometric_asian_calls/"
...
int main() {
    ...
    variance_gamma::ModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(variance_gamma::ModelParameters)
            ),
