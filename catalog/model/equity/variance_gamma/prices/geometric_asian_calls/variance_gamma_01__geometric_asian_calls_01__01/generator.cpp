...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/geometric_asian_calls/variance_gamma_01__geometric_asian_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/geometric_asian_calls/variance_gamma_01__geometric_asian_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/GeometricAsianCall/variance_gamma_01__geometric_asian_calls_01__01.json",
