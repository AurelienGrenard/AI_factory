...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/up_and_out_calls/variance_gamma_01__up_and_out_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/up_and_out_calls/variance_gamma_01__up_and_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/UpAndOutCall/variance_gamma_01__up_and_out_calls_01__01.json",
