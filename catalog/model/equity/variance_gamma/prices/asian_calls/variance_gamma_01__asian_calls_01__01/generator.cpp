...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/asian_calls/variance_gamma_01__asian_calls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/asian_calls/variance_gamma_01__asian_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/AsianCall/variance_gamma_01__asian_calls_01__01.json",
