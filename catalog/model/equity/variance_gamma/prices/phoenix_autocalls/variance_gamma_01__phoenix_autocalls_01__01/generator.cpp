...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/phoenix_autocalls/variance_gamma_01__phoenix_autocalls_01__01.json",
        "catalog/model/equity/variance_gamma/prices/phoenix_autocalls/variance_gamma_01__phoenix_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/PhoenixAutocall/variance_gamma_01__phoenix_autocalls_01__01.json",
