...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/up_no_touches/variance_gamma_01__up_no_touches_01__01.json",
        "catalog/model/equity/variance_gamma/prices/up_no_touches/variance_gamma_01__up_no_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/UpNoTouch/variance_gamma_01__up_no_touches_01__01.json",
