...
const std::filesystem::path dataset_path =
    "datasets/model/equity/variance_gamma/prices/double_knock_out_puts/"
    "variance_gamma_01__double_knock_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/variance_gamma/prices/double_knock_out_puts/"
    "variance_gamma_01__double_knock_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/variance_gamma/prices/double_knock_out_puts/"
    "variance_gamma_01__double_knock_out_puts_01__01.json";
