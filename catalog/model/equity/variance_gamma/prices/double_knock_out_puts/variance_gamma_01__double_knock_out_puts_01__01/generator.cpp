...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01.json",
        "catalog/model/equity/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01.json",
