...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/variance_gamma/prices/up_one_touches/variance_gamma_01__up_one_touches_01__01.json",
        "catalog/model/equity/variance_gamma/prices/up_one_touches/variance_gamma_01__up_one_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/VarianceGamma/UpOneTouch/variance_gamma_01__up_one_touches_01__01.json",
