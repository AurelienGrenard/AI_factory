...
int main() {
    ...
    write_model_dataset(
        ...
        dataset,
        "catalog/model/equity/log_modulated_rough_bergomi/parameters/log_modulated_rough_bergomi_01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/log_modulated_rough_bergomi/parameters/log_modulated_rough_bergomi_01.json",
        {
