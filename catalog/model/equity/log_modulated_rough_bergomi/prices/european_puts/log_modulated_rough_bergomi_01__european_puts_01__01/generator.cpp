...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/log_modulated_rough_bergomi/prices/european_puts/log_modulated_rough_bergomi_01__european_puts_01__01.json",
        "catalog/model/equity/log_modulated_rough_bergomi/prices/european_puts/log_modulated_rough_bergomi_01__european_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/log_modulated_rough_bergomi/prices/european_puts/log_modulated_rough_bergomi_01__european_puts_01__01.json",
