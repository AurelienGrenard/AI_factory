...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/sabr/prices/asian_puts/sabr_01__asian_puts_01__01.json",
        "catalog/model/equity/sabr/prices/asian_puts/sabr_01__asian_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/sabr/prices/asian_puts/sabr_01__asian_puts_01__01.json",
        "Lamperti SABR Euler",
