...
#include "model/equity/markovian/sabr/up_no_touch.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/sabr/prices/up_no_touches/sabr_01__up_no_touches_01__01.json",
        "catalog/model/equity/sabr/prices/up_no_touches/sabr_01__up_no_touches_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/sabr/prices/up_no_touches/sabr_01__up_no_touches_01__01.json",
        "Lamperti SABR Euler",
