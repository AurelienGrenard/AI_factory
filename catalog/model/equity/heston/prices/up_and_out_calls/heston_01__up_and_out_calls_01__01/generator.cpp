...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/up_and_out_calls/heston_01__up_and_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/UpAndOutCall/heston_01__up_and_out_calls_01__01.json",
        "Andersen QE-M",
