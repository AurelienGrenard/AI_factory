...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/heston/prices/lookback_options/heston_01__lookback_options_01__01.json",
        "catalog/model/equity/heston/prices/lookback_options/heston_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/LookbackOption/heston_01__lookback_options_01__01.json",
        "Andersen QE-M",
