...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/cliquets/heston_01__cliquets_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/Cliquet/heston_01__cliquets_01__01.json",
        "Andersen QE-M",
