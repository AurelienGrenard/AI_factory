...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/athena_autocalls/heston_01__athena_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/AthenaAutocall/heston_01__athena_autocalls_01__01.json",
        "Andersen QE-M",
