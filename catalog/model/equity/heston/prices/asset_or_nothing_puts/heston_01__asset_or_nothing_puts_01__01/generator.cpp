...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/asset_or_nothing_puts/heston_01__asset_or_nothing_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/heston/prices/asset_or_nothing_puts/heston_01__asset_or_nothing_puts_01__01.json",
        "Andersen QE-M",
