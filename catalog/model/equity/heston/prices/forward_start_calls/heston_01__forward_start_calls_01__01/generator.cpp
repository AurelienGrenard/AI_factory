...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/heston/prices/forward_start_calls/heston_01__forward_start_calls_01__01.json",
        "catalog/model/equity/heston/prices/forward_start_calls/heston_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/ForwardStartCall/heston_01__forward_start_calls_01__01.json",
        "Andersen QE-M",
