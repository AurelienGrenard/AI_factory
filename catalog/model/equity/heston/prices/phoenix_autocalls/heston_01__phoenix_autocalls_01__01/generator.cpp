...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/phoenix_autocalls/heston_01__phoenix_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/PhoenixAutocall/heston_01__phoenix_autocalls_01__01.json",
        "Andersen QE-M",
