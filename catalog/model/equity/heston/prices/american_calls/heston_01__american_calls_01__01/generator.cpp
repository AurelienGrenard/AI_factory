...
const std::filesystem::path dataset_path =
    "datasets/model/equity/heston/prices/american_calls/"
    "heston_01__american_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/heston/prices/american_calls/"
    "heston_01__american_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/heston/prices/american_calls/"
    "heston_01__american_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc Heston American call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc Heston American call standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "Heston American-call warmup");
        ...
        longstaff_schwartz::validate_regression_diagnostics(
            execution, "Heston American call"
        );
        ...
        check_cuda(
            ...
            "cudaMemcpy Heston American call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy Heston American call standard errors"
        );
    ...
    check_cuda(cudaFree(device_prices), "cudaFree Heston American call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree Heston American call standard errors"
    );
