// Generated Heston American-call price-dataset recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "american_calls/heston_01__american_calls_01__01.json",
    ...
    return pricing::generate_american_option_equity_price_dataset(
        ...
        [&](const auto* device_models, std::size_t model_count,
            ...
            return model_binding::launch_heston_american_option_cuda<
                OptionSide::call
            >(
                device_models,
                model_count,
