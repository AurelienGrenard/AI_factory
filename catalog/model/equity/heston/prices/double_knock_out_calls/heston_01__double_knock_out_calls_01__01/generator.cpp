...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/double_knock_out_calls/heston_01__double_knock_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/DoubleKnockOutCall/heston_01__double_knock_out_calls_01__01.json",
        "Andersen QE-M",
