...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/digital_puts/heston_01__digital_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/heston/prices/digital_puts/heston_01__digital_puts_01__01.json",
        "Andersen QE-M",
