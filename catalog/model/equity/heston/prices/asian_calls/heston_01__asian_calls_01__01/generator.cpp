...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/asian_calls/heston_01__asian_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/AsianCall/heston_01__asian_calls_01__01.json",
        "Andersen QE-M",
