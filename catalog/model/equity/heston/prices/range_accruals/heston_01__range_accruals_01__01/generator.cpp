...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/range_accruals/heston_01__range_accruals_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/RangeAccrual/heston_01__range_accruals_01__01.json",
        "Andersen QE-M",
