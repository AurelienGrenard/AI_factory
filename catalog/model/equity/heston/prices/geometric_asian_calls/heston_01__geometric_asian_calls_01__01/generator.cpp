...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/heston/prices/geometric_asian_calls/heston_01__geometric_asian_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Heston/GeometricAsianCall/heston_01__geometric_asian_calls_01__01.json",
        "Andersen QE-M",
