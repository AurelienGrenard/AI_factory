...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01.json",
        "catalog/model/equity/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01.json",
        "Andersen QE-M",
