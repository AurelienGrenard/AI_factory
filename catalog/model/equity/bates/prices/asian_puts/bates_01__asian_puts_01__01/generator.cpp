...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/bates/prices/asian_puts/bates_01__asian_puts_01__01.json",
        "catalog/model/equity/bates/prices/asian_puts/bates_01__asian_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/bates/prices/asian_puts/bates_01__asian_puts_01__01.json",
