...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/bates/prices/forward_start_calls/bates_01__forward_start_calls_01__01.json",
        "catalog/model/equity/bates/prices/forward_start_calls/bates_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Bates/ForwardStartCall/bates_01__forward_start_calls_01__01.json",
