...
const std::filesystem::path dataset_path =
    "datasets/model/equity/bates/prices/geometric_asian_puts/"
    "bates_01__geometric_asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/bates/prices/geometric_asian_puts/"
    "bates_01__geometric_asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/bates/prices/geometric_asian_puts/"
    "bates_01__geometric_asian_puts_01__01.json";
...
int main() {
    ...
    bates::ModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(bates::ModelParameters)
            ),
