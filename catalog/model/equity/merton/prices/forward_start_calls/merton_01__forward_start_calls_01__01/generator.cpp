...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/merton/prices/forward_start_calls/merton_01__forward_start_calls_01__01.json",
        "catalog/model/equity/merton/prices/forward_start_calls/merton_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/ForwardStartCall/merton_01__forward_start_calls_01__01.json",
