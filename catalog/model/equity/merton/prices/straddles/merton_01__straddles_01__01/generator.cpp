...
const std::filesystem::path dataset_path =
    "datasets/model/equity/merton/prices/straddles/"
    "merton_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/merton/prices/straddles/"
    "merton_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/merton/prices/straddles/"
    "merton_01__straddles_01__01.json";
