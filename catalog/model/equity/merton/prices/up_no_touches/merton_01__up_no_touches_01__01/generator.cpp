...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/merton/prices/up_no_touches/merton_01__up_no_touches_01__01.json",
        "catalog/model/equity/merton/prices/up_no_touches/merton_01__up_no_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/UpNoTouch/merton_01__up_no_touches_01__01.json",
