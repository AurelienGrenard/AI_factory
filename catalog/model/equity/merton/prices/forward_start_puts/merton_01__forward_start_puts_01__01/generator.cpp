...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/merton/prices/forward_start_puts/merton_01__forward_start_puts_01__01.json",
        "catalog/model/equity/merton/prices/forward_start_puts/merton_01__forward_start_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/merton/prices/forward_start_puts/merton_01__forward_start_puts_01__01.json",
