...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/merton/prices/lookback_options/merton_01__lookback_options_01__01.json",
        "catalog/model/equity/merton/prices/lookback_options/merton_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/Merton/LookbackOption/merton_01__lookback_options_01__01.json",
