...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/variance_gamma/prices/double_knock_out_puts/variance_gamma_01__double_knock_out_puts_01__01_cartesian.json",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_variance_gamma_double_knock_out_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
