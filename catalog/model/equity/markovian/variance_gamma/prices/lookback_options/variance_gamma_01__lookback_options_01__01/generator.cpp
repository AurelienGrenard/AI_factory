...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/variance_gamma/prices/lookback_options/variance_gamma_01__lookback_options_01__01.json",
        "catalog/model/equity/markovian/variance_gamma/prices/lookback_options/variance_gamma_01__lookback_options_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/variance_gamma/prices/lookback_options/variance_gamma_01__lookback_options_01__01.json",
