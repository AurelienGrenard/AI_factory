...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/variance_gamma/prices/straddles/variance_gamma_01__straddles_01__01_cartesian.json",
        "catalog/model/equity/markovian/variance_gamma/prices/straddles/variance_gamma_01__straddles_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/variance_gamma/prices/straddles/variance_gamma_01__straddles_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "variance_gamma", "straddle", ""}).threads_per_block,
        11668828210769952768ULL,
        "exact transition dates",
        nlohmann::ordered_json::object(),
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "variance_gamma", "straddle", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_variance_gamma_straddle_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
