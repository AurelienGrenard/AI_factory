// Generated Variance-Gamma athena-autocalls price-dataset recipe.
#include "model/equity/markovian/variance_gamma/product/athena_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/variance_gamma/prices/athena_autocalls/variance_gamma_01__athena_autocalls_01__01.json",
        "catalog/model/equity/markovian/variance_gamma/prices/athena_autocalls/variance_gamma_01__athena_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/variance_gamma/prices/athena_autocalls/variance_gamma_01__athena_autocalls_01__01.json",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_variance_gamma_athena_autocall_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
