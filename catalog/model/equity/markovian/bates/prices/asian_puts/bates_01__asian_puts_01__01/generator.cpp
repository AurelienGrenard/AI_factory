...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/bates/prices/asian_puts/bates_01__asian_puts_01__01.json",
        "catalog/model/equity/markovian/bates/prices/asian_puts/bates_01__asian_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/bates/prices/asian_puts/bates_01__asian_puts_01__01.json",
