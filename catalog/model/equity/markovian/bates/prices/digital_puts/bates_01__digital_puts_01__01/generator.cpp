...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/bates/prices/digital_puts/bates_01__digital_puts_01__01.json",
        "catalog/model/equity/markovian/bates/prices/digital_puts/bates_01__digital_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/bates/prices/digital_puts/bates_01__digital_puts_01__01.json",
