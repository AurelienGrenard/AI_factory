// Generated Bates up-one-touches price-dataset recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/bates/prices/up_one_touches/bates_01__up_one_touches_01__01_cartesian.json",
        "catalog/model/equity/markovian/bates/prices/up_one_touches/bates_01__up_one_touches_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/bates/prices/up_one_touches/bates_01__up_one_touches_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "bates", "up_one_touch", ""}).threads_per_block,
        11668826763365974016ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "bates", "up_one_touch", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_bates_up_one_touch_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
