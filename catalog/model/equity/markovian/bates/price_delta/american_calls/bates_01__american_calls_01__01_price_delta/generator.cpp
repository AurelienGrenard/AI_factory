...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/bates/price_delta/american_calls/bates_01__american_calls_01__01_price_delta.json", "catalog/model/equity/markovian/bates/prices/american_calls/bates_01__american_calls_01__01/recipe.yaml", "frozen_central_exercise_dates_crn", .01, 2U};
