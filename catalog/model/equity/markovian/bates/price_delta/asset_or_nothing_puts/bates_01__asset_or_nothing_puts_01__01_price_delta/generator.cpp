...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/bates/price_delta/asset_or_nothing_puts/bates_01__asset_or_nothing_puts_01__01_price_delta.json", "catalog/model/equity/markovian/bates/prices/asset_or_nothing_puts/bates_01__asset_or_nothing_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
