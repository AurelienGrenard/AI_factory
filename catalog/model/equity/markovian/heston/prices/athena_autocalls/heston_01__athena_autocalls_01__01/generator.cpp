...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/heston/prices/athena_autocalls/heston_01__athena_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/athena_autocalls/heston_01__athena_autocalls_01__01.json",
        "Andersen QE-M",
