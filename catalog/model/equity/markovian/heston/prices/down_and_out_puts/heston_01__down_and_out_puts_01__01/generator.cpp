...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/heston/prices/down_and_out_puts/heston_01__down_and_out_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/down_and_out_puts/heston_01__down_and_out_puts_01__01.json",
        "Andersen QE-M",
