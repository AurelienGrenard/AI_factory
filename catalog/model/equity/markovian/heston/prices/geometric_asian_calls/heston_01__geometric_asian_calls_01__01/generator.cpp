...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/heston/prices/geometric_asian_calls/heston_01__geometric_asian_calls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/geometric_asian_calls/heston_01__geometric_asian_calls_01__01.json",
        "Andersen QE-M",
