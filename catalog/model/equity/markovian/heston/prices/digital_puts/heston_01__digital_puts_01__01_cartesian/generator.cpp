...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/heston/prices/digital_puts/heston_01__digital_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/heston/prices/digital_puts/heston_01__digital_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/digital_puts/heston_01__digital_puts_01__01_cartesian.json",
        "Andersen QE-M",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_heston_digital_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
