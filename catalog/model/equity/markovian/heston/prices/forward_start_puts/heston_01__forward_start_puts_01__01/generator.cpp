...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01.json",
        "catalog/model/equity/markovian/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/forward_start_puts/heston_01__forward_start_puts_01__01.json",
        "Andersen QE-M",
