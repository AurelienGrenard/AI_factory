...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/heston/prices/phoenix_autocalls/heston_01__phoenix_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/prices/phoenix_autocalls/heston_01__phoenix_autocalls_01__01.json",
        "Andersen QE-M",
