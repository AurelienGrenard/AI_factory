...
int main() {
    ...
    try {
        const datasets::price_gradients::Recipe recipe{
            "datasets/model/equity/markovian/heston/parameters/heston_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/markovian/heston/price_gradients/european_puts/heston_01__european_puts_01__01_cartesian_price_gradients.json", "catalog/model/equity/markovian/heston/price_gradients/european_puts/heston_01__european_puts_01__01_cartesian_price_gradients/generation.yaml", "https://datasets.ai-factory.example/v1/model/equity/markovian/heston/price_gradients/european_puts/heston_01__european_puts_01__01_cartesian_price_gradients.json", "catalog/model/equity/markovian/heston/prices/european_puts/heston_01__european_puts_01__01_cartesian/recipe.yaml",
