...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/sabr/price_delta/lookback_options/sabr_01__lookback_options_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/sabr/prices/lookback_options/sabr_01__lookback_options_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
