...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/sabr/price_delta/double_knock_out_calls/sabr_01__double_knock_out_calls_01__01_price_delta.json", "catalog/model/equity/markovian/sabr/prices/double_knock_out_calls/sabr_01__double_knock_out_calls_01__01/generator.cpp", "centered_crn", .01, 2U};
