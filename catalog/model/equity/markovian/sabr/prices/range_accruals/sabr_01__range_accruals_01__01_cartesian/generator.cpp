...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/sabr/prices/range_accruals/sabr_01__range_accruals_01__01_cartesian.json",
        "catalog/model/equity/markovian/sabr/prices/range_accruals/sabr_01__range_accruals_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/sabr/prices/range_accruals/sabr_01__range_accruals_01__01_cartesian.json",
        "Lamperti SABR Euler",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "sabr", "range_accrual", ""}).threads_per_block,
        11668827789863157760ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "sabr", "range_accrual", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_sabr_range_accrual_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
