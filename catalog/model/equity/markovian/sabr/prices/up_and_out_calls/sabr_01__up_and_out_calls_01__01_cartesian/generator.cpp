// Generated SABR up-and-out-calls price-dataset recipe.
#include "model/equity/markovian/sabr/product/up_and_out_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/sabr/prices/up_and_out_calls/sabr_01__up_and_out_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/sabr/prices/up_and_out_calls/sabr_01__up_and_out_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/sabr/prices/up_and_out_calls/sabr_01__up_and_out_calls_01__01_cartesian.json",
        "Lamperti SABR Euler",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "sabr", "up_and_out_option", ""}).threads_per_block,
        11668827802748059648ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "sabr", "up_and_out_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_sabr_up_and_out_option_cuda<OptionSide::call>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
