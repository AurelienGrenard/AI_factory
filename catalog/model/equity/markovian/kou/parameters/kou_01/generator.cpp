...
int main() {
    ...
    write_model_dataset(
        ...
        dataset,
        "catalog/model/equity/markovian/kou/parameters/kou_01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/parameters/kou_01.json",
        {
            {"spot", "Initial spot."},
