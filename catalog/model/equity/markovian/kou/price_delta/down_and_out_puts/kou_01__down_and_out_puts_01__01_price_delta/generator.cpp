...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/kou/parameters/kou_01.json", "datasets/product/down_and_out_option/down_and_out_options_01.json", "datasets/model/equity/markovian/kou/price_delta/down_and_out_puts/kou_01__down_and_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/kou/price_delta/down_and_out_puts/kou_01__down_and_out_puts_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/price_delta/down_and_out_puts/kou_01__down_and_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/kou/prices/down_and_out_puts/kou_01__down_and_out_puts_01__01/generator.cpp", "centered_crn", .01, 2U};
