...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/price_delta/up_and_in_calls/kou_01__up_and_in_calls_01__01_price_delta.json", "catalog/model/equity/markovian/kou/prices/up_and_in_calls/kou_01__up_and_in_calls_01__01/recipe.yaml", "centered_crn", .01, 2U};
