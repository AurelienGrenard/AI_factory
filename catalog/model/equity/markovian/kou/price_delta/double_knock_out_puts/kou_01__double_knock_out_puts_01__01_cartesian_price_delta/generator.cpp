...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/kou/parameters/kou_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/markovian/kou/price_delta/double_knock_out_puts/kou_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/kou/price_delta/double_knock_out_puts/kou_01__double_knock_out_puts_01__01_cartesian_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/price_delta/double_knock_out_puts/kou_01__double_knock_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/kou/prices/double_knock_out_puts/kou_01__double_knock_out_puts_01__01_cartesian/generator.cpp", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
