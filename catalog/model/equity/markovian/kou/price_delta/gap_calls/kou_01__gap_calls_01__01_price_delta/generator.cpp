...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/kou/parameters/kou_01.json", "datasets/product/gap_option/gap_call_options_01.json", "datasets/model/equity/markovian/kou/price_delta/gap_calls/kou_01__gap_calls_01__01_price_delta.json", "catalog/model/equity/markovian/kou/price_delta/gap_calls/kou_01__gap_calls_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/price_delta/gap_calls/kou_01__gap_calls_01__01_price_delta.json", "catalog/model/equity/markovian/kou/prices/gap_calls/kou_01__gap_calls_01__01/recipe.yaml", "centered_crn", .01, 0U};
