...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/kou/prices/gap_puts/kou_01__gap_puts_01__01.json",
        "catalog/model/equity/markovian/kou/prices/gap_puts/kou_01__gap_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/kou/prices/gap_puts/kou_01__gap_puts_01__01.json",
