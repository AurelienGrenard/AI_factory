...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_puts/schobel_zhu_01__asset_or_nothing_puts_01__01.json",
        "catalog/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_puts/schobel_zhu_01__asset_or_nothing_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_puts/schobel_zhu_01__asset_or_nothing_puts_01__01.json",
