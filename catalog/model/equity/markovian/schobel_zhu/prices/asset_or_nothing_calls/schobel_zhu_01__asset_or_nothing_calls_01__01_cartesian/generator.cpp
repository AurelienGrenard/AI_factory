// Generated Schobel-Zhu asset-or-nothing-calls price-dataset recipe.
#include "model/equity/markovian/schobel_zhu/product/asset_or_nothing_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_calls/schobel_zhu_01__asset_or_nothing_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_calls/schobel_zhu_01__asset_or_nothing_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/schobel_zhu/prices/asset_or_nothing_calls/schobel_zhu_01__asset_or_nothing_calls_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "schobel_zhu", "asset_or_nothing_option", ""}).threads_per_block,
        11668827841402765312ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "schobel_zhu", "asset_or_nothing_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_schobel_zhu_asset_or_nothing_option_cuda<OptionSide::call>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
