...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/schobel_zhu/prices/athena_autocalls/schobel_zhu_01__athena_autocalls_01__01.json",
        "catalog/model/equity/markovian/schobel_zhu/prices/athena_autocalls/schobel_zhu_01__athena_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/schobel_zhu/prices/athena_autocalls/schobel_zhu_01__athena_autocalls_01__01.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "schobel_zhu", "athena_autocall", ""}).threads_per_block,
        11668827849992699904ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "schobel_zhu", "athena_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_schobel_zhu_athena_autocall_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
