// Generated Cartesian-product schobel_zhu phoenix_autocall price-delta recipe; production paths/profile stay shared.
#include "model/equity/markovian/schobel_zhu/product/phoenix_autocall_price_delta.cuh"
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/schobel_zhu/parameters/schobel_zhu_01.json", "datasets/product/phoenix_autocall/phoenix_autocalls_01.json", "datasets/model/equity/markovian/schobel_zhu/price_delta/phoenix_autocalls/schobel_zhu_01__phoenix_autocalls_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/schobel_zhu/price_delta/phoenix_autocalls/schobel_zhu_01__phoenix_autocalls_01__01_cartesian_price_delta/generation.yaml",
    ...
    return pricing::generate_equity_price_delta_dataset<true, false>(
        ...
        [](const auto* host_models, const auto* device_models, std::size_t model_count,
           ...
           float* prices, float* price_errors, float* deltas, float* delta_errors) {
            return model::equity::schobel_zhu::launch_schobel_zhu_phoenix_autocall_price_delta_cuda(
                    host_models,
                    device_models,
                    model_count,
                    host_products,
