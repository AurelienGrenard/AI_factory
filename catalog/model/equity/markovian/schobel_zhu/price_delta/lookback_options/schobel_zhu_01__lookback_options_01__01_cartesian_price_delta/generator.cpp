// Generated Cartesian-product schobel_zhu lookback_option price-delta recipe; production paths/profile stay shared.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/schobel_zhu/parameters/schobel_zhu_01.json", "datasets/product/lookback_option/lookback_options_01.json", "datasets/model/equity/markovian/schobel_zhu/price_delta/lookback_options/schobel_zhu_01__lookback_options_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/schobel_zhu/price_delta/lookback_options/schobel_zhu_01__lookback_options_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/schobel_zhu/price_delta/lookback_options/schobel_zhu_01__lookback_options_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/schobel_zhu/prices/lookback_options/schobel_zhu_01__lookback_options_01__01_cartesian/recipe.yaml", "centered_crn", .01, 2U, PriceConstruction::CartesianProduct};
