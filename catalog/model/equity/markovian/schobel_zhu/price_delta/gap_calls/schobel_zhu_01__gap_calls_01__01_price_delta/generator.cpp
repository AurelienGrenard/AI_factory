...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/schobel_zhu/price_delta/gap_calls/schobel_zhu_01__gap_calls_01__01_price_delta.json", "catalog/model/equity/markovian/schobel_zhu/prices/gap_calls/schobel_zhu_01__gap_calls_01__01/recipe.yaml", "centered_crn", .01, 2U};
