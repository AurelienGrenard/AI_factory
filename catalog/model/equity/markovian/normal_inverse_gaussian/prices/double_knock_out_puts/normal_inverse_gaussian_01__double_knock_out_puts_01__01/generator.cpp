...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/double_knock_out_puts/normal_inverse_gaussian_01__double_knock_out_puts_01__01/dataset.yaml",
