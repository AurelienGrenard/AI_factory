...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/phoenix_autocalls/normal_inverse_gaussian_01__phoenix_autocalls_01__01_cartesian/dataset.yaml",
