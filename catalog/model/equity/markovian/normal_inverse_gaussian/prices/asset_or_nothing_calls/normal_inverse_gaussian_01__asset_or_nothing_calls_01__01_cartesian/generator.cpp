...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/asset_or_nothing_calls/normal_inverse_gaussian_01__asset_or_nothing_calls_01__01_cartesian/dataset.yaml",
