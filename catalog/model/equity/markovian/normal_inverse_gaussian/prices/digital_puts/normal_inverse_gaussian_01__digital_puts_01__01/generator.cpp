...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/normal_inverse_gaussian/prices/digital_puts/normal_inverse_gaussian_01__digital_puts_01__01.json",
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/digital_puts/normal_inverse_gaussian_01__digital_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/normal_inverse_gaussian/prices/digital_puts/normal_inverse_gaussian_01__digital_puts_01__01.json",
