...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/up_and_in_calls/normal_inverse_gaussian_01__up_and_in_calls_01__01_cartesian/dataset.yaml",
