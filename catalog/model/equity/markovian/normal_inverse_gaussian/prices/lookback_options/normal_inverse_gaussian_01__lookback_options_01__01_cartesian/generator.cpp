...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/lookback_options/normal_inverse_gaussian_01__lookback_options_01__01_cartesian/dataset.yaml",
