...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/geometric_asian_puts/normal_inverse_gaussian_01__geometric_asian_puts_01__01/dataset.yaml",
