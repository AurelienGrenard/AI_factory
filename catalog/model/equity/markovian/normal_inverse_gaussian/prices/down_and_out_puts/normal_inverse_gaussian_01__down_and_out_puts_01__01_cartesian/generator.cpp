// Generated Normal-Inverse-Gaussian down-and-out-puts price-dataset recipe.
#include "model/equity/markovian/normal_inverse_gaussian/product/down_and_out_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/normal_inverse_gaussian/prices/down_and_out_puts/normal_inverse_gaussian_01__down_and_out_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/down_and_out_puts/normal_inverse_gaussian_01__down_and_out_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/normal_inverse_gaussian/prices/down_and_out_puts/normal_inverse_gaussian_01__down_and_out_puts_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "normal_inverse_gaussian", "down_and_out_option", ""}).threads_per_block,
        11668827605179564032ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "normal_inverse_gaussian", "down_and_out_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_normal_inverse_gaussian_down_and_out_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
