...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/normal_inverse_gaussian/prices/down_and_out_puts/normal_inverse_gaussian_01__down_and_out_puts_01__01_cartesian/dataset.yaml",
