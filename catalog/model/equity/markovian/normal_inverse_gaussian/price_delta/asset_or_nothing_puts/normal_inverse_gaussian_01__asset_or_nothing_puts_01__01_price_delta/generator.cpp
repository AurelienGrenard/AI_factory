...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/normal_inverse_gaussian/parameters/normal_inverse_gaussian_01.json", "datasets/product/asset_or_nothing_option/asset_or_nothing_options_01.json", "datasets/model/equity/markovian/normal_inverse_gaussian/price_delta/asset_or_nothing_puts/normal_inverse_gaussian_01__asset_or_nothing_puts_01__01_price_delta.json", "catalog/model/equity/markovian/normal_inverse_gaussian/price_delta/asset_or_nothing_puts/normal_inverse_gaussian_01__asset_or_nothing_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/normal_inverse_gaussian/price_delta/asset_or_nothing_puts/normal_inverse_gaussian_01__asset_or_nothing_puts_01__01_price_delta.json", "catalog/model/equity/markovian/normal_inverse_gaussian/prices/asset_or_nothing_puts/normal_inverse_gaussian_01__asset_or_nothing_puts_01__01/recipe.yaml", "centered_crn", .01, 0U};
