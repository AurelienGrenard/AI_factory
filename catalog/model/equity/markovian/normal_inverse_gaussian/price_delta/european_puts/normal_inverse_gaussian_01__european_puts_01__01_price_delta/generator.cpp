// Generated aligned normal_inverse_gaussian european_option price-delta recipe; production paths/profile stay shared.
...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/normal_inverse_gaussian/parameters/normal_inverse_gaussian_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/markovian/normal_inverse_gaussian/price_delta/european_puts/normal_inverse_gaussian_01__european_puts_01__01_price_delta.json", "catalog/model/equity/markovian/normal_inverse_gaussian/price_delta/european_puts/normal_inverse_gaussian_01__european_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/normal_inverse_gaussian/price_delta/european_puts/normal_inverse_gaussian_01__european_puts_01__01_price_delta.json", "catalog/model/equity/markovian/normal_inverse_gaussian/prices/european_puts/normal_inverse_gaussian_01__european_puts_01__01/recipe.yaml", "centered_crn", .01, 0U};
