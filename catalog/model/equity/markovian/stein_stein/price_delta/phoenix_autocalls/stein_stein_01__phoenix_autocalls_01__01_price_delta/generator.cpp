...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/stein_stein/parameters/stein_stein_01.json", "datasets/product/phoenix_autocall/phoenix_autocalls_01.json", "datasets/model/equity/markovian/stein_stein/price_delta/phoenix_autocalls/stein_stein_01__phoenix_autocalls_01__01_price_delta.json", "catalog/model/equity/markovian/stein_stein/price_delta/phoenix_autocalls/stein_stein_01__phoenix_autocalls_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/stein_stein/price_delta/phoenix_autocalls/stein_stein_01__phoenix_autocalls_01__01_price_delta.json", "catalog/model/equity/markovian/stein_stein/prices/phoenix_autocalls/stein_stein_01__phoenix_autocalls_01__01/generator.cpp", "centered_crn", .01, 2U};
