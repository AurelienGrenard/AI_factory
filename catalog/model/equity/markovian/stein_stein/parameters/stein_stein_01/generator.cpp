...
int main() {
    ...
    write_model_dataset(
        ...
        "catalog/model/equity/markovian/stein_stein/parameters/stein_stein_01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/stein_stein/parameters/stein_stein_01.json",
        {
