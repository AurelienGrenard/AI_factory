...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/merton/parameters/merton_01.json", "datasets/product/gap_option/gap_call_options_01.json", "datasets/model/equity/markovian/merton/price_delta/gap_calls/merton_01__gap_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/merton/price_delta/gap_calls/merton_01__gap_calls_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/price_delta/gap_calls/merton_01__gap_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/merton/prices/gap_calls/merton_01__gap_calls_01__01_cartesian/recipe.yaml", "centered_crn", .01, 0U, PriceConstruction::CartesianProduct};
