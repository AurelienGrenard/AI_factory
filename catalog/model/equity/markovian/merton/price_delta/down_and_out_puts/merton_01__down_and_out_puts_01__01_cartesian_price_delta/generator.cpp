...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/merton/parameters/merton_01.json", "datasets/product/down_and_out_option/down_and_out_options_01.json", "datasets/model/equity/markovian/merton/price_delta/down_and_out_puts/merton_01__down_and_out_puts_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/merton/price_delta/down_and_out_puts/merton_01__down_and_out_puts_01__01_cartesian_price_delta/dataset.yaml",
