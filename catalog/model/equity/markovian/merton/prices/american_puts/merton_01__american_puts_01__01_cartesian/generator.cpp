// Generated Merton American-put price-dataset recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/merton/prices/american_puts/"
        "merton_01__american_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/merton/prices/american_puts/"
        "merton_01__american_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/prices/"
        "american_puts/merton_01__american_puts_01__01_cartesian.json",
    ...
    const pricing::AmericanOptionProfile profile{
        ...
        true,
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_lsm, "merton", "american_option", ""},
    };
