// Generated Merton digital-calls price-dataset recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/merton/prices/digital_calls/merton_01__digital_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/merton/prices/digital_calls/merton_01__digital_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/prices/digital_calls/merton_01__digital_calls_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "merton", "digital_option", ""}).threads_per_block,
        11668827441970806784ULL,
        "exact transition dates",
        nlohmann::ordered_json::object(),
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "merton", "digital_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_merton_digital_option_cuda<OptionSide::call>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
