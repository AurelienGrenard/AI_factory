...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/merton/prices/up_one_touches/merton_01__up_one_touches_01__01.json",
        "catalog/model/equity/markovian/merton/prices/up_one_touches/merton_01__up_one_touches_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/prices/up_one_touches/merton_01__up_one_touches_01__01.json",
