...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/merton/prices/european_puts/merton_01__european_puts_01__01.json",
        "catalog/model/equity/markovian/merton/prices/european_puts/merton_01__european_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/prices/european_puts/merton_01__european_puts_01__01.json",
