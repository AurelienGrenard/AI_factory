// Generated Merton athena-autocalls price-dataset recipe.
#include "model/equity/markovian/merton/product/athena_autocall.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/merton/prices/athena_autocalls/merton_01__athena_autocalls_01__01_cartesian.json",
        "catalog/model/equity/markovian/merton/prices/athena_autocalls/merton_01__athena_autocalls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/merton/prices/athena_autocalls/merton_01__athena_autocalls_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "merton", "athena_autocall", ""}).threads_per_block,
        11668827433380872192ULL,
        "exact transition dates",
        nlohmann::ordered_json::object(),
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_exact_mc, "merton", "athena_autocall", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_merton_athena_autocall_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
