...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/black_scholes/parameters/black_scholes_01.json", "datasets/product/geometric_asian_option/geometric_asian_options_01.json", "datasets/model/equity/markovian/black_scholes/price_delta/geometric_asian_calls/black_scholes_01__geometric_asian_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/black_scholes/price_delta/geometric_asian_calls/black_scholes_01__geometric_asian_calls_01__01_cartesian_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/price_delta/geometric_asian_calls/black_scholes_01__geometric_asian_calls_01__01_cartesian_price_delta.json", "catalog/model/equity/markovian/black_scholes/prices/geometric_asian_calls/black_scholes_01__geometric_asian_calls_01__01_cartesian/recipe.yaml", "centered_closed_form", .01, 2U, PriceConstruction::CartesianProduct};
