...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/black_scholes/parameters/black_scholes_01.json", "datasets/product/double_knock_out_option/double_knock_out_options_01.json", "datasets/model/equity/markovian/black_scholes/price_delta/double_knock_out_puts/black_scholes_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/black_scholes/price_delta/double_knock_out_puts/black_scholes_01__double_knock_out_puts_01__01_price_delta/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/price_delta/double_knock_out_puts/black_scholes_01__double_knock_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/black_scholes/prices/double_knock_out_puts/black_scholes_01__double_knock_out_puts_01__01/generator.cpp", "centered_crn", .01, 2U};
