...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        ...
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/price_delta/asian_puts/black_scholes_01__asian_puts_01__01_price_delta.json", "catalog/model/equity/markovian/black_scholes/prices/asian_puts/black_scholes_01__asian_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
