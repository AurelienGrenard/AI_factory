...
int main() {
    ...
    const datasets::PriceDeltaRecipe recipe{
        "datasets/model/equity/markovian/black_scholes/parameters/black_scholes_01.json", "datasets/product/down_and_out_option/down_and_out_options_01.json", "datasets/model/equity/markovian/black_scholes/price_delta/down_and_out_puts/black_scholes_01__down_and_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/black_scholes/price_delta/down_and_out_puts/black_scholes_01__down_and_out_puts_01__01_price_delta/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/price_delta/down_and_out_puts/black_scholes_01__down_and_out_puts_01__01_price_delta.json", "catalog/model/equity/markovian/black_scholes/prices/down_and_out_puts/black_scholes_01__down_and_out_puts_01__01/recipe.yaml", "centered_crn", .01, 2U};
