...
int main() {
    ...
    try {
        const datasets::price_gradients::Recipe recipe{
            "datasets/model/equity/markovian/black_scholes/parameters/black_scholes_01.json", "datasets/product/european_option/european_options_01.json", "datasets/model/equity/markovian/black_scholes/price_gradients/european_puts/black_scholes_01__european_puts_01__01_cartesian_price_gradients.json", "catalog/model/equity/markovian/black_scholes/price_gradients/european_puts/black_scholes_01__european_puts_01__01_cartesian_price_gradients/generation.yaml", "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/price_gradients/european_puts/black_scholes_01__european_puts_01__01_cartesian_price_gradients.json", "catalog/model/equity/markovian/black_scholes/prices/european_puts/black_scholes_01__european_puts_01__01_cartesian/recipe.yaml",
        ...
        return offline::pricing::price_gradients::execute_dataset<false>(recipe,
            ...
            model::equity::black_scholes::launch_black_scholes_european_option_price_gradients_cuda<OptionSide::put>);
