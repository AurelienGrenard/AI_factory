...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/straddles/black_scholes_01__straddles_01__01.json",
        "catalog/model/equity/markovian/black_scholes/prices/straddles/black_scholes_01__straddles_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/straddles/black_scholes_01__straddles_01__01.json",
        "Black-Scholes closed-form straddles",
        PriceConstruction::Aligned,
    };
    const pricing::AnalyticalProfile profile{1.0f / 252.0f, ::ai_factory::workbench::offline::cuda_tuning::kAnalyticalThreadsPerBlock, 0U, ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "black_scholes", "straddle", ""}};
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_analytical(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    float* device_prices) {
                    model_binding::launch_black_scholes_straddle_cuda(
                        device_models,
                        model_count,
