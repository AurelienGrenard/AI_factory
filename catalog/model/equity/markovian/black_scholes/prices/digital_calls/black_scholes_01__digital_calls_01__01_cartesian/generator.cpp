// Generated Black-Scholes digital-calls analytical price recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/digital_calls/black_scholes_01__digital_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/black_scholes/prices/digital_calls/black_scholes_01__digital_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/digital_calls/black_scholes_01__digital_calls_01__01_cartesian.json",
        "Black-Scholes closed-form digital-calls",
        PriceConstruction::CartesianProduct,
    };
    const pricing::AnalyticalProfile profile{1.0f / 252.0f, ::ai_factory::workbench::offline::cuda_tuning::kAnalyticalThreadsPerBlock, 0U, ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "black_scholes", "digital_option", ""}};
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_analytical(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    float* device_prices) {
                    model_binding::launch_black_scholes_digital_option_cuda<OptionSide::call>(
                        device_models,
                        model_count,
