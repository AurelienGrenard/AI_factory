...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/forward_start_puts/black_scholes_01__forward_start_puts_01__01.json",
        "catalog/model/equity/markovian/black_scholes/prices/forward_start_puts/black_scholes_01__forward_start_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/forward_start_puts/black_scholes_01__forward_start_puts_01__01.json",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_analytical(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    float* device_prices) {
                    model_binding::launch_black_scholes_forward_start_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
