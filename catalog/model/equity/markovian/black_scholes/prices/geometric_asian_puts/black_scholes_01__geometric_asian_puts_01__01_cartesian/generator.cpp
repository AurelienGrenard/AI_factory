// Generated Black-Scholes geometric-asian-puts analytical price recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/geometric_asian_puts/black_scholes_01__geometric_asian_puts_01__01_cartesian.json",
        "Black-Scholes closed-form geometric-asian-puts",
        PriceConstruction::CartesianProduct,
    };
    const pricing::AnalyticalProfile profile{1.0f / 504.0f, ::ai_factory::workbench::offline::cuda_tuning::kAnalyticalThreadsPerBlock, 2U, ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "black_scholes", "geometric_asian_option", ""}};
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_analytical(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    float* device_prices) {
                    model_binding::launch_black_scholes_geometric_asian_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
                        products.data(),
                        device_products,
