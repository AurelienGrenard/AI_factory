...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/lookback_options/black_scholes_01__lookback_options_01__01.json",
        "catalog/model/equity/markovian/black_scholes/prices/lookback_options/black_scholes_01__lookback_options_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/lookback_options/black_scholes_01__lookback_options_01__01.json",
