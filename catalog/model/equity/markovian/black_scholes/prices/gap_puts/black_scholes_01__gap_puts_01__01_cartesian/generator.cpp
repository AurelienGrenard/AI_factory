// Generated Black-Scholes gap-puts analytical price recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/gap_puts/black_scholes_01__gap_puts_01__01_cartesian.json",
        "catalog/model/equity/markovian/black_scholes/prices/gap_puts/black_scholes_01__gap_puts_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/gap_puts/black_scholes_01__gap_puts_01__01_cartesian.json",
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_analytical(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    float* device_prices) {
                    model_binding::launch_black_scholes_gap_option_cuda<OptionSide::put>(
                        device_models,
                        model_count,
