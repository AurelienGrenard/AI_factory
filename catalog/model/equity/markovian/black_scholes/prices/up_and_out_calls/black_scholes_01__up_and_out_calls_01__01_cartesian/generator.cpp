// Generated Black-Scholes up-and-out-calls price-dataset recipe.
#include "model/equity/markovian/black_scholes/product/up_and_out_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/black_scholes/prices/up_and_out_calls/black_scholes_01__up_and_out_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/black_scholes/prices/up_and_out_calls/black_scholes_01__up_and_out_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/black_scholes/prices/up_and_out_calls/black_scholes_01__up_and_out_calls_01__01_cartesian.json",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "black_scholes", "up_and_out_option", ""}).threads_per_block,
        11668826827790483456ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "black_scholes", "up_and_out_option", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_black_scholes_up_and_out_option_cuda<OptionSide::call>(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
