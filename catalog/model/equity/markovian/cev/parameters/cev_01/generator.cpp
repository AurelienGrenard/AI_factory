...
int main() {
    ...
    write_model_dataset(
        ...
        "CEV",
        dataset,
        "catalog/model/equity/markovian/cev/parameters/cev_01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/parameters/cev_01.json",
        {
            {"spot", "Initial spot."},
