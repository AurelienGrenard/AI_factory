// Generated CEV American-call price-dataset recipe.
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/cev/prices/american_calls/"
        "cev_01__american_calls_01__01_cartesian.json",
        "catalog/model/equity/markovian/cev/prices/american_calls/"
        "cev_01__american_calls_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/prices/"
        "american_calls/cev_01__american_calls_01__01_cartesian.json",
    ...
    const pricing::AmericanOptionProfile profile{
        ...
        false,
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_lsm, "cev", "american_option", ""},
    };
