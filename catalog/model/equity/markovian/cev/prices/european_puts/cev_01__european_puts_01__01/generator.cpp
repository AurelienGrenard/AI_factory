...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/markovian/cev/prices/european_puts/cev_01__european_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/prices/european_puts/cev_01__european_puts_01__01.json",
        "absorbed Milstein",
