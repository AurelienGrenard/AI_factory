...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/cev/prices/athena_autocalls/cev_01__athena_autocalls_01__01.json",
        "catalog/model/equity/markovian/cev/prices/athena_autocalls/cev_01__athena_autocalls_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/prices/athena_autocalls/cev_01__athena_autocalls_01__01.json",
        "absorbed Milstein",
