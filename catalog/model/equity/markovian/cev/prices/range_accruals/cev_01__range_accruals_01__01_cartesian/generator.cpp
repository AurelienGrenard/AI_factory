// Generated CEV range-accruals price-dataset recipe.
#include "model/equity/markovian/cev/product/range_accrual.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/cev/prices/range_accruals/cev_01__range_accruals_01__01_cartesian.json",
        "catalog/model/equity/markovian/cev/prices/range_accruals/cev_01__range_accruals_01__01_cartesian/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/prices/range_accruals/cev_01__range_accruals_01__01_cartesian.json",
        "absorbed Milstein",
    ...
    const pricing::BatchedMonteCarloProfile profile{
        ...
        ::ai_factory::workbench::offline::cuda_tuning::pricing_profile(::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "cev", "range_accrual", ""}).threads_per_block,
        11668826956639502336ULL,
        "1 / 504",
        nlohmann::ordered_json{{"simulation_steps_per_day", simulation_steps_per_day}},
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::equity_step_mc, "cev", "range_accrual", ""},
    };
        ...
        [&](const auto& models, const auto& products,
            ...
            return pricing::execute_batched_monte_carlo(
                ...
                [&](const auto* device_models, std::size_t model_count,
                    ...
                    model_binding::launch_cev_range_accrual_cuda(
                        device_models,
                        model_count,
                        host_products,
                        device_products,
