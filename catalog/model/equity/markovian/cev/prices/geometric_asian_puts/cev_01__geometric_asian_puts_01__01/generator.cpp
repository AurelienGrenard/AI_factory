...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/markovian/cev/prices/geometric_asian_puts/cev_01__geometric_asian_puts_01__01.json",
        "catalog/model/equity/markovian/cev/prices/geometric_asian_puts/cev_01__geometric_asian_puts_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/markovian/cev/prices/geometric_asian_puts/cev_01__geometric_asian_puts_01__01.json",
        "absorbed Milstein",
