...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/normal_inverse_gaussian/prices/european_puts/normal_inverse_gaussian_01__european_puts_01__01.json",
        "catalog/model/equity/normal_inverse_gaussian/prices/european_puts/normal_inverse_gaussian_01__european_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/normal_inverse_gaussian/prices/european_puts/normal_inverse_gaussian_01__european_puts_01__01.json",
