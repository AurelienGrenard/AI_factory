...
const std::filesystem::path dataset_path =
    "datasets/model/equity/normal_inverse_gaussian/prices/asset_or_nothing_calls/"
    "normal_inverse_gaussian_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/normal_inverse_gaussian/prices/asset_or_nothing_calls/"
    "normal_inverse_gaussian_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/normal_inverse_gaussian/prices/"
