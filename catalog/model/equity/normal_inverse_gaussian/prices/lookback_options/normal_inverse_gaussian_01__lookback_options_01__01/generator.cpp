...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/normal_inverse_gaussian/prices/lookback_options/normal_inverse_gaussian_01__lookback_options_01__01.json",
        "catalog/model/equity/normal_inverse_gaussian/prices/lookback_options/normal_inverse_gaussian_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/LookbackOption/normal_inverse_gaussian_01__lookback_options_01__01.json",
