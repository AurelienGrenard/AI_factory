...
const std::filesystem::path dataset_path =
    "datasets/model/equity/normal_inverse_gaussian/prices/down_and_in_puts/"
    "normal_inverse_gaussian_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/normal_inverse_gaussian/prices/down_and_in_puts/"
    "normal_inverse_gaussian_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/normal_inverse_gaussian/prices/down_and_in_puts/"
    "normal_inverse_gaussian_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    const std::vector<normal_inverse_gaussian::ModelParameters> models =
    ...
    normal_inverse_gaussian::ModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(normal_inverse_gaussian::ModelParameters)
            ),
