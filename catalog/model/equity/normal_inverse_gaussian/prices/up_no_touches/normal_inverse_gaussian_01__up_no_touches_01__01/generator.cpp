...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/normal_inverse_gaussian/prices/up_no_touches/normal_inverse_gaussian_01__up_no_touches_01__01.json",
        "catalog/model/equity/normal_inverse_gaussian/prices/up_no_touches/normal_inverse_gaussian_01__up_no_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/UpNoTouch/normal_inverse_gaussian_01__up_no_touches_01__01.json",
