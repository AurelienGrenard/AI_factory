...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/normal_inverse_gaussian/prices/up_one_touches/normal_inverse_gaussian_01__up_one_touches_01__01.json",
        "catalog/model/equity/normal_inverse_gaussian/prices/up_one_touches/normal_inverse_gaussian_01__up_one_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/UpOneTouch/normal_inverse_gaussian_01__up_one_touches_01__01.json",
