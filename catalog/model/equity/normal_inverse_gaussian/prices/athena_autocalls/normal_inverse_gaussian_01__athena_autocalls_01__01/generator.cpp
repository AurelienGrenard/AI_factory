...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/normal_inverse_gaussian/prices/athena_autocalls/normal_inverse_gaussian_01__athena_autocalls_01__01.json",
        "catalog/model/equity/normal_inverse_gaussian/prices/athena_autocalls/normal_inverse_gaussian_01__athena_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/NormalInverseGaussian/AthenaAutocall/normal_inverse_gaussian_01__athena_autocalls_01__01.json",
