// Build one CEV European-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/european_calls/"
    "cev_01__european_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/european_calls/"
    "cev_01__european_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/EuropeanCall/"
    "cev_01__european_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        cev::launch_cev_european_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
