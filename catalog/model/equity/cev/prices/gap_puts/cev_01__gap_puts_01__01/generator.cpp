...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/gap_puts/cev_01__gap_puts_01__01.json",
        "catalog/model/equity/cev/prices/gap_puts/cev_01__gap_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/cev/prices/gap_puts/cev_01__gap_puts_01__01.json",
        "absorbed Milstein",
