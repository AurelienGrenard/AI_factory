...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/up_one_touches/cev_01__up_one_touches_01__01.json",
        "catalog/model/equity/cev/prices/up_one_touches/cev_01__up_one_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/UpOneTouch/cev_01__up_one_touches_01__01.json",
        "absorbed Milstein",
