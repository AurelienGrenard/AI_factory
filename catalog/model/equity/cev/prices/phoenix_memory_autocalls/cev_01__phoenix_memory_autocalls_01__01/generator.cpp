// Build one CEV Phoenix-Memory-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/phoenix_memory_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/phoenix_memory_autocalls/"
    "cev_01__phoenix_memory_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/phoenix_memory_autocalls/"
    "cev_01__phoenix_memory_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/PhoenixMemoryAutocall/"
    "cev_01__phoenix_memory_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV Phoenix Memory autocall standard errors"
        );
        ...
        cev::launch_cev_phoenix_memory_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Phoenix Memory autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Phoenix Memory autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV Phoenix Memory autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Phoenix Memory autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Phoenix Memory autocall standard errors"
    );
