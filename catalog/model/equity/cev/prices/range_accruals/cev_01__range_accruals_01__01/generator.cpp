...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/range_accruals/"
    "cev_01__range_accruals_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/range_accruals/"
    "cev_01__range_accruals_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/RangeAccrual/"
    "cev_01__range_accruals_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Range Accrual prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV Range Accrual standard errors"
        );
        ...
        cev::launch_cev_range_accrual_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Range Accrual warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Range Accrual prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV Range Accrual standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Range Accrual prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Range Accrual standard errors"
    );
