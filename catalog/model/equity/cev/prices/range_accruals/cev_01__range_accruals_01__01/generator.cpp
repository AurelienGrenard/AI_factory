...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/range_accruals/cev_01__range_accruals_01__01.json",
        "catalog/model/equity/cev/prices/range_accruals/cev_01__range_accruals_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/RangeAccrual/cev_01__range_accruals_01__01.json",
        "absorbed Milstein",
