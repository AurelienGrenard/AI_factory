...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/double_knock_out_calls/cev_01__double_knock_out_calls_01__01.json",
        "catalog/model/equity/cev/prices/double_knock_out_calls/cev_01__double_knock_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/DoubleKnockOutCall/cev_01__double_knock_out_calls_01__01.json",
        "absorbed Milstein",
