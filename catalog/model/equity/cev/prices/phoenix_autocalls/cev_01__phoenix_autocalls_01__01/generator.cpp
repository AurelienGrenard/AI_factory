...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/phoenix_autocalls/cev_01__phoenix_autocalls_01__01.json",
        "catalog/model/equity/cev/prices/phoenix_autocalls/cev_01__phoenix_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/PhoenixAutocall/cev_01__phoenix_autocalls_01__01.json",
        "absorbed Milstein",
