// Build one CEV Phoenix-autocall price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/phoenix_autocall.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/phoenix_autocalls/"
    "cev_01__phoenix_autocalls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/phoenix_autocalls/"
    "cev_01__phoenix_autocalls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/PhoenixAutocall/"
    "cev_01__phoenix_autocalls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Phoenix autocall prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV Phoenix autocall standard errors"
        );
        ...
        cev::launch_cev_phoenix_autocall_cuda(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Phoenix autocall warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Phoenix autocall prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV Phoenix autocall standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Phoenix autocall prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Phoenix autocall standard errors"
    );
