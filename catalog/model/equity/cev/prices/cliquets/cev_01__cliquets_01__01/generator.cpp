// Build one CEV Cliquet price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/cliquet.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/cliquets/"
    "cev_01__cliquets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/cliquets/"
    "cev_01__cliquets_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/Cliquet/"
    "cev_01__cliquets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Cliquet standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Cliquet warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Cliquet standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Cliquet prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Cliquet standard errors"
    );
