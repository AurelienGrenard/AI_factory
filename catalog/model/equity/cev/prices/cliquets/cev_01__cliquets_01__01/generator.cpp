...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/cliquets/cev_01__cliquets_01__01.json",
        "catalog/model/equity/cev/prices/cliquets/cev_01__cliquets_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/Cliquet/cev_01__cliquets_01__01.json",
        "absorbed Milstein",
