...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/up_and_out_calls/cev_01__up_and_out_calls_01__01.json",
        "catalog/model/equity/cev/prices/up_and_out_calls/cev_01__up_and_out_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/UpAndOutCall/cev_01__up_and_out_calls_01__01.json",
        "absorbed Milstein",
