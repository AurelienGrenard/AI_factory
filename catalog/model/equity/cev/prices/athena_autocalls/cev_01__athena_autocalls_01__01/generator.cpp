...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/athena_autocalls/cev_01__athena_autocalls_01__01.json",
        "catalog/model/equity/cev/prices/athena_autocalls/cev_01__athena_autocalls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/AthenaAutocall/cev_01__athena_autocalls_01__01.json",
        "absorbed Milstein",
