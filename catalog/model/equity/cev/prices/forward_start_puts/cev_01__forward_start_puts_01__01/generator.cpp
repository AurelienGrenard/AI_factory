// Build one CEV Forward-start-put price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/forward_start_puts/"
    "cev_01__forward_start_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/forward_start_puts/"
    "cev_01__forward_start_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/forward_start_puts/"
    "cev_01__forward_start_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        cev::launch_cev_forward_start_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
