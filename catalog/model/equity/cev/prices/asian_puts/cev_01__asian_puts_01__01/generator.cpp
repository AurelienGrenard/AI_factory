...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/asian_puts/"
    "cev_01__asian_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/asian_puts/"
    "cev_01__asian_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/asian_puts/"
    "cev_01__asian_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Asian put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV Asian put standard errors"
        );
        ...
        cev::launch_cev_asian_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Asian put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Asian put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV Asian put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Asian put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Asian put standard errors"
    );
