// Build one CEV gap-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/gap_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/gap_calls/"
    "cev_01__gap_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/gap_calls/"
    "cev_01__gap_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/gap_calls/"
    "cev_01__gap_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV gap call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV gap call standard errors"
        );
        ...
        cev::launch_cev_gap_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV gap call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV gap call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV gap call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV gap call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV gap call standard errors"
    );
