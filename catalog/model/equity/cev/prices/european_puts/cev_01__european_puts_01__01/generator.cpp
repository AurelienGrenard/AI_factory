...
#include "model/equity/markovian/cev/european_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "catalog/model/equity/cev/prices/european_puts/cev_01__european_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/cev/prices/european_puts/cev_01__european_puts_01__01.json",
        "absorbed Milstein",
