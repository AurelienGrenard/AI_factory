...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/lookback_options/cev_01__lookback_options_01__01.json",
        "catalog/model/equity/cev/prices/lookback_options/cev_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/LookbackOption/cev_01__lookback_options_01__01.json",
        "absorbed Milstein",
