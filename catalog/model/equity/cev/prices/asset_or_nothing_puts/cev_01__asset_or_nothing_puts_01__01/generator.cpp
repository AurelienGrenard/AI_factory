...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/asset_or_nothing_puts/"
    "cev_01__asset_or_nothing_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/asset_or_nothing_puts/"
    "cev_01__asset_or_nothing_puts_01__01/dataset.yaml";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV asset-or-nothing put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV asset-or-nothing put standard errors"
        );
        ...
        cev::launch_cev_asset_or_nothing_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV asset-or-nothing put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV asset-or-nothing put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV asset-or-nothing put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV asset-or-nothing put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV asset-or-nothing put standard errors"
    );
