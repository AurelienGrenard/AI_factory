...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/down_and_in_puts/cev_01__down_and_in_puts_01__01.json",
        "catalog/model/equity/cev/prices/down_and_in_puts/cev_01__down_and_in_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/cev/prices/down_and_in_puts/cev_01__down_and_in_puts_01__01.json",
        "absorbed Milstein",
