// Build one CEV Down-and-in-put price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/down_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/down_and_in_puts/"
    "cev_01__down_and_in_puts_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV down-and-in put prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV down-and-in put standard errors"
        );
        ...
        cev::launch_cev_down_and_in_option_cuda<OptionSide::put>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV down-and-in put warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV down-and-in put prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV down-and-in put standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV down-and-in put prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV down-and-in put standard errors"
    );
