// Build one CEV Forward-start-call price dataset from JSON inputs.
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/forward_start_calls/"
    "cev_01__forward_start_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/forward_start_calls/"
    "cev_01__forward_start_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/ForwardStartCall/"
    "cev_01__forward_start_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV call standard errors"
        );
        ...
        cev::launch_cev_forward_start_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV call standard errors"
    );
