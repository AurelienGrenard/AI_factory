...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/cev/prices/forward_start_calls/cev_01__forward_start_calls_01__01.json",
        "catalog/model/equity/cev/prices/forward_start_calls/cev_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/ForwardStartCall/cev_01__forward_start_calls_01__01.json",
        "absorbed Milstein",
