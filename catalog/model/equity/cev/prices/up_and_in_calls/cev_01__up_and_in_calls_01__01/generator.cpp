// Build one CEV Up-and-in-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/up_and_in_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/up_and_in_calls/"
    "cev_01__up_and_in_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/up_and_in_calls/"
    "cev_01__up_and_in_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/UpAndInCall/"
    "cev_01__up_and_in_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV up-and-in call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV up-and-in call standard errors"
        );
        ...
        cev::launch_cev_up_and_in_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV up-and-in call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV up-and-in call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV up-and-in call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV up-and-in call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV up-and-in call standard errors"
    );
