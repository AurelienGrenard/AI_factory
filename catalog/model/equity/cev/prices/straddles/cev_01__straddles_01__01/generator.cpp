// Build one CEV straddle price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/straddle.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/straddles/"
    "cev_01__straddles_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/straddles/"
    "cev_01__straddles_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/straddles/"
    "cev_01__straddles_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV straddle prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV straddle standard errors"
        );
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV straddle warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV straddle prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV straddle standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV straddle prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV straddle standard errors"
    );
