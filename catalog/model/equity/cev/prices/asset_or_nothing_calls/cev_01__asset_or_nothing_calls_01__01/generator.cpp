// Build one CEV asset-or-nothing price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/asset_or_nothing_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/asset_or_nothing_calls/"
    "cev_01__asset_or_nothing_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/asset_or_nothing_calls/"
    "cev_01__asset_or_nothing_calls_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/cev/prices/"
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CEV asset-or-nothing call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV asset-or-nothing call standard errors"
        );
        ...
        cev::launch_cev_asset_or_nothing_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV asset-or-nothing call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV asset-or-nothing call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV asset-or-nothing call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV asset-or-nothing call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV asset-or-nothing call standard errors"
    );
