// Build one CEV Geometric-Asian-call price dataset from JSON inputs.
#include "common/check_cuda.cuh"
#include "model/equity/cev/geometric_asian_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/equity/cev/prices/geometric_asian_calls/"
    "cev_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/cev/prices/geometric_asian_calls/"
    "cev_01__geometric_asian_calls_01__01/dataset.yaml";
const std::string url =
    "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/CEV/GeometricAsianCall/"
    "cev_01__geometric_asian_calls_01__01.json";
...
int main() {
    ...
    cev::ModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(cev::ModelParameters)
            ),
        ...
        check_cuda(
            ...
            "cudaMalloc CEV Geometric Asian call prices"
        );
        check_cuda(
            cudaMalloc(
            ...
            "cudaMalloc CEV Geometric Asian call standard errors"
        );
        ...
        cev::launch_cev_geometric_asian_option_cuda<OptionSide::call>(
            device_models,
            warmup_row_count,
            device_products,
            warmup_row_count,
        ...
        check_cuda(cudaDeviceSynchronize(), "CEV Geometric Asian call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CEV Geometric Asian call prices"
        );
        check_cuda(
            cudaMemcpy(
            ...
            "cudaMemcpy CEV Geometric Asian call standard errors"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CEV Geometric Asian call prices");
    check_cuda(
        cudaFree(device_standard_errors),
        "cudaFree CEV Geometric Asian call standard errors"
    );
