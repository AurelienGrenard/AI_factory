...
#include "model/equity/markovian/stein_stein/forward_start_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/stein_stein/prices/forward_start_calls/stein_stein_01__forward_start_calls_01__01.json",
        "catalog/model/equity/stein_stein/prices/forward_start_calls/stein_stein_01__forward_start_calls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/stein_stein/prices/forward_start_calls/stein_stein_01__forward_start_calls_01__01.json",
