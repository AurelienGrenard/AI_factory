...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/stein_stein/prices/up_no_touches/stein_stein_01__up_no_touches_01__01.json",
        "catalog/model/equity/stein_stein/prices/up_no_touches/stein_stein_01__up_no_touches_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/stein_stein/prices/up_no_touches/stein_stein_01__up_no_touches_01__01.json",
