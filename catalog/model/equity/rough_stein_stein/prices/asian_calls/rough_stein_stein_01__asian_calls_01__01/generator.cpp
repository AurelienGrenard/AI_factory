...
#include "model/equity/rough/rough_stein_stein/asian_option.cuh"
...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_stein_stein/prices/asian_calls/rough_stein_stein_01__asian_calls_01__01.json",
        "catalog/model/equity/rough_stein_stein/prices/asian_calls/rough_stein_stein_01__asian_calls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_stein_stein/prices/asian_calls/rough_stein_stein_01__asian_calls_01__01.json",
