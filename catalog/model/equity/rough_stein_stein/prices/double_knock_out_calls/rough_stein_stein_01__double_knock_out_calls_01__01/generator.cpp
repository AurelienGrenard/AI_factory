...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_stein_stein/prices/double_knock_out_calls/rough_stein_stein_01__double_knock_out_calls_01__01.json",
        "catalog/model/equity/rough_stein_stein/prices/double_knock_out_calls/rough_stein_stein_01__double_knock_out_calls_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_stein_stein/prices/double_knock_out_calls/rough_stein_stein_01__double_knock_out_calls_01__01.json",
