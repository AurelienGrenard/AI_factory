...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/rough_stein_stein/prices/down_and_in_puts/rough_stein_stein_01__down_and_in_puts_01__01.json",
        "catalog/model/equity/rough_stein_stein/prices/down_and_in_puts/rough_stein_stein_01__down_and_in_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_stein_stein/prices/down_and_in_puts/rough_stein_stein_01__down_and_in_puts_01__01.json",
