...
int main() {
    ...
    write_model_dataset(
        ...
        "catalog/model/equity/rough_stein_stein/parameters/rough_stein_stein_01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/rough_stein_stein/parameters/rough_stein_stein_01.json",
        {
