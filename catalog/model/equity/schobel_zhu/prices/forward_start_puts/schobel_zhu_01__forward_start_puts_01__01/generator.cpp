...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/schobel_zhu/prices/forward_start_puts/schobel_zhu_01__forward_start_puts_01__01.json",
        "catalog/model/equity/schobel_zhu/prices/forward_start_puts/schobel_zhu_01__forward_start_puts_01__01/dataset.yaml",
        "https://datasets.ai-factory.example/v1/model/equity/schobel_zhu/prices/forward_start_puts/schobel_zhu_01__forward_start_puts_01__01.json",
