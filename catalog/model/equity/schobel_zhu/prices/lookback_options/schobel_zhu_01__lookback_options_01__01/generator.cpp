...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/schobel_zhu/prices/lookback_options/schobel_zhu_01__lookback_options_01__01.json",
        "catalog/model/equity/schobel_zhu/prices/lookback_options/schobel_zhu_01__lookback_options_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/LookbackOption/schobel_zhu_01__lookback_options_01__01.json",
