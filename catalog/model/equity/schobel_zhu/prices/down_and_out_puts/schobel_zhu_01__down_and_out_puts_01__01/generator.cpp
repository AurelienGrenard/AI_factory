...
const std::filesystem::path dataset_path =
    "datasets/model/equity/schobel_zhu/prices/down_and_out_puts/"
    "schobel_zhu_01__down_and_out_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/schobel_zhu/prices/down_and_out_puts/"
    "schobel_zhu_01__down_and_out_puts_01__01/dataset.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/equity/schobel_zhu/prices/down_and_out_puts/"
    "schobel_zhu_01__down_and_out_puts_01__01.json";
