...
const std::filesystem::path dataset_path =
    "datasets/model/equity/schobel_zhu/prices/geometric_asian_calls/"
    "schobel_zhu_01__geometric_asian_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/equity/schobel_zhu/prices/geometric_asian_calls/"
...
int main() {
    ...
    const std::vector<schobel_zhu::ModelParameters> models =
    ...
    schobel_zhu::ModelParameters* device_models = nullptr;
    ...
    try {
        ...
        check_cuda(
            cudaMalloc(
                &device_models,
                models.size() * sizeof(schobel_zhu::ModelParameters)
            ),
