...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/schobel_zhu/prices/forward_start_calls/schobel_zhu_01__forward_start_calls_01__01.json",
        "catalog/model/equity/schobel_zhu/prices/forward_start_calls/schobel_zhu_01__forward_start_calls_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/ForwardStartCall/schobel_zhu_01__forward_start_calls_01__01.json",
