...
int main() {
    ...
    const pricing::EquityPriceRecipe recipe{
        ...
        "datasets/model/equity/schobel_zhu/prices/up_one_touches/schobel_zhu_01__up_one_touches_01__01.json",
        "catalog/model/equity/schobel_zhu/prices/up_one_touches/schobel_zhu_01__up_one_touches_01__01/dataset.yaml",
        "https://mlp.lpma.math.upmc.fr/DataCarlo/Assets/SchobelZhu/UpOneTouch/schobel_zhu_01__up_one_touches_01__01.json",
