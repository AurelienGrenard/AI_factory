// Generated Build one CIR zero-coupon bond put price dataset.
...
const std::filesystem::path dataset_path =
    ...
    "cir_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir/prices/zero_coupon_bond_puts/"
    "cir_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
