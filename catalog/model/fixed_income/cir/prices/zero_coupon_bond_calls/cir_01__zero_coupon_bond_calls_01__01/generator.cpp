...
const std::filesystem::path dataset_path =
    ...
    "cir_01__zero_coupon_bond_calls_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(
            ...
            "cudaMalloc CIR zero-coupon bond call prices"
        );
        check_cuda(
            cudaMemcpy(
                device_models,
        ...
        check_cuda(cudaDeviceSynchronize(), "CIR ZCB call warmup");
        ...
        check_cuda(
            ...
            "cudaMemcpy CIR zero-coupon bond call prices"
        );
    } catch (...) {
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CIR ZCB call prices");
