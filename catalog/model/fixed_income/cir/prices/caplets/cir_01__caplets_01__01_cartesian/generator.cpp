// Generated Build one CIR caplet price dataset.
...
const std::filesystem::path dataset_path =
    ...
    "cir_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir/prices/caplets/"
    "cir_01__caplets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "cir", "rate_option", ""}, result_count, 0U
    );
