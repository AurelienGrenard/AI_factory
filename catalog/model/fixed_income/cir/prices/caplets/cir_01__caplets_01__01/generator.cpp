...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir/prices/caplets/"
    "cir_01__caplets_01__01.json";
...
const std::string url =
    ...
    "fixed_income/cir/prices/caplets/"
    "cir_01__caplets_01__01.json";
...
int main() {
    ...
    try {
        ...
        check_cuda(cudaDeviceSynchronize(), "CIR caplet warmup");
    ...
    check_cuda(cudaFree(device_prices), "cudaFree CIR caplet prices");
