// Generated Build one G2 zero-coupon bond call price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/g2/prices/zero_coupon_bond_calls/"
    "g2_01__zero_coupon_bond_calls_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/g2/prices/zero_coupon_bond_calls/"
    "g2_01__zero_coupon_bond_calls_01__01_cartesian/generation.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/"
    "fixed_income/g2/prices/zero_coupon_bond_calls/"
    "g2_01__zero_coupon_bond_calls_01__01_cartesian.json";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "g2", "zero_coupon_bond_option", ""}, result_count, 0U
    );
