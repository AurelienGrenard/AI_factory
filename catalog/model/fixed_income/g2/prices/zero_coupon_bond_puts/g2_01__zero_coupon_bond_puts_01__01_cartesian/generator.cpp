...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/g2/prices/zero_coupon_bond_puts/"
    "g2_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/g2/prices/zero_coupon_bond_puts/"
    "g2_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/"
    "fixed_income/g2/prices/zero_coupon_bond_puts/"
    "g2_01__zero_coupon_bond_puts_01__01_cartesian.json";
