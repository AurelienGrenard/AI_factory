// Generated Build one G2++ Nelson-Siegel caplet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/g2_plus_plus/prices/nelson_siegel/caplets/"
    "g2_plus_plus_01__nelson_siegel_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/g2_plus_plus/prices/nelson_siegel/caplets/"
    "g2_plus_plus_01__nelson_siegel_01__caplets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_g2_plus_plus_nelson_siegel_rate_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
