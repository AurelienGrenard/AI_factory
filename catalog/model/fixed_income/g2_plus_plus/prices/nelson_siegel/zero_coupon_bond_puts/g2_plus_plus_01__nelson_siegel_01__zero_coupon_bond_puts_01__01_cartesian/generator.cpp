// Generated Build one G2++ Nelson-Siegel zero-coupon bond put dataset.
#include "model/fixed_income/g2_plus_plus/product/nelson_siegel/zero_coupon_bond_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/g2_plus_plus/prices/nelson_siegel/zero_coupon_bond_puts/"
    "g2_plus_plus_01__nelson_siegel_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/g2_plus_plus/prices/nelson_siegel/zero_coupon_bond_puts/"
    "g2_plus_plus_01__nelson_siegel_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
...
const std::string numerical_method =
    "G2++ closed-form zero-coupon bond put";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "g2_plus_plus", "zero_coupon_bond_option", "nelson_siegel"}, result_count, 0U
    );
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_g2_plus_plus_nelson_siegel_zero_coupon_bond_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
