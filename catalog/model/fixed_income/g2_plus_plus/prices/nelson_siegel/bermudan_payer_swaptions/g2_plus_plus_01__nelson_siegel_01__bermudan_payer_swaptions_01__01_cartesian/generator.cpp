// Generated G2++/Nelson-Siegel Bermudan-payer-swaption price recipe.
...
int main() {
    ...
    constexpr std::uint64_t seed = 11668829074058379264ULL;
    auto configuration = datasets::make_fitted_bermudan_swaption_generation_configuration(
        "g2_plus_plus", "nelson_siegel", "payer", paths, seed,
