// Generated Svensson-fitted G2++ European receiver swaption MC recipe.
...
int main() {
    ...
    const datasets::EuropeanSwaptionMonteCarloRecipe recipe{
        ...
        "datasets/model/fixed_income/g2_plus_plus/prices/svensson/european_receiver_swaptions/g2_plus_plus_01__svensson_01__european_receiver_swaptions_01__01.json",
        "catalog/model/fixed_income/g2_plus_plus/prices/svensson/european_receiver_swaptions/g2_plus_plus_01__svensson_01__european_receiver_swaptions_01__01/generation.yaml",
        "https://datasets.ai-factory.example/v1/model/fixed_income/g2_plus_plus/prices/svensson/european_receiver_swaptions/g2_plus_plus_01__svensson_01__european_receiver_swaptions_01__01.json",
    ...
    datasets::generate_european_swaption_monte_carlo_prices(
        ...
        [&](auto& execution, std::size_t offset, std::size_t batch, std::size_t paths,
            ...
            rates::svensson::launch_g2_plus_plus_svensson_european_swaption_cuda<SwaptionSide::receiver>(
