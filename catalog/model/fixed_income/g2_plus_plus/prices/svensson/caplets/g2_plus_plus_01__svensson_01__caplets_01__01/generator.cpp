// Generated Build one G2++ Svensson caplet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/g2_plus_plus/prices/svensson/caplets/"
    "g2_plus_plus_01__svensson_01__caplets_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/g2_plus_plus/prices/svensson/caplets/"
    "g2_plus_plus_01__svensson_01__caplets_01__01/generation.yaml";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "g2_plus_plus", "rate_option", "svensson"}, result_count, 0U
    );
