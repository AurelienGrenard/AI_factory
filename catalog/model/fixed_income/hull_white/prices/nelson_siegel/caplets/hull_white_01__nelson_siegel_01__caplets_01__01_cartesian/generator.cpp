// Generated Build one Hull-White Nelson-Siegel caplet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/hull_white/prices/nelson_siegel/caplets/"
    "hull_white_01__nelson_siegel_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/hull_white/prices/nelson_siegel/caplets/"
    "hull_white_01__nelson_siegel_01__caplets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_hull_white_nelson_siegel_rate_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
