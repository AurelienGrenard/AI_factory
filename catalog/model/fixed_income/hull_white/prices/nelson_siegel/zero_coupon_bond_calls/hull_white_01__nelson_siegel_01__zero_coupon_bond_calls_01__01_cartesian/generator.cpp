// Generated Build one Hull-White Nelson-Siegel zero-coupon bond call dataset.
#include "model/fixed_income/hull_white/product/nelson_siegel/zero_coupon_bond_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/hull_white/prices/nelson_siegel/zero_coupon_bond_calls/"
    "hull_white_01__nelson_siegel_01__zero_coupon_bond_calls_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/hull_white/prices/nelson_siegel/zero_coupon_bond_calls/"
    "hull_white_01__nelson_siegel_01__zero_coupon_bond_calls_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const std::vector<hw::ModelParameters> models =
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "hull_white", "zero_coupon_bond_option", "nelson_siegel"}, result_count, 0U
    );
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_hull_white_nelson_siegel_zero_coupon_bond_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
