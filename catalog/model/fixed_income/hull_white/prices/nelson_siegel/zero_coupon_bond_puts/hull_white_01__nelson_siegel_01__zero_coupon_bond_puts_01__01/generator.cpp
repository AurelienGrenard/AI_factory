// Generated Build one Hull-White Nelson-Siegel zero-coupon bond put dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/hull_white/prices/nelson_siegel/zero_coupon_bond_puts/"
    "hull_white_01__nelson_siegel_01__zero_coupon_bond_puts_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/hull_white/prices/nelson_siegel/zero_coupon_bond_puts/"
    "hull_white_01__nelson_siegel_01__zero_coupon_bond_puts_01__01/generation.yaml";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_hull_white_nelson_siegel_zero_coupon_bond_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
