...
int main() {
    ...
    datasets::generate_regular_european_swaption_prices(
        ...
        "hull_white_01__nelson_siegel_01__european_payer_swaptions_01__01_cartesian.json",
        "catalog/model/fixed_income/hull_white/prices/nelson_siegel/"
        "european_payer_swaptions/"
        "hull_white_01__nelson_siegel_01__european_payer_swaptions_01__01_cartesian/"
        "generation.yaml",
