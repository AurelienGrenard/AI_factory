...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/hull_white/prices/svensson/caplets/"
    "hull_white_01__svensson_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/hull_white/prices/svensson/caplets/"
    "hull_white_01__svensson_01__caplets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_hull_white_svensson_rate_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
