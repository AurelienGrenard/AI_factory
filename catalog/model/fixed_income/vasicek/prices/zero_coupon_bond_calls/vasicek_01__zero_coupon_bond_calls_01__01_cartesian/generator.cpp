// Generated Build one Vasicek zero-coupon bond call price dataset.
...
const std::filesystem::path dataset_path =
    ...
    "vasicek_01__zero_coupon_bond_calls_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/vasicek/prices/zero_coupon_bond_calls/"
    "vasicek_01__zero_coupon_bond_calls_01__01_cartesian/generation.yaml";
