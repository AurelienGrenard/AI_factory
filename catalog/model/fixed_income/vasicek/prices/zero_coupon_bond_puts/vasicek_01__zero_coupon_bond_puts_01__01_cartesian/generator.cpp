// Generated Build one Vasicek zero-coupon bond put price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/vasicek/prices/zero_coupon_bond_puts/"
    "vasicek_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/vasicek/prices/zero_coupon_bond_puts/"
    "vasicek_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/"
    "fixed_income/vasicek/prices/zero_coupon_bond_puts/"
    "vasicek_01__zero_coupon_bond_puts_01__01_cartesian.json";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "vasicek", "zero_coupon_bond_option", ""}, result_count, 0U
    );
