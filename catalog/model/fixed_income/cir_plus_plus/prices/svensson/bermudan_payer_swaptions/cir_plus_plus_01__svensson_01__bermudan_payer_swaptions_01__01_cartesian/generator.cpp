...
int main() {
    ...
    constexpr std::uint64_t seed = 11668829194317463552ULL;
    auto configuration = datasets::make_fitted_bermudan_swaption_generation_configuration(
        "cir_plus_plus", "svensson", "payer", paths, seed,
    ...
    datasets::generate_exact_fitted_bermudan_swaption_prices(
        ...
        &fitted::launch_cir_plus_plus_svensson_bermudan_swaption_cuda<SwaptionSide::payer>,
        configuration
    );
}
