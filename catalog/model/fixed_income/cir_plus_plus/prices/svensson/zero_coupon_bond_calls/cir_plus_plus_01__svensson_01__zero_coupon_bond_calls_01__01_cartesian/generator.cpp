// Generated Build one CIR++ Svensson zero-coupon bond call dataset.
#include "model/fixed_income/cir_plus_plus/product/svensson/zero_coupon_bond_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/svensson/zero_coupon_bond_calls/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_calls_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/svensson/zero_coupon_bond_calls/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_calls_01__01_cartesian/generation.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/fixed_income/cir_plus_plus/prices/"
    "svensson/zero_coupon_bond_calls/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_calls_01__01_cartesian.json";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "cir_plus_plus", "zero_coupon_bond_option", "svensson"}, result_count, 0U
    );
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_svensson_zero_coupon_bond_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
