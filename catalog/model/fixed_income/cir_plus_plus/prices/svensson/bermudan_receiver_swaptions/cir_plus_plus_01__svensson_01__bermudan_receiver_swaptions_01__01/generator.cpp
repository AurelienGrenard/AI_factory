// Generated fitted CIR++ Svensson Bermudan swaption recipe.
...
int main() {
    ...
    const std::filesystem::path curve_path = "datasets/curve/svensson/svensson_01.json";
    ...
    constexpr std::uint64_t seed = 11668829198612430848ULL;
    auto configuration = datasets::make_fitted_bermudan_swaption_generation_configuration(
        "cir_plus_plus", "svensson", "receiver", paths, seed,
    ...
    datasets::generate_exact_fitted_bermudan_swaption_prices(
        ...
        &fitted::launch_cir_plus_plus_svensson_bermudan_swaption_cuda<SwaptionSide::receiver>,
        configuration
    );
}
