// Generated Build one CIR++ Svensson floorlet price dataset.
#include "model/fixed_income/cir_plus_plus/product/svensson/rate_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/svensson/floorlets/"
    "cir_plus_plus_01__svensson_01__floorlets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/svensson/floorlets/"
    "cir_plus_plus_01__svensson_01__floorlets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "cir_plus_plus", "rate_option", "svensson"}, result_count, 0U
    );
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_svensson_rate_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
