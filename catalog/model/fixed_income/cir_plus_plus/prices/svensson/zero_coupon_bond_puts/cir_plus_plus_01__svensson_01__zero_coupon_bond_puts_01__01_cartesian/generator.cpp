// Generated Build one CIR++ Svensson zero-coupon bond put dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/svensson/zero_coupon_bond_puts/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/svensson/zero_coupon_bond_puts/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
const std::string url =
    "https://datasets.ai-factory.example/v1/model/fixed_income/cir_plus_plus/prices/"
    "svensson/zero_coupon_bond_puts/"
    "cir_plus_plus_01__svensson_01__zero_coupon_bond_puts_01__01_cartesian.json";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_svensson_zero_coupon_bond_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
