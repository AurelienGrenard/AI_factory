// Generated Build one CIR++ Nelson-Siegel zero-coupon bond put dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/nelson_siegel/zero_coupon_bond_puts/"
    "cir_plus_plus_01__nelson_siegel_01__zero_coupon_bond_puts_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/nelson_siegel/zero_coupon_bond_puts/"
    "cir_plus_plus_01__nelson_siegel_01__zero_coupon_bond_puts_01__01_cartesian/generation.yaml";
...
const std::string numerical_method =
    "CIR++ closed-form zero-coupon bond put";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_nelson_siegel_zero_coupon_bond_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
