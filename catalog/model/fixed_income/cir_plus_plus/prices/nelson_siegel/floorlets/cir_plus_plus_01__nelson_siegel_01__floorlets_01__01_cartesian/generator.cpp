// Generated Build one CIR++ Nelson-Siegel floorlet price dataset.
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/nelson_siegel/floorlets/"
    "cir_plus_plus_01__nelson_siegel_01__floorlets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/nelson_siegel/floorlets/"
    "cir_plus_plus_01__nelson_siegel_01__floorlets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_nelson_siegel_rate_option_cuda<OptionSide::put>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
