// Generated Build one CIR++ Nelson-Siegel caplet price dataset.
#include "model/fixed_income/cir_plus_plus/product/nelson_siegel/rate_option.cuh"
...
const std::filesystem::path dataset_path =
    "datasets/model/fixed_income/cir_plus_plus/prices/nelson_siegel/caplets/"
    "cir_plus_plus_01__nelson_siegel_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/nelson_siegel/caplets/"
    "cir_plus_plus_01__nelson_siegel_01__caplets_01__01_cartesian/generation.yaml";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "cir_plus_plus", "rate_option", "nelson_siegel"}, result_count, 0U
    );
    ...
    const auto run = offline::cuda::run_analytical(
        ...
        fitted::launch_cir_plus_plus_nelson_siegel_rate_option_cuda<OptionSide::call>(
            device_models,
            warmup_count,
            device_curves,
            warmup_count,
