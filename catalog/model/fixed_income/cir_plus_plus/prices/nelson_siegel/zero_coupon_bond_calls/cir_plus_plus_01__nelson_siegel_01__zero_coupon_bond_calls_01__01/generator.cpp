...
const std::filesystem::path dataset_path =
    ...
    "cir_plus_plus_01__nelson_siegel_01__zero_coupon_bond_calls_01__01.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/cir_plus_plus/prices/nelson_siegel/zero_coupon_bond_calls/"
    "cir_plus_plus_01__nelson_siegel_01__zero_coupon_bond_calls_01__01/generation.yaml";
