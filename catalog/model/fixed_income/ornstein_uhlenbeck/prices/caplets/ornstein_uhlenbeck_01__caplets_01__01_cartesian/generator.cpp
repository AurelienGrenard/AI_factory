// Generated Build one Ornstein-Uhlenbeck caplet price dataset.
...
const std::filesystem::path dataset_path =
    ...
    "ornstein_uhlenbeck_01__caplets_01__01_cartesian.json";
const std::filesystem::path catalog_path =
    "catalog/model/fixed_income/ornstein_uhlenbeck/prices/caplets/"
    "ornstein_uhlenbeck_01__caplets_01__01_cartesian/generation.yaml";
