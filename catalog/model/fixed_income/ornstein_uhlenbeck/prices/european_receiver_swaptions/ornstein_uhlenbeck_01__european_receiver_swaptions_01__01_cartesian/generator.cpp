// Generated Generate Ornstein-Uhlenbeck European receiver-swaption prices.
...
int main() {
    ...
    datasets::generate_regular_european_swaption_prices(
        ...
        [maximum_payment_count = product_dataset.maximum_payment_count](
            ...
            ou::launch_ornstein_uhlenbeck_european_swaption_cuda<SwaptionSide::receiver>(
        ...
        "ornstein_uhlenbeck_01__european_receiver_swaptions_01__01_cartesian.json",
        "catalog/model/fixed_income/ornstein_uhlenbeck/prices/european_receiver_swaptions/"
        "ornstein_uhlenbeck_01__european_receiver_swaptions_01__01_cartesian/generation.yaml",
        ...
        "Ornstein-Uhlenbeck European receiver swaption",
