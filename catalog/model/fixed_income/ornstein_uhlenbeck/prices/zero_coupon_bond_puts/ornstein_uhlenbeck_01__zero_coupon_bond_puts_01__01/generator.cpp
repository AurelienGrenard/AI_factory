// Generated Build one Ornstein-Uhlenbeck zero-coupon bond put price dataset.
...
const std::filesystem::path catalog_path =
    ...
    "ornstein_uhlenbeck_01__zero_coupon_bond_puts_01__01/generation.yaml";
...
int main() {
    ...
    const auto launch_plan = offline::cuda_tuning::make_pricing_launch_plan(
        ::ai_factory::workbench::offline::cuda_tuning::PricingIdentity{::ai_factory::workbench::offline::cuda_tuning::PricingFamily::closed_form, "ornstein_uhlenbeck", "zero_coupon_bond_option", ""}, result_count, 0U
    );
