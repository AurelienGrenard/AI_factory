...
constexpr ai_factory::workbench::datasets::PriceConstruction construction =
    ai_factory::workbench::datasets::PriceConstruction::CartesianProduct;
...
const std::filesystem::path dataset_path =
    "datasets/price/heston/european_calls/"
    "heston_01__european_calls_01__02.json";
const std::filesystem::path catalog_path =
    "catalog/price/heston/european_calls/"
    "heston_01__european_calls_01__02.yaml";
